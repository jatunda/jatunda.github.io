var d100_effects = {
	old_key: null,
	effects: [
		'everyone in line of sight looses all their clothes',
		'God sneezes. Everyone feels it.',
		...
		'Others in 30’: 1d10 necrotic dmg. Gain HP equal to loss. 3 rounds. Laser beams',
		...
		"Everything tastes like salty peanut butter for 24 hours. Cast on everyone in 60'.",
	],
};
...
function get_d100_effects() {
	...
	var output =
		'Rolled a d' +
		d100_effects.effects.length +
		' and got a <strong>' +
		(d100_effects.old_key + 1) +
		'</strong>';
	output += '<br>';
...
function get_d10000_effects() {
	var fxNum = (d10000_effects.effects.length * Math.random()) << 0;
	// << 0 basically does Math.floor()
	for (var i = 0; i < 100; i++) {
		if (fxNum == d10000_effects.old_key) {
			fxNum = (d10000_effects.effects.length * Math.random()) << 0;
		} else {
			d10000_effects.old_key = fxNum;
			break;
		}
	}
	var output =
		'Rolled a d' +
		d10000_effects.effects.length +
		' and got a <strong>' +
		(d10000_effects.old_key + 1) +
		'</strong>';
	output += '<br>';
	output += '<em>' + d10000_effects.effects[fxNum] + '</em>';
...
var d10000_effects = {
	...
	effects: [
		...
		"1d4 of caster's fingers move from their left hand to their right hand",
		...
		"A basement's been installed in caster's home while they're been away",
		...
		"A glowing orb hovers over caster's head while they're invisible",
		...
		"A magical blast detonates at caster's location, but they're unharmed",
		'A mound of snow falls onto caster and buries them up to their chest',
		"A page falls out of caster's spell book each time it's opened",
		'A skeleton mimics caster, exactly duplicating their movements',
		...
		'A tornado picks caster up and deposits them atop the nearest house',
		...
		'After each spell, caster briefly appears to bleed from their eyes',
		...
		"After each spell, caster briefly thinks that they're choking",
		...
		'After each spell, caster feels compelled to wash their hands',
		...
		'After each spell, caster forgets their name for one hour',
		...
		'After each spell, caster is 30% likely to lose their balance',
		'After each spell, caster is 60% likely to flap their arms',
		'After each spell, caster is afraid of their own name',
		...
		"After each spell, caster thinks that they're drowning",
		'After each spell, caster thinks that their clothes are on fire',
		...
		"All of caster's fingers are as long as their middle finger",
		...
		'All who meet caster are 50% likely to think they smells like manure',
		"All who meet caster are 60% likely to think they're a lycanthrope",
		"All who meet caster are 60% likely to think they're undead",
		'All within 10 yards of caster are sprayed with viscous ectoplasm',
		'All within 10 yards of caster attack them for 1d4 rounds',
		"Alternating pages of caster's spellbook are indestructible",
		'An accurate illusion of caster copies their movements one mile away',
		...
		"An image of the caster's head hovers over their actual head",
		"An image the of caster's beating heart hovers over their head",
		...
		'Any attempt to change shape makes the caster forget their true form',
		...
		'Any attempt to change shape will leave their feet unchanged',
		...
		'Any attempt to change shape will turn them into 2d12 ducklings',
		...
		'Any building that the caster enters ejects them forcefully',
		'Any clothing worn by caster is invisible to them while they wears it',
		'Any clothing worn by caster smells like carrion while they wears it',
		...
		'Any creature Summoned by caster emerges from their mouth',
		...
		'Any hammer thrown by caster returns to their hand one round later',
		'Any horse ridden by caster suffers no fatigue while they rides it',
		'Any intelligent weapons now carried by caster hate them forever',
		...
		'Any ranged spell used by caster seems to issue from their eyes',
		...
		'Any shield held by caster gains a +1 bonus while they holds it',
		...
		'Any spells caster now has memorized will fail when they casts them',
		...
		'Anyone attempting to rob caster must tell them about it beforehand',
		'Anyone drinking a potion near caster looks like them until sunset',
		'Anyone drinking a potion shrinks by 50% for its duration',
		"Anyone in caster's presence can't employ Direction Sense",
		"Anyone in caster's presence thinks that they represents True North",
		...
		"Anyone voluntarily struck by caster's magic resents them for it",
		"Anyone who knows caster's name gives them an offensive nickname",
		"Anyone who looks deep into caster's mouth risks insanity",
		'Anything caster drinks is 50% likely to fall from their mouth',
		...
		'Before each spell, caster must anoint their head with water',
		...
		'Before each spell, caster must claim that their shoes are too tight',
		'Before each spell, caster must claim to be invincible',
		'Before each spell, caster must clear their throat loudly',
		'Before each spell, caster must confess an embarrassing secret',
		"Before each spell, caster must confess that they're a charlatan",
		'Before each spell, caster must crack their knuckles',
		...
		'Before each spell, caster must hold their breath for 1d10 seconds',
		...
		'Before each spell, caster must pluck 1d6 hairs from their head',
		"Before each spell, caster must predict that he'll die by sunset",
		'Before each spell, caster must prick their finger with a rusty pin',
		...
		'Before each spell, caster must promise to change their name',
		...
		'Before each spell, caster must touch their eyes, ears, and nose',
		'Before each spell, caster must touch liquid water',
		'Before each spell, caster must trace a circle in the air',
		'Before each spell, caster must vow that this is their final spell',
		'Beneficial magic potions have an opposite effect upon the caster',
		"Bits of flesh fall from caster's body until they're a bare skeleton",
		'Blades seem extraordinarily dull while caster wields them',
		'Caster accidentally creates a virulent plague in their workshop',
		'Caster accuses their nearest ally of murdering him',
		'Caster acquires an exact copy of every non-magical thing they owns',
		'Caster acquires lycanthropy, but only in their left leg',
		'Caster acquires proficiency in some weapon that will never exist',
		'Caster addresses everyone they knows by their own name',
		'Caster adopts a habit of nightly self-flagellation',
		'Caster adopts a universally obscene gesture as their trademark',
		...
		'Caster adopts the next religion they encounters for the first time',
		...
		'Caster ages normally but forever retains their current appearance',
		'Caster ages one year per day spent on open water',
		'Caster ages one year per mile that they travels away from this spot',
		...
		'Caster always sees their surroundings as misty and fog-shrouded',
		...
		"Caster and everyone else forgets and can't discern their age",
		'Caster and nearest intelligent weapon exchange personalities',
		"Caster and one nearby ally teleport to the caster's home",
		"Caster annoys everyone by insisting that they're ambidextrous",
		...
		"Caster appears to be bleeding profusely whenever they're indoors",
		...
		'Caster appears to be on fire while their spellbook is open',
		'Caster appears to be operating their body from a remote location',
		...
		'Caster appears to have a railroad spike jutting from their forehead',
		...
		'Caster asks Elves if they can supply them with fudge cookies',
		'Caster ate the last of the rations that their party was carrying',
		'Caster ate two or three pounds of apple seeds this morning',
		'Caster attempts to drink every potion they sees',
		'Caster attracts undead in any town they enters',
		'Caster attracts zealous sycophants wherever they goes',
		'Caster automatically believes that their own illusions are real',
		...
		'Caster becomes lost if they enters a cave by himself',
		'Caster becomes lost if they enters a forest by himself',
		'Caster becomes powerfully addicted to necromantic magic',
		'Caster becomes powerfully addicted to Chaos Bursts',
		'Caster becomes tightly stuck to the next chair in which they sits',
		'Caster becomes unconscious when they becomes invisible',
		'Caster becomes violently ill if they eats near a fire',
		...
		'Caster begins their conversations with an insulting comment',
		'Caster begins to resemble the next person who touches him',
		'Caster begins worshipping their spellbook with burnt offerings',
		'Caster believes that a nearby sheep is their polymorphed true love',
		'Caster briefly turns translucent after casting a spell',
		"Caster burns with homicidal rage whenever they're struck by magic",
		'Caster can alter their weight by up to 50% at will',
		'Caster can always sense their location relative to this location',
		'Caster can appear to be 50% fatter at will',
		'Caster can appraise gems by tasting them',
		'Caster can ask three questions of the next tree they touches',
		'Caster can assess the purity of any metal by tasting it',
		'Caster can be accurately described as "frumious" (very angry)',
		...
		"Caster can become invisible at will while they're knee-deep in snow",
		'Caster can become invisible while standing neck-deep in water',
		'Caster can breathe underwater, but they always smells like a fish',
		'Caster can carry any weight of books but only in their bare hands',
		'Caster can cause one creature near them to turn to iron',
		'Caster can cause one nearby person to age 1d10 years',
		'Caster can change the size of their ears at will',
		'Caster can conjure apples out of thin air, one at a time',
		'Caster can control any undead skeletons now within 100 yards',
		'Caster can detach either of their hands at will',
		'Caster can detach their head easily but dies if they does so',
		...
		"Caster can double their spells' range if they're carrying no metal",
		'Caster can double their weight for up to 1d4 rounds per day',
		...
		'Caster can extend their legs to 150% of their normal length at will',
		'Caster can extend their legs to 2X their normal length at will',
		'Caster can handle red-hot metal with their bare hands',
		'Caster can hear what occurs at this location from up to 10 miles',
		"Caster can hear what's going on in their home, wherever they is",
		'Caster can hold their breath for 3X their Wisdom score in rounds',
		'Caster can hurl a baseball-sized object beyond the horizon',
		'Caster can identify any kind of fungus on sight',
		'Caster can ignite twigs by sticking them in their mouth',
		'Caster can ignore any spell cast on them but is 80% likely to die',
		'Caster can induce ravenous hunger in others',
		'Caster can inflate their left hand like a balloon',
		...
		'Caster can make their ears resemble noses at will',
		...
		'Caster can move in total silence for their Wisdom score in rounds',
		'Caster can move silently while holding a thumb in each nostril',
		'Caster can never again come within one mile of their home',
		...
		'Caster can open their mouth as wide as they is tall',
		'Caster can pass their right arm through up to six inches of wood',
		"Caster can reattach their own limbs if they're severed",
		'Caster can recall their own birth with perfect clarity',
		'Caster can remove their tongue and replace it at will',
		...
		'Caster can retract their feet into their ankles at will',
		'Caster can retract their fingers into their palms at will',
		'Caster can retract their nose into their face at will',
		'Caster can scale walls like a monkey while unencumbered',
		'Caster can see in total darkness if they has a banana in their pocket',
		"Caster can see secret doors easily but can't see normal doors",
		'Caster can see through fire',
		'Caster can see through their eyelids for up to 1d6 rounds at a time',
		'Caster can see through stone if they has a pebble in their mouth',
		...
		'Caster can speak in a whisper to anyone in their line of sight',
		'Caster can speak in any of 2d4 voices at will',
		'Caster can speak with ants but can only ask yes/no questions',
		'Caster can speak with carrion birds, but they smells like a corpse',
		"Caster can speak with carrion birds, but they're permanently bald",
		'Caster can speak with domestic fowl, but they crows at sunrise',
		...
		'Caster can speak with oysters while holding a pearl in their mouth',
		...
		'Caster can stretch their left arm 2X the length of their body',
		...
		'Caster can survive in the depths of space, if they can get there',
		...
		'Caster can turn their arms to wood for up to 1d6 rounds per day',
		'Caster can turn their bones invisible at will',
		'Caster can turn their hands invisible at will 1d8 times per day',
		'Caster can turn their head completely around once per day',
		"Caster can turn into a cat but can't resume their true form",
		'Caster can turn into a falcon but is only 30% likely to turn back',
		"Caster can turn into a small tree while they're indoors",
		'Caster can turn into any kind of fish if no water is nearby',
		'Caster can turn invisible while they holds their breath',
		...
		'Caster can, at will, appear to be the next person they touches',
		...
		"Caster can't be cut by any blade until they casts their next spell",
		...
		"Caster can't be harmed while they stands where they is right now",
		"Caster can't be killed by anyone of their own race",
		...
		"Caster can't bring their left hand within 18 inches of their head",
		"Caster can't carry anything larger than their own head",
		"Caster can't carry anything made entirely of metal",
		"Caster can't carry refined metal in a wooded environment",
		"Caster can't cast any spells they now has memorized for 1d8 days",
		...
		"Caster can't cast magic unless they're within sight of a tree",
		...
		"Caster can't cross moving water while carrying their spellbook",
		...
		"Caster can't learn any new spells until they're been resurrected",
		"Caster can't learn any new spells within 1d10 miles of here",
		"Caster can't lift both feet from the ground at the same time",
		"Caster can't move their arms for 1d4 turns",
		"Caster can't move their left arm or right leg for 1d4 turns",
		"Caster can't move more than 10 feet from the next tree they touches",
		...
		"Caster can't open any door unless their hair is wet",
		"Caster can't open any door while anyone is watching",
		"Caster can't quite be certain that they really exists",
		"Caster can't remember the last 2d12+12 hours",
		"Caster can't remove any magical armor that they're now wearing",
		"Caster can't remove their hands from their pockets",
		"Caster can't run while their eyes are open",
		...
		"Caster can't sleep until they shaves their head bald",
		"Caster can't sleep until they're walked at least 4d8 miles from here",
		"Caster can't speak for one hour and can only croak like a frog",
		"Caster can't speak for one hour if they're wearing clothes",
		...
		"Caster can't speak to anyone whom they're not currently touching",
		"Caster can't speak unless they first turns in a circle",
		"Caster can't speak unless they're brandishing a weapon",
		"Caster can't speak unless they're carrying at least one gold coin",
		"Caster can't speak unless their thumbs are touching",
		"Caster can't speak until they're removed 1d10 articles of clothing",
		...
		"Caster can't touch food with their hands",
		"Caster can't use any blade longer than their forearm",
		"Caster can't use any magic until someone cuts them with a blade",
		...
		"Caster can't use magic unless they swallows a gold coin each day",
		"Caster can't use magic unless they're holding a buzzard's feather",
		"Caster can't use magic until they eats a pound of feathers",
		...
		"Caster can't wield any weapon longer than their arm",
		'Caster changes their name to its reverse: "Tom" becomes "Mot"',
		"Caster claims that they're doing the work of some god or other",
		'Caster claims to be able to command dragons to do their bidding',
		...
		"Caster combusts instantly if they're stabbed by a silver dagger",
		...
		"Caster comes into possession of their great-grandfather's jawbone",
		"Caster completely blends into their surroundings while they're asleep",
		'Caster completely blends into their surroundings while upside down',
		'Caster compulsively hordes some kind of small, worthless item',
		'Caster confesses to every crime they hears about',
		'Caster confesses to improbable crimes (e.g. "I stole the moon")',
		'Caster consistently overestimates their martial and magical prowess',
		...
		"Caster cries like a baby whenever they're hungry or can't sleep",
		"Caster cries like a baby whenever they're struck by magic",
		...
		'Caster declares that they can redeem the damned',
		'Caster declares that they has the power to absolve sins',
		'Caster declares that they is the judge of all mankind',
		'Caster declares that these pretzels are making them thirsty',
		'Caster deeply resents anyone who asks them to use magic',
		"Caster deeply resents anyone who doesn't praise their magical skill",
		'Caster deeply resents anyone who eats meat in their presence',
		'Caster deeply resents anyone who uses magic in their presence',
		'Caster demands that employers pay them in wood instead of gold',
		'Caster demands that their allies adopt fastidious hygiene standards',
		"Caster demands that their allies treat them as though they're invisible",
		'Caster demands that people call them Ishmael',
		'Caster demands that people call them Legion, for they is many',
		'Caster demands that people call them The Spell-Meister',
		...
		'Caster develops an intense hunger for the pages of their spellbook',
		"Caster didn't actually exist prior to this Chaos Burst",
		'Caster dies if they slays a zombie in the next 1d6 days',
		'Caster dies instantly if their blood is spilled by a god',
		'Caster dies instantly if their blood is spilled by mistletoe',
		...
		'Caster discovers that one of their limbs belongs to someone else',
		'Caster discovers that one of their limbs is a clockwork replica',
		...
		'Caster disgorges a bar of soap as large as their spellbook',
		...
		'Caster disgorges a coffin large enough to accommodate their corpse',
		...
		'Caster disgorges a lump of brass the size of their torso',
		...
		'Caster disgorges a weapon that they misplaced 1d12 months ago',
		...
		'Caster disgorges what appears to be their entire nervous system',
		'Caster disgorges what appears to be their own still-beating heart',
		'Caster displays all the signs of full demonic possession',
		'Caster distrusts anyone displaying a cut gem or jewel',
		'Caster distrusts anyone taller than they is',
		"Caster distrusts anyone who doesn't know the caster's name",
		"Caster distrusts anyone who doesn't resemble him",
		"Caster distrusts anyone who won't let them examine their teeth",
		"Caster distrusts anyone who's wearing armor",
		'Caster distrusts other members of their race',
		...
		'Caster donates all of their money to some unlikely charity',
		...
		"Caster dreams of unicorns and wonders if they're an automaton",
		"Caster drinks any potions they're now carrying",
		...
		'Caster ends their conversations with an annoying catch phrase',
		...
		'Caster erases one randomly-chosen spell from their spellbook',
		'Caster experiences pain if they handles jewels or precious gems',
		'Caster experiences pain when they spends money',
		'Caster experiences violent, full-body spasms for 2d4 rounds',
		'Caster faces True North and is stuck that way for one turn',
		'Caster falls down the next flight of steps they encounters',
		'Caster falls from the nearest tree',
		"Caster falls madly in love with someone they're never heard of",
		...
		"Caster fears that he'll be damned forever whenever they uses magic",
		"Caster fears that he'll cease to exist if they causes another Burst",
		'Caster fears that their allies are vanishing one by one',
		'Caster fears that their limbs are vanishing one by one',
		'Caster fears that spiders have lain countless eggs in their brain',
		'Caster fears the reaper',
		'Caster feels a psychic bond to someone unknown but nearby',
		"Caster feels as if they're always walking on a slope",
		"Caster feels as though they're trudging through knee-deep snow",
		"Caster feels as though they're trudging uphill",
		'Caster feels constant, overwhelming hunger while in their home',
		'Caster feels countless small snakes crawling all over their body',
		'Caster feels incredible hostility toward non-magic users',
		'Caster feels incredible hostility toward other magic users',
		'Caster feels inexplicable anxiety when they hears their name',
		'Caster feels inexplicable anxiety while at full hit points',
		'Caster feels inexplicable nostalgia when they meets new people',
		...
		'Caster feels overpowering hatred for the next magic item they sees',
		"Caster feels powerless unless everyone knows they're a magic user",
		"Caster feels powerless unless they're wearing boots on their hands",
		'Caster feels strangely calm while in the presence of dragons',
		'Caster feels thorny roots growing slowly through their flesh',
		'Caster fiercely covets the next magical ring they sees',
		'Caster finds 1d100 cans containing pink, processed meat in jelly',
		'Caster finds 1d4 extra spells in their spellbook',
		'Caster finds 1d4 small rodents living in their spellbook',
		'Caster finds 2d6 white pills, each of which heals 1d20 hit points',
		'Caster finds 2d8 real-looking but useless spells in their spellbook',
		'Caster finds a barrel full of rancid mayonnaise',
		'Caster finds a book describing the methods for self-dissection',
		'Caster finds a book that will shatter their sanity if they reads it',
		...
		'Caster finds a copy of their own ghost-written autobiography',
		...
		'Caster finds a handful of mysterious pills in their pocket',
		'Caster finds a handful of rainbow-colored powder in their pocket',
		...
		'Caster finds a large, cursed diamond in the next hole they digs',
		'Caster finds a large, gold box containing nothing but sand',
		'Caster finds a large, metal disc engraved with their image',
		'Caster finds a list of assassination targets; their name is next',
		'Caster finds a magic wand but for some reason is afraid to use it',
		'Caster finds a minor artifact in the next hole they digs',
		...
		'Caster finds a notebook detailing the way they was built in a lab',
		...
		'Caster finds a possibly inaccurate chronology of their entire life',
		'Caster finds a potion 90% likely to heal and 10% likely to kill',
		'Caster finds a potion that can instantly cause their death',
		'Caster finds a potion that can instill zealous religious fervor',
		'Caster finds a potion that can turn them into an invisible cat',
		...
		'Caster finds a powder that is highly toxic to them but no one else',
		...
		'Caster finds a sack full of their own crematory remains',
		'Caster finds a satchel containing their weight in gold pieces',
		"Caster finds a scroll describing exactly how & when he'll die",
		'Caster finds a secret passage in the next room they enters',
		"Caster finds a set of high-quality watchmaker's tools",
		'Caster finds a small iron box containing 4d8 of their own teeth',
		'Caster finds a treasure map in the next animal they butchers',
		...
		"Caster finds convincing evidence that they're just a clone",
		'Caster finds foul odors pleasant and pleasant scents repulsive',
		'Caster finds their own decaying corpse in the next hole they digs',
		...
		'Caster flies into a fury when they removes their shoes',
		'Caster flies into a murderous rage and attacks their nearest ally',
		'Caster forgets any fire that they lights',
		'Caster forgets any first-level spell they now has memorized',
		"Caster forgets everyone's name",
		'Caster forgets everything they knows about etiquette',
		'Caster forgets how to open their spellbook',
		...
		'Caster forgets that their name is a vile expletive in Dwarfish',
		'Caster gains 1d4 points of Strength; loses one point per day',
		'Caster gains experience at 2X normal rate until they gains a level',
		...
		'Caster gains one pound per level of spells they casts',
		'Caster gains one pound per round for the next 1d100 rounds',
		'Caster generally seems to be lying when talking about magic',
		'Caster gets a splinter every time they wields a wooden weapon',
		"Caster gives their party two weeks' notice before resigning",
		"Caster glows as bright as daylight while they're asleep",
		'Caster goes berserk and attacks the next undead creature they sees',
		'Caster goes berserk in the presence of royalty',
		'Caster goes berserk whenever they receives magical healing',
		'Caster goes on and on about their misunderstood genius',
		'Caster goes out of their way to appear humble and unassuming',
		'Caster goes out of their way to avoid using magic in combat',
		'Caster goes out of their way to be offensive to royalty',
		'Caster goes out of their way to draw attention to himself in battle',
		'Caster gradually becomes more and more angular',
		'Caster gradually becomes more and more turtle-like',
		'Caster growls in their sleep like a tiger',
		'Caster grows 1d10 new and mysterious organs in their abdomen',
		'Caster grows an additional finger each week',
		'Caster grows one inch per day for the next 2d4-1 days',
		'Caster hallucinates wildly the next time they drinks water',
		'Caster hallucinates wildly until they drinks a quart of water',
		'Caster has 5 Intelligence for 1d6 turns',
		'Caster has 5 Strength for 1d4 turns',
		'Caster has 1d100 real-looking but useless copies of their spellbook',
		'Caster has a +10 bonus on each of their next 1d4 dice rolls',
		'Caster has a 10% chance to control any Summoned entity they sees',
		...
		'Caster has a crystal cube that enables them to see through wood',
		'Caster has a cumulative 1% chance daily to be eaten by a dragon',
		'Caster has a cumulative 1% chance daily to turn to stone',
		'Caster has a flat 10% chance to know any new language they hears',
		'Caster has a habit of issuing idle but poorly-considered threats',
		'Caster has a large but harmless hole at the top of their head',
		'Caster has a parrot on their shoulder and a peg leg',
		...
		'Caster has a scar as if their head were severed and reattached',
		'Caster has a small keyhole in the palm of their right hand',
		'Caster has a star-shaped dent at the back of their head',
		'Caster has a violent argument with the next soldier they meets',
		...
		'Caster has an identical face on the back of their head',
		'Caster has an inexplicable but overwhelming fear of sunrise',
		"Caster has an out-of-body experience and can't find their way back",
		...
		'Caster has blasphemous tattoos over most of their body',
		'Caster has dreadful dreams of a foul, ancient, and tentacled god',
		'Caster has faulty direction sense while carrying their spellbook',
		'Caster has misgivings about those mushrooms they ate yesterday',
		"Caster has no internal organs; they're a homogenous mush inside",
		'Caster has no scent whatsoever',
		"Caster has ram's horns growing from their hips",
		'Caster has rings on their fingers and bells on their toes',
		'Caster has scars as if their skeleton had been torn out of their body',
		'Caster has silly and pornographic tattoos over most of their body',
		'Caster has ten thumbs in their mouth',
		'Caster has ten thumbs instead of fingers',
		'Caster has ten thumbs somewhere on their body',
		'Caster has tiny mathematical formulae tattooed all over their body',
		'Caster has vivid but false memories of a past life',
		'Caster has vivid but false memories of the last 24 hours',
		'Caster has vivid dreams of their own death each night',
		"Caster hasn't eaten during the past 1d100 days",
		'Caster hatches numerous schemes for destroying the world',
		'Caster hears a heavenly choir singing their praises for 1d4 hours',
		'Caster hears crickets chirping loudly from now on',
		'Caster hears malevolent voices nearby whispering about their doom',
		'Caster hears normally except for voices, which seem subtly muted',
		'Caster hears the echo of their own voice whenever they speaks',
		'Caster hears the footfalls of a hungry predator nearby',
		'Caster hears waves crashing on a beach no matter where they is',
		"Caster henceforth casts this spell as if they're two levels higher",
		...
		'Caster hurls their spellbook as far as they can',
		'Caster informs people of what they judges their greatest weakness',
		"Caster insists that they're proficient in some obscure martial art",
		...
		'Caster is 5% likely to become a god if they drowns himself',
		'Caster is 5% likely to become a god if they kills himself by fire',
		'Caster is 10% likely never to have existed at all',
		'Caster is 10% likely to be immune to any single dose of poison',
		'Caster is 10% likely to be invisible to any female that they meets',
		'Caster is 10% likely to be invisible to any male that they meets',
		'Caster is 10% likely to be resurrected if their corpse is set afire',
		...
		'Caster is 10% likely to sympathize with any enemy they injures',
		'Caster is 15% likely to have read any book they sees',
		'Caster is 20% likely to faint outright at the sight of blood',
		'Caster is 20% likely to sneeze and disrupt any spell they casts',
		'Caster is 20% likely to turn to stone while swimming',
		'Caster is 2X as old as the oldest person within 100 yards',
		'Caster is 50% likely to drown in any water deeper than they is tall',
		'Caster is 60% likely to misplace any money they receives',
		'Caster is able to see their own eyes',
		"Caster is absolutely convinced that they're a zombie",
		...
		'Caster is attacked by a shark when they next enters a river',
		'Caster is attacked by countless stinging earthworms',
		'Caster is attacked by goats the next time they crosses a bridge',
		...
		"Caster is blind unless they're carrying at least 4d10 gold coins",
		"Caster is blind while they're invisible",
		'Caster is blind while their spellbook is open',
		...
		'Caster is briefly paralyzed at the sight of their own blood',
		...
		'Caster is carrying a bowl full of water that they must not spill',
		'Caster is certain that a horrible monster is living inside him',
		'Caster is certain that every meal they eats contains strong poison',
		'Caster is certain that they can breathe underwater',
		'Caster is certain that they has just killed their guardian angel',
		'Caster is certain that they used to have four arms',
		"Caster is certain that he'll become immortal if they're beheaded",
		"Caster is certain that he'll die in the next 1d4 rounds",
		"Caster is certain that they're recently returned from the future",
		"Caster is certain that they're transforming into a horrible monster",
		'Caster is certain that their soul is buried under the nearest tree',
		'Caster is chained to a desk in some high-rise office building',
		'Caster is chained to an anvil',
		"Caster is clad in funerary wraps as if they're about to be interred",
		'Caster is completely invulnerable to all harm for 1d4 rounds',
		'Caster is convinced that they once ate an entire person',
		'Caster is convinced that they only exists as numbers on paper',
		'Caster is convinced that their allies plan to kill and eat him',
		'Caster is covered in a shell of frozen slime',
		'Caster is covered in barnacles',
		'Caster is covered in indelible, jet-black hand prints',
		...
		'Caster is determined to destroy their staff or spellbook',
		'Caster is determined to rid himself of their nails, teeth, and hair',
		'Caster is distracted by something stuck between their teeth',
		"Caster is drawn forcefully toward the spell's target point",
		'Caster is dressed like a high-class burlesque performer',
		'Caster is eager to find out just how fireproof they really is',
		'Caster is eager to find out just how much blood they can lose',
		'Caster is encased from the waist down in a block of cheese',
		'Caster is encased up to their neck in a shell of concrete',
		...
		'Caster is forcibly barred from the next town they attempts to enter',
		"Caster is full o' the milk of human kindness",
		'Caster is half the age of the youngest person within 100 yards',
		'Caster is Healed each time they triggers a Chaos Burst',
		...
		'Caster is immune to all harm until they attacks or uses magic',
		...
		"Caster is immune to cold-based attacks while they're on fire",
		"Caster is immune to electrical attacks while they're barefoot",
		"Caster is immune to electrical magic at night while it's snowing",
		'Caster is immune to fear while holding a spider in their mouth',
		'Caster is immune to fire from the waist down',
		"Caster is immune to fire while holding a wren's egg in their mouth",
		'Caster is immune to gaze attacks while holding their open spellbook',
		...
		'Caster is immune to magic until they imbibes any liquid',
		'Caster is immune to missile-based spells while naked',
		'Caster is immune to natural cold while naked and unencumbered',
		'Caster is immune to necromantic magic while standing on their head',
		...
		'Caster is immune to poison gas while their feet are wet',
		...
		'Caster is inappropriately frank about their bodily functions',
		'Caster is inclined to attack any who offer them magical healing',
		'Caster is inclined to attack anyone representing the crown',
		'Caster is increasingly convinced that they just might be a deity',
		'Caster is intensely curious about the limits of their own mortality',
		'Caster is intensely curious about the taste of certain poisons',
		'Caster is invisible from their hips to their sternum',
		...
		'Caster is invisible to members of their immediate family',
		...
		'Caster is nearly paralyzed by fear while their spellbook is open',
		'Caster is on the verge of starvation, no matter how much they eats',
		...
		'Caster is permanently disfigured by the next fire they sets',
		'Caster is permanently invisible to the next person to injure him',
		'Caster is pinned beneath a large tombstone bearing their name',
		...
		'Caster is reduced to one hit point when they next triggers a Burst',
		'Caster is related by blood to no one who has ever lived',
		'Caster is reluctant to bring their spellbook indoors',
		'Caster is reluctant to carry any weapons after sunset',
		'Caster is reluctant to cast any spell that they now has memorized',
		"Caster is reluctant to enter any building they're previously entered",
		'Caster is reluctant to get blood on any of their weapons',
		...
		'Caster is rumored to have killed the last person to ask their name',
		'Caster is rumored to have murdered hundreds of innocent people',
		"Caster is rumored to have orc's blood flowing through their veins",
		...
		'Caster is rumored to have placed a huge bounty on their own head',
		'Caster is rumored to have sold their family into slavery',
		...
		"Caster is scarred as if he'd been burned over 80% of their body",
		...
		'Caster is Slowed when they becomes invisible',
		'Caster is smeared from head to toe with molasses',
		'Caster is soaked each time they casts a water-based spell',
		...
		"Caster is stricken mute until they're cut by a magic weapon",
		"Caster is stripped of monetary wealth except what they're carrying",
		...
		'Caster is suddenly unsure that they really wants to be a magic user',
		...
		'Caster is thought to have a huge bounty on their head',
		...
		'Caster is utterly unable to assess their own injuries',
		'Caster is utterly unable to disguise himself by magic',
		'Caster is vaguely aware of any deliberate threat upon their life',
		'Caster is very susceptible to peer pressure in matters of alcohol',
		'Caster is violently ejected from the next building they enters',
		...
		"Caster is wearing their mother's wedding gown",
		...
		"Caster is wearing the clothes that he'll be wearing when they dies",
		'Caster is wearing the leathered skin of a recently dead king',
		'Caster is wearing what appears to be their heart on their sleeve',
		'Caster is widely known to be a reprehensible hedonist',
		'Caster is worshipped as a god by some degenerate, isolated tribe',
		'Caster is wracked by searing pain every time they asks a question',
		"Caster is wracked by searing pain when they draws another's blood",
		'Caster is wracked by searing pain when they touches the undead',
		"Caster isn't quite certain that they're not the spawn of a demon",
		'Caster jams both thumbs deep into their nostrils for 1d6 rounds',
		'Caster just barely passes for a member of their race',
		...
		'Caster knows a spell that will slay them instantly',
		"Caster knows that he'll go mad if they says their name aloud",
		'Caster knows the location of every mammal now within one mile',
		'Caster knows the secret language of frogs and toads',
		'Caster laughs heartily when they sees their allies injured',
		'Caster leaps from the next bridge that they crosses',
		'Caster learns a damaging secret about one of their allies',
		"Caster learns that they're been assigned to some government position",
		'Caster learns that their arranged marriage is due to occur tomorrow',
		'Caster learns that their parents were undead on the day they was born',
		'Caster leaves no footprints in snow',
		'Caster likes to tell everyone that they has an eidetic memory',
		"Caster looks as if they're been submerged in a bog for six months",
		...
		"Caster loses 1d4 hit points each round that they're invisible",
		'Caster loses 1d4 hit points every time they speaks a pun',
		'Caster loses 1d4 hit points per hour until sunset tonight',
		'Caster loses 3d8 hit points any time they uses the spell Read Magic',
		...
		'Caster loses all hair on the left side of their body',
		'Caster loses one hit point each time they calls someone by name',
		'Caster loses one hit point per level of spells cast in sunlight',
		'Caster loses one point of Charisma for each hit point they loses',
		'Caster loses one point of Charisma per day for 3d6 weeks',
		'Caster loses one pound per level of spell they casts',
		...
		'Caster must carry their spellbook in hand, not in a bag or pouch',
		'Caster must drink their weight in water by sunset',
		'Caster must drink salt water instead of fresh water',
		'Caster must eat at least one pound of salt each week',
		'Caster must include a vile expletive in every sentence they speaks',
		'Caster must insult any figure of authority at least 1d4 times',
		"Caster must Save or their arms start decomposing as if they're dead",
		'Caster must Save or turn into an anthropomorphic weasel',
		'Caster must Save vs Fortitude or food turns to iron in their mouth',
		'Caster must Save vs Fortitude or their lungs turn to gold',
		'Caster must Save vs Fortitude, or their weight doubles',
		'Caster must Save vs Will or attempt to disembowel himself',
		'Caster must Save vs Will or begin aging twenty years per round',
		'Caster must Save vs Will, or they becomes permanently illiterate',
		'Caster must state their name to anyone who asks it',
		...
		'Caster obsessively pursues their goal of acquiring a second head',
		'Caster offers to sell their spellbook to the lowest bidder',
		'Caster only needs to eat during alternating weeks',
		'Caster owes 10d100 gold pieces to the next person they touches',
		'Caster owes 1d4 gold pieces to everyone within 100 yards',
		'Caster owes a colossal sum of money to a local lender',
		"Caster owes their life to someone who won't be born for centuries",
		'Caster perceives an assassin hiding behind every tree and rock',
		'Caster perceives marbles to be rolling around inside their skull',
		...
		'Caster randomly teleports 1d100 yards when they becomes invisible',
		'Caster raves like a lunatic whenever they witnesses a spellcasting',
		...
		'Caster reacts violently to anyone they hears using improper grammar',
		'Caster reacts violently to anyone who asks their name',
		...
		"Caster realizes they're an escaped slave whose owner is tracking him",
		'Caster realizes that chickens and ducks are plotting a mutiny',
		"Caster realizes that they're their left arm isn't actually attached",
		"Caster realizes that they're lived this day repeatedly for years",
		"Caster realizes that they're skilled in the use of the bola",
		"Caster realizes that they're standing on a trapdoor over a deep pit",
		"Caster realizes that they're very close to fulfilling their destiny",
		'Caster realizes that their name is a synonym for manure',
		...
		"Caster recently drank a poison or a potion; they can't recall which",
		...
		'Caster recites a long list of grievances against their allies',
		'Caster recites that bit from Macbeth whenever they holds a dagger',
		'Caster refers to their allies by cute nicknames',
		'Caster refers to their spellbook as their "Booky-Wooky"',
		...
		'Caster refuses to speak to anyone while their spellbook is open',
		'Caster refuses to speak to anyone who addresses them by name',
		'Caster refuses to speak with one particular ally',
		'Caster refuses to wield any weapon not engraved with their name',
		...
		'Caster reveals that they enjoys the taste of roasted Dwarf',
		"Caster reveals that they're a doppelganger",
		'Caster routinely forgets magical command words',
		"Caster routinely forgets that they can't breathe underwater",
		'Caster routinely forgets that poisons are harmful when ingested',
		'Caster routinely forgets the reason they stood up, sat down, etc.',
		'Caster routinely forgets to douse campfires, cooking fires, etc.',
		'Caster routinely forgets to draw a weapon before attacking',
		"Caster routinely forgets to eat, even when they're famished",
		'Caster routinely forgets to lie down before sleeping',
		'Caster routinely forgets to put their clothes on after bathing',
		'Caster routinely forgets to remove their clothes before bathing',
		"Caster routinely forgets where they is and where they're going",
		'Caster routinely forgets where they left their spellbook',
		"Caster routinely forgets whether or not they're wearing armor",
		'Caster routinely forgets which spells they has memorized',
		'Caster routinely loses their train of thought mid-sentence',
		...
		'Caster sees as if their eyes were hovering one foot to the left',
		'Caster sees as if their eyes were in the back of their head',
		'Caster sees as if their eyes were where their ears are',
		'Caster sees colorful ribbons swirling in the air around him',
		'Caster sees cryptic messages in the patterns of plant growth',
		"Caster sees everything as if they're deep underwater",
		...
		'Caster sees menacing, shadowy figures everywhere they goes',
		...
		'Caster shatters like glass if they falls more than 2X their height',
		'Caster shivers uncontrollably in the presence of fire',
		'Caster shows all signs of plague but is actually quite healthy',
		'Caster shows everyone their wounds and asks if they look infected',
		'Caster shrieks like a fire alarm in the presence of fire',
		'Caster shrinks by 50% upon losing 50% of their hit points',
		...
		'Caster sneezes repeatedly when they becomes invisible',
		...
		'Caster spends 1d4 rounds attempting to ignite their shoes',
		'Caster spends 1d4 rounds trying to cast this same spell',
		'Caster spends 1d4 rounds trying to strangle himself with their hair',
		'Caster spends 2d10 rounds racing toward the nearest coastline',
		'Caster spends 2d10 rounds trying to look into their own ears',
		'Caster spends all of their money on the next thing they buys',
		...
		'Caster sprouts a ghastly tentacle from the center of their chest',
		'Caster sprouts a large, spongy mass between their shoulder blades',
		"Caster sprouts a mane like a lion's",
		'Caster sprouts a new ear on the back of one hand',
		'Caster sprouts a pretty flower from their chin',
		'Caster sprouts a prominent brow ridge',
		'Caster sprouts a retractable metal antenna from their forehead',
		'Caster sprouts a small, flaming wick atop of their head',
		'Caster sprouts a tiny horn from the tip of their nose',
		'Caster sprouts a zipper along the length of their spine',
		'Caster sprouts an additional ear behind each of their normal ears',
		'Caster sprouts an eye at the exact top of their head',
		'Caster sprouts an ugly protuberance from their forearm',
		'Caster sprouts sharp blades along the edges of their forearms',
		'Caster sprouts tiny, useless wings from the bridge of their nose',
		'Caster sprouts wild-looking feathers on their cheeks',
		'Caster sprouts wires and rubber tubing from their flesh',
		'Caster stands in uffish (grumpy) thought for 3d4 rounds',
		"Caster stares at the spell's target point for 1d10 rounds",
		'Caster starts billing their allies for each spell they casts',
		"Caster starts dancing and can't stop until they're struck by magic",
		"Caster starts running and thinks he'll explode if they stops",
		...
		'Caster sticks to the next metal item they touches for 1d6 turns',
		'Caster stumbles into the next campfire that they passes',
		'Caster suddenly has 2d4+2 toes jutting from their face',
		'Caster suddenly has feet like an elephant',
		'Caster suddenly has misgivings about their skill as a magic user',
		'Caster suddenly has ten toes on each foot',
		'Caster suddenly has ten toes on one foot and none on the other',
		"Caster suddenly realizes that they're been naked for 2d8 days",
		'Caster suddenly realizes that their clothing is made of human skin',
		...
		'Caster suffers acute paranoia whenever they hears their name',
		'Caster suffers an intense, debilitating fever for 1d4 days',
		'Caster suffers bouts of rampant xenophobia',
		'Caster suffers brief pain every time they closes a book',
		'Caster suffers cramps if they uses magic within an hour of eating',
		...
		'Caster suffers incredible fear the next time they crosses a bridge',
		'Caster suffers intense pain during attempts at magical healing',
		'Caster suffers intense pain in their eyes whenever they sees undead',
		'Caster suffers intense pain whenever they changes shape',
		'Caster suffers intense pain whenever they eats cooked meat',
		'Caster suffers intense pain whenever they enters a temple or church',
		'Caster suffers intense pain whenever they passes through a doorway',
		'Caster suffers intense pain whenever they treads upon grass',
		'Caster suffers intense pain whenever they tries to sing',
		'Caster suffers intense pain whenever they uses Divination magic',
		'Caster suffers intense pain whenever they wields a magical blade',
		'Caster suffers maximum damage from the next 1d4 attacks upon him',
		'Caster suffers the bends as if they surfaced too quickly',
		...
		'Caster suspects that their allies have all joined a dangerous cult',
		'Caster suspects that their use of magic is entirely delusional',
		'Caster suspects that someone nearby has taken over their mind',
		'Caster suspects that someone nearby is a mechanical automaton',
		'Caster takes a big bite out of their spellbook',
		...
		'Caster teleports one mile the next time they crosses a river',
		'Caster teleports to exactly where they was standing an hour ago',
		...
		'Caster teleports to the spot where they last ate',
		'Caster tells everyone that they has an eidetic memory',
		'Caster tells everyone that their bones are made of diamond',
		'Caster tells malicious lies about their employer or benefactor',
		'Caster tells malicious lies in the presence of clergy',
		'Caster tends to be marked as the strongest member of their party',
		...
		'Caster thinks that "hi-ho, hi-ho" is a proper Dwarf greeting',
		'Caster thinks that a distant mountain is made of gold',
		'Caster thinks that a huge fire is blazing all around him',
		'Caster thinks that a magic candle is burning in their stomach',
		'Caster thinks that a nearby ally is sapping their magical energies',
		'Caster thinks that a past life is intruding upon their current one',
		'Caster thinks that a snake runs the length of their digestive tract',
		'Caster thinks that a violent hailstorm is going on',
		'Caster thinks that all fire is an illusion',
		'Caster thinks that all of their suspicions are justified',
		'Caster thinks that all other magic users are out to get him',
		'Caster thinks that all royalty is hopelessly corrupt',
		'Caster thinks that an ally will kill them before sunset tomorrow',
		'Caster thinks that any wound they receives is much, much worse',
		'Caster thinks that elementals pose no threat to him',
		'Caster thinks that every herbivore in the world hates him',
		'Caster thinks that every scratch will infect them with lycanthropy',
		'Caster thinks that everyone they knows is an impostor',
		'Caster thinks that everyone is jealous of their magical prowess',
		'Caster thinks that everyone thinks that they is an impostor',
		'Caster thinks that everything they owns has been replaced by a copy',
		'Caster thinks that everything they owns is powerfully enchanted',
		'Caster thinks that evil beings will kill to possess their spellbook',
		'Caster thinks that food prepared by others is poisonous to him',
		'Caster thinks that gold will burn them if placed against their skin',
		'Caster thinks that they came into existence just 1d4 days ago',
		'Caster thinks that they can become invisible to undead at will',
		'Caster thinks that they can command dragons to do their bidding',
		'Caster thinks that they can communicate with ants',
		'Caster thinks that they can communicate with cats',
		'Caster thinks that they can fly by leaping off of tall buildings',
		'Caster thinks that they can handle red-hot metal without harm',
		'Caster thinks that they can neutralize poisons by swallowing them',
		'Caster thinks that they can restore the undead to true life',
		'Caster thinks that they can speak directly to their deity',
		'Caster thinks that they can speak with birds',
		'Caster thinks that they can survive many hammer blows to the skull',
		'Caster thinks that they died during their youth',
		'Caster thinks that they has a weakness to green rock',
		'Caster thinks that they has diplomatic immunity',
		'Caster thinks that they has the power to speak prophecy',
		'Caster thinks that they is attended by invisible undead retainers',
		'Caster thinks that they just died and is now a zombie',
		'Caster thinks that they knows the location of a vast horde of gold',
		'Caster thinks that they looks totally different after each sunrise',
		'Caster thinks that they must eat a pound of soil by midnight',
		'Caster thinks that they must hold an awkward item to cast magic',
		'Caster thinks that they must learn a new spell before sunset',
		'Caster thinks that they must protect the target at all costs',
		'Caster thinks that they must quickly remove and burn their clothes',
		'Caster thinks that they must undertake some bizarre quest',
		'Caster thinks that they owes thousands of gold pieces to the king',
		'Caster thinks that they owns everything now in their line of sight',
		'Caster thinks that they smells strongly of manure',
		"Caster thinks that he'll be a god if they removes all of their skin",
		"Caster thinks that he'll be canonized immediately after their death",
		"Caster thinks that he'll be eaten by zombies if they falls asleep",
		"Caster thinks that he'll be executed for treason at dawn tomorrow",
		"Caster thinks that he'll be executed for treason if they uses magic",
		"Caster thinks that he'll be immolated if they uses magical fire",
		"Caster thinks that he'll be killed in their sleep one night soon",
		"Caster thinks that he'll catch a disease if they uses magic items",
		"Caster thinks that he'll combust if they gets wet",
		"Caster thinks that he'll combust if they tells a lie",
		"Caster thinks that he'll combust unless they wears a garland of ivy",
		"Caster thinks that he'll contract every disease they encounters",
		"Caster thinks that he'll die if a particular person nearby dies",
		"Caster thinks that he'll die unless they eats a magical scroll",
		"Caster thinks that he'll drown in the next water they crosses",
		"Caster thinks that he'll excrete diamonds if they ingests coal",
		"Caster thinks that he'll melt if they gets too close to a fire",
		"Caster thinks that they're a master thief",
		"Caster thinks that they're a priest of a foul, tentacled monstrosity",
		"Caster thinks that they're actually 10X older than they appears to be",
		"Caster thinks that they're aging at a rate of one year per hour",
		"Caster thinks that they're been declared The Protector Of The Forest",
		"Caster thinks that they're been spared for some infernal purpose",
		"Caster thinks that they're being attacked by piranha",
		"Caster thinks that they're being attacked by the nearest boulder",
		"Caster thinks that they're being consumed by invisible worms",
		"Caster thinks that they're being held against their will",
		"Caster thinks that they're being savaged by rabid dogs",
		"Caster thinks that they're being squeezed by a large python",
		"Caster thinks that they're dead and hopes their allies don't find out",
		"Caster thinks that they're destined to be hanged at midnight tonight",
		"Caster thinks that they're destined to die in a comical fashion",
		"Caster thinks that they're died and gone to heaven",
		"Caster thinks that they're fireproof while they're naked",
		"Caster thinks that they're guilty of sedition and treason",
		"Caster thinks that they're highly combustible",
		"Caster thinks that they're immune to lycanthropy",
		"Caster thinks that they're immune to necromantic magic",
		"Caster thinks that they're immune to non-magical diseases",
		"Caster thinks that they're indentured to some nearby landowner",
		"Caster thinks that they're invincible while they're talking",
		"Caster thinks that they're invulnerable to magical weapons",
		"Caster thinks that they're invulnerable to missile weapons",
		"Caster thinks that they're invulnerable while they're invisible",
		"Caster thinks that they're invulnerable while wearing a hat",
		"Caster thinks that they're just escaped from rogue vivisectionists",
		"Caster thinks that they're next in line for the throne of hell",
		"Caster thinks that they're on fire and begs people to extinguish him",
		"Caster thinks that they're raised himself from the dead",
		"Caster thinks that they're seeing through someone else's eye",
		"Caster thinks that they're slowly transforming into a dragon",
		"Caster thinks that they're sold their soul to several different demons",
		"Caster thinks that they're sold their soul to that guy at the market",
		"Caster thinks that they're soon to be bronze-plated",
		"Caster thinks that they're standing at the edge of a cliff",
		"Caster thinks that they're standing in a chest-high heap of manure",
		"Caster thinks that they're standing in waist-deep water",
		"Caster thinks that they're standing on a tall, narrow staircase",
		"Caster thinks that they're stolen this body from its rightful owner",
		"Caster thinks that they're the child of some unlikely person nearby",
		"Caster thinks that they're the lizard king and can do anything",
		"Caster thinks that they're the man in the moon",
		"Caster thinks that they're the victim of an elaborate practical joke",
		"Caster thinks that they're the victim of circumstance",
		"Caster thinks that they're water soluble",
		'Caster thinks that their actions are fulfilling ancient prophecy',
		'Caster thinks that their allies will all be dead before morning',
		"Caster thinks that their allies' wounds are much more serious",
		'Caster thinks that their ancestors are speaking through their allies',
		'Caster thinks that their ancestors came from a distant world',
		'Caster thinks that their brain will pop if they learns one more spell',
		'Caster thinks that their clothing is drenched in strong acid',
		"Caster thinks that their current alignment isn't their true alignment",
		'Caster thinks that their death will bring about the apocalypse',
		'Caster thinks that their death will open the gates of heaven',
		'Caster thinks that their death will open the gates of hell',
		'Caster thinks that their deity has commanded them to kill their allies',
		'Caster thinks that their destiny awaits them in the nearest cave',
		'Caster thinks that their face is far too hideous to look at',
		'Caster thinks that their face is just a mask they wears on their skull',
		'Caster thinks that their hands will disintegrate if they touches gold',
		'Caster thinks that their head is a parasitic organism',
		'Caster thinks that their head is an extraneous, vestigial appendage',
		'Caster thinks that their head was sewn onto this body only recently',
		'Caster thinks that their head will fall off if they removes their hat',
		'Caster thinks that their head will shatter if they wears a hat',
		'Caster thinks that their magic items are about to explode',
		'Caster thinks that their magic items are plotting against him',
		'Caster thinks that their soul is controlling their body from far away',
		'Caster thinks that their soul was forced into this current body',
		'Caster thinks that their spellbook belongs to someone else',
		'Caster thinks that their spellbook is a living entity',
		'Caster thinks that their spellbook is incredibly flammable',
		'Caster thinks that their spellbook is trying to consume their soul',
		'Caster thinks that their spellbook is trying to kill him',
		'Caster thinks that their teeth will explode if chews meat',
		'Caster thinks that horses are conspiring against him',
		'Caster thinks that imps and demons harass them while they sleeps',
		"Caster thinks that it's cute when they speaks in baby-talk",
		"Caster thinks that life is a simulation and they're soaking in a vat",
		'Caster thinks that many of their memories were falsely implanted',
		'Caster thinks that mighty deities are vying for their soul',
		'Caster thinks that must hold one hand to their head at all times',
		'Caster thinks that no non-magical animal can harm him',
		'Caster thinks that no one really trusts him',
		"Caster thinks that no one really understands what they're saying",
		'Caster thinks that one their allies will kill them while they sleeps',
		'Caster thinks that people are just using them for their money',
		"Caster thinks that people think they're some kind of deity",
		'Caster thinks that rhyming words have mystical significance',
		"Caster thinks that some item they're carrying is about to explode",
		"Caster thinks that some item they're carrying will soon explode",
		'Caster thinks that some nearby person killed them yesterday',
		'Caster thinks that someone else can see through their eyes',
		"Caster thinks that something valuable's been stolen from him",
		'Caster thinks that the king owes them a big favor',
		...
		'Caster thinks that the top of their head should be flattened',
		'Caster thinks that the universe will cease to exist when they dies',
		"Caster thinks that the world's rotation will hurl them into space",
		'Caster thinks that this date will live in infamy',
		'Caster thinks that this is all just a big misunderstanding',
		"Caster thinks that Chaos Bursts are proof that they're nearly a deity",
		'Caster threatens to kill and eat anyone who insults him',
		'Caster tries to commit Seppuku with some sort of cudgel',
		'Caster tries to pop their head by squeezing it with both hands',
		"Caster tries to swallow any writing instrument that they're carrying",
		'Caster tries very hard to peel their face from their skull',
		'Caster tries very hard to twist their nose upside down',
		"Caster turns bright blue while they're bleeding",
		...
		'Caster vanishes; in 1d8 rounds they appears at the target point',
		'Caster volunteers for the most dangerous task they can find',
		"Caster vows not to rest until they're found the real killers",
		'Caster vows to commit deicide before the end of the year',
		'Caster vows to make a little birdhouse in their soul',
		'Caster vows to slay the next person to use magic on him',
		'Caster vows to slay the next person who addresses them by name',
		'Caster wagers all of their money on an improbable contest',
		'Caster walks with a profound limp except while naked',
		'Caster wants to join the next flock of birds they sees',
		'Caster was born in the universe that existed before this one',
		'Caster wears eyeglasses and has an odd birthmark on their forehead',
		'Caster weeps powerfully adhesive tears for 1d6 rounds',
		'Caster weeps tears of blood whenever someone says their name',
		'Caster will appear to be their current age for the rest of their life',
		'Caster will combust unless they immerses himself within an hour',
		...
		"Caster won't age for 100 years if they cuts off their thumbs",
		"Caster won't remember the next 4d6 hours",
		'Caster, their gear, and clothes are translucent for 2d4-1 days',
		"Caster's age is doubled until sunrise tomorrow",
		"Caster's allies completely ignore them for 1d6 hours",
		"Caster's allies have never quite trusted him",
		"Caster's allies suspect that they isn't quite housebroken",
		"Caster's allies suspect that they secretly eats mice and rats",
		"Caster's allies treat them like a child for 2d12 hours",
		"Caster's allies worship them as a god for 1d4 days",
		...
		"Caster's attempts at scrying yield visions of their own home",
		...
		"Caster's blood combusts violently within their body",
		...
		"Caster's blood is strongly adhesive after it leaves their body",
		...
		"Caster's body can act independently if separated from their head",
		...
		"Caster's body is scarred as if they're undergone an autopsy",
		...
		"Caster's bones can't be broken unless they're barefoot",
		"Caster's bones will be powerfully explosive after their death",
		"Caster's boots adhere strongly to stone while they're wearing them",
		...
		"Caster's center of gravity is 1d4 feet to their left",
		"Caster's center of gravity is at the level of their eyes",
		"Caster's center of gravity is at the level of their feet",
		...
		"Caster's clothes are burned to cinders, but they is unharmed",
		...
		"Caster's clothes clatter like metal when they moves",
		...
		"Caster's death is ordered due to a Burst they triggered previously",
		...
		"Caster's dominant hand becomes as clumsy as their other hand",
		"Caster's ears are burned from their head",
		"Caster's ears are on the same side of their head",
		...
		"Caster's eyes do not move, but they can see normally",
		"Caster's eyes glow red when they tries to make a good impression",
		"Caster's eyes merge into a single eye at the bridge of their nose",
		"Caster's eyes migrate to their cheekbones",
		"Caster's eyes migrate two inches higher on their forehead",
		"Caster's eyes sink 1d4 inches into their skull",
		...
		"Caster's face appears to float 1d4 inches in front of their skull",
		"Caster's face appears to have been sculpted from cold wax",
		"Caster's face doesn't move when they speaks; -2 to reaction rolls",
		...
		"Caster's feet are burned as if they're waded through ankle-deep acid",
		"Caster's feet are encased in brick",
		"Caster's feet can't be burned by magical fire",
		"Caster's feet inflate to 2X normal size while they wades in water",
		"Caster's feet shrink by 80% while they're wearing shoes or boots",
		"Caster's feet smolder gently for 1d6 hours without harming him",
		"Caster's feet vanish, but they can walk comfortably on their ankles",
		...
		"Caster's fingers can't be severed from their hands",
		...
		"Caster's hair reeks of sulfur when they're near a campfire",
		"Caster's hair stands straight up for the next 1d4 weeks",
		"Caster's hand adheres to the next bludgeoning weapon they grips",
		"Caster's hand adheres to the next tree they touches",
		...
		"Caster's hands are invisible while they clasps them",
		...
		"Caster's hands can't come within 12 inches of their face",
		"Caster's hands detach the next time they puts them in their pockets",
		...
		"Caster's head is split down the middle but they is unharmed",
		...
		"Caster's home has a secret room that they're never noticed before",
		"Caster's home has served as a brothel while they're been away",
		"Caster's home has served as a cafeteria while they're been away",
		"Caster's home has served as a crematorium while they're been away",
		"Caster's home has served as a grain silo while they're been away",
		"Caster's home has served as a monastery while they're been away",
		"Caster's home has served as a mortuary while they're been away",
		"Caster's home has served as a pig sty while they're been away",
		"Caster's home has served as a prison while they're been away",
		"Caster's home has served as a public latrine while they're been away",
		"Caster's home has served as a stable while they're been away",
		"Caster's home has served as an abattoir while they're been away",
		"Caster's home has served as an armory while they're been away",
		"Caster's home has served as an unholy altar while they're been away",
		"Caster's home has served as barracks while they're been away",
		...
		"Caster's Intelligence is equal to their level for 2d12 hours",
		...
		"Caster's left arm stretches to 2X the length of their body",
		"Caster's left hand and 10d10% of their arm turn to brass",
		...
		"Caster's left hand strongly resents their right hand",
		"Caster's left leg detaches and starts kicking them really hard",
		"Caster's left leg is covered by bark",
		"Caster's legs are both encased in a single thick, steel pipe",
		"Caster's legs are now exactly as long as their arms",
		"Caster's legs can't support their weight for 10d10 rounds",
		"Caster's legs double in length, and their arms shorten by 50%",
		"Caster's legs weigh as much as iron while they're wading",
		"Caster's limbs are rendered permanently invisible",
		"Caster's limbs each belong to a different species",
		"Caster's lungs are visible through their flesh and clothing",
		"Caster's lungs begin to function at 2X normal efficiency",
		"Caster's lungs begin to function at half normal efficiency",
		"Caster's lungs sound like bagpipes when they exerts himself",
		...
		"Caster's magic doesn't work if they're ankle-deep in water",
		...
		"Caster's mass increases by a factor of 10 while they're on a boat",
		"Caster's missile-based spells seem to issue from their eyes",
		"Caster's missile-based spells seem to issue from their mouth",
		...
		"Caster's nearest ally attacks them for 1d6 rounds",
		"Caster's nearest ally is invisible to them for 1d4 days",
		"Caster's neck doubles in length",
		"Caster's neck is invisible",
		"Caster's next 1d8 attacks inflict only illusionary damage",
		"Caster's next attack causes equal damage to them and their target",
		...
		"Caster's next spell functions but knocks them unconscious",
		"Caster's next spell persists until they're injured",
		"Caster's next spell turns its target bright blue for its duration",
		"Caster's next Summoning calls up something they can not put down",
		"Caster's next Summoning turns them into the Summoned creature",
		...
		"Caster's next Summoning yields the last thing that they expects",
		"Caster's next Summoning yields two of whatever they're Summoning",
		...
		"Caster's principal weapon disintegrates if it draws their blood",
		...
		"Caster's reflection commits suicide when they next sees it",
		"Caster's reflection harbors a deep and obvious resentment of him",
		"Caster's reflection is not mirror-reversed",
		"Caster's reflection shows them as battered corpse",
		"Caster's reflection shows them as they was 10 years ago",
		"Caster's reflection shows them beaten nearly to death",
		"Caster's right arm is encased in a cylinder of solid crystal",
		"Caster's right arm is just like their left arm, facing backwards",
		"Caster's right arm resembles a horse's foreleg",
		"Caster's right hand is a perfect sphere at the end of their wrist",
		"Caster's right hand struggles to grip their right elbow",
		"Caster's right leg increases in thickness by a factor of 1d4",
		"Caster's right thigh is as long as their entire left leg",
		...
		"Caster's skin appears to have been riveted to their body in sheets",
		...
		"Caster's skin is permanently stained by their blood",
		"Caster's skin is plaid from now on",
		"Caster's skin is suddenly the color of their hair",
		...
		"Caster's speech doesn't match the movement of their lips",
		...
		"Caster's spellbook contains 1d8 spells they're never seen before",
		...
		"Caster's spellbook contains pages and pages of risque woodcuts",
		...
		"Caster's spellbook gives faulty warnings about their impending doom",
		...
		"Caster's spellbook is invisible to them unless their hair is wet",
		...
		"Caster's spellbook is stolen by someone on their way to the latrine",
		...
		"Caster's spellbook tends to slam shut on their hand (1d2-1 damage)",
		"Caster's spellbook turns into a cat when they says a command word",
		"Caster's spellbook vanishes; they finds it in a nearby well",
		"Caster's spellbook vanishes; in 1d4 days they disgorges it",
		...
		"Caster's spellbook weighs as much as they does",
		"Caster's spellbook will combust if they opens it before dawn",
		"Caster's spells function as though cast by someone half their level",
		...
		"Caster's Strength is halved until they're struck by fire-based magic",
		...
		"Caster's voice issues from their right hand instead of their mouth",
		"Caster's voice makes people feel hostile and aggressive",
		"Caster's voice resonates in any gems nearby",
		"Caster's voice seems poorly matched to their age and sex",
		"Caster's voice seems to issue from 1d4 people around him",
		"Caster's voice seems to issue from their pockets",
		"Caster's voice seems to issue from some item they're now carrying",
		...
		"Caster's voice sounds like they're 1d100 years older",
		"Caster's voice sounds like that of each person to whom they speaks",
		...
		'Each day for 2d6 days, caster must reroll their attributes',
		'Each day, caster adds a cumbersome new title to their name',
		"Each day, caster attempts to prove that they're impervious to blades",
		'Each day, caster bores their allies with tales of their own heroism',
		'Each day, caster can add +1 (or +5%) to any one dice roll',
		'Each day, caster can cause one foe to miss one attack',
		'Each day, caster can detach their head for up to one hour',
		...
		'Each day, caster finds 1d10 human eyeballs in their pocket',
		'Each day, caster finds 1d4 gold pieces in their pocket',
		'Each day, caster finds a severed body part in their pocket',
		'Each day, caster has no idea who they is for 1d10 minutes',
		'Each day, caster increasingly obsesses about their waning lifespan',
		...
		'Each day, caster must Save or lose half of their hit points',
		'Each day, caster must Save vs Will or their home explodes',
		...
		'Each day, caster sees great meaning in the first words they hears',
		'Each day, caster suffers violent withdrawal unless they uses magic',
		'Each day, caster tells the same stupid joke about gnomes',
		'Each day, caster threatens to murder someone nearby',
		'Each day, caster wakes because a small pebble hits their forehead',
		...
		'Each day, caster wakes completely deaf until they drinks something',
		"Each day, caster wakes dressed in a mummy's filthy rags",
		'Each day, caster wakes exhausted as if they just ran a marathon',
		'Each day, caster wakes in a pile of dry leaves',
		"Each day, caster wakes looking as if they're been beaten with clubs",
		'Each day, caster wakes nearly out of their mind with rage',
		'Each day, caster wakes thinking that 1d100 days have passed',
		"Each day, caster wakes thinking that they're under attack",
		'Each day, caster wakes to find a loaf of warm bread on their chest',
		'Each day, caster wakes unable to see their allies for 1d4 turns',
		'Each day, caster wakes wearing a heavily powdered wig',
		'Each day, caster wakes wearing a straw hat',
		'Each day, caster wakes with a daisy sprouting from their mouth',
		'Each day, caster wakes with a gold coin in their mouth',
		'Each day, caster wakes with a hospital bracelet on their wrist',
		'Each day, caster wakes with their mouth packed full of flour',
		'Each day, caster wakes with no idea of how they got there',
		...
		"Each day, caster's nostrils appear at a new place on their head",
		...
		'Each morning, caster must Save or they ages 1d4 days',
		"Each morning, caster must Save or he'll be arrested before sunset",
		'Each morning, caster must Save or their clothes dissolve by sunset',
		'Each night as caster sleeps, every blade they owns is sharpened',
		"Each night as caster sleeps, they're 5% likely to trigger a Burst",
		'Each night as caster sleeps, their ankles are bound by silk cord',
		"Each night as caster sleeps, their lips move as though they're talking",
		"Each of caster's big toes is now as long as the rest of their foot",
		"Each of caster's big toes is now as wide as the rest of their foot",
		"Each of caster's teeth is now a different and contrasting color",
		"Each of caster's teeth screams each time they opens their mouth",
		...
		"Elementals Summoned in caster's presence attack them outright",
		...
		"Elementals Summoned in caster's presence mock them endlessly",
		...
		'Everyone now harboring ill will toward caster forgets who they is',
		'Everyone now harboring ill will toward caster knows where they is',
		...
		"Everyone who knows the caster suspects that they're really undead",
		'Everyone who knows the caster thinks that they owes them money',
		...
		"Foliage grows to entangle caster's feet if they stands still",
		'Food turns ethereal while the caster touches it',
		'For 1d4 days, caster can neutralize poisons by touch',
		'For 1d4 days, caster is certain that their saliva is poisonous',
		...
		"For 1d4 weeks, caster's nose hovers 1d4 inches before their face",
		...
		'If caster attempts a Summoning, they vanishes for its duration',
		'If caster attempts to create or control undead, they attack him',
		"If caster casts a spell in the next turn, they thinks they're drowning",
		'If caster casts a spell in the next turn, their clothing vanishes',
		'If caster comes within one mile of a dragon, their hair falls out',
		'If caster comes within one mile of an ocean, they begins to drown',
		'If caster damages a statue, they suffers an equivalent injury',
		"If caster dies and is resurrected, they're 85% likely to change sex",
		'If caster draws a weapon before sunset, they goes berserk',
		'If caster draws a weapon before sunset, that weapon vanishes',
		'If caster falls more than twenty yards, they teleports to this spot',
		"If caster has a beard, it vanishes; if they doesn't, they grows one",
		"If caster has a missile weapon, they're attacked by small animals",
		'If caster has drawn blood recently, they vanishes until sunrise',
		'If caster has eaten in the past hour, they falls unconscious',
		'If caster has eaten in the past hour, they loses 2d10 hit points',
		'If caster has eaten in the past hour, they never has to eat again',
		'If caster has eaten in the past hour, they vanishes until lunchtime',
		...
		'If caster has ever been resurrected, they loses 1d100 hit points',
		'If caster has ever been resurrected, they now gains one level',
		'If caster has ever been resurrected, they now loses one level',
		'If caster has ever been resurrected, they teleports to that spot',
		"If caster has slain anyone in cold blood, they're wracked by remorse",
		'If caster has slain anyone in cold blood, that person haunts him',
		'If caster ingests poison, they becomes powerfully addicted to it',
		'If caster ingests poison, they briefly gains 1d4 points of Wisdom',
		"If caster ingests poison, they can't be harmed by fire for 1d4 days",
		'If caster ingests poison, they combusts in 1d6 turns',
		'If caster ingests poison, they develops an intense, unusual phobia',
		'If caster ingests poison, they develops hundreds of ugly blisters',
		'If caster ingests poison, they forgets their name and how to speak',
		'If caster ingests poison, they hallucinates wildly for 2d20 hours',
		'If caster ingests poison, they is instantly aware of it',
		'If caster ingests poison, they smells like carrion for 1d4 weeks',
		'If caster ingests poison, they tries to cut it out of their body',
		"If caster ingests poison, they're 20% likely to change sex",
		'If caster ingests poison, their age is reduced by 1d20 years',
		'If caster ingests poison, their blood is corrosive to metal',
		'If caster ingests poison, their body shrinks by 1d100%',
		'If caster ingests poison, their fingers vanish',
		'If caster ingests poison, their teeth fall out',
		...
		'If caster is carrying a pouch, they attempts to climb into it',
		'If caster is carrying a pouch, they likes to wear it as a hat',
		'If caster is carrying a pouch, they uses it as a hand-puppet',
		'If caster is carrying a weapon, it attempts to strike him',
		'If caster is carrying a weapon, it turns into an umbrella',
		'If caster is carrying any blades, they throws them in a nearby lake',
		"If caster is carrying any blades, they're now incredibly sharp",
		'If caster is carrying any bread, it animates and attacks him',
		'If caster is carrying any coins, each weighs as much as they does',
		'If caster is carrying any coins, they develops an allergy to gold',
		"If caster is carrying any keys, they're all suddenly identical",
		'If caster is carrying any kind of key, it explodes violently',
		"If caster is carrying any metal, they can't cast magic until dawn",
		"If caster is carrying any metal, they thinks that they're rusting",
		'If caster is carrying any wood, they tries to eat it like a termite',
		"If caster is carrying any wood, they're attacked by termites",
		'If caster is carrying food, they becomes violently ill for an hour',
		'If caster is carrying food, they eats all of it as fast as they can',
		"If caster is carrying food, they're attacked by hungry hungry hippos",
		"If caster is carrying food, it's 4X as nutritious as normal food",
		'If caster is carrying their spellbook, they teleports 2d4 miles',
		'If caster is carrying their spellbook, they teleports to their home',
		"If caster is carrying their spellbook, they're illiterate for one week",
		"If caster is carrying their spellbook, they're reluctant to open it",
		'If caster is carrying their spellbook, it teleports to their home',
		'If caster is carrying their spellbook, it vanishes until dawn',
		'If caster is hit by a bludgeon, their head resembles a watermelon',
		'If caster is hit by a bludgeon, their head rings like a bronze gong',
		'If caster is now at full hit points, they vanishes for 1d12 hours',
		'If caster is now bleeding, they ages 10d10 years',
		'If caster is now bleeding, they attacks their nearest ally',
		'If caster is now bleeding, they can never use invisibility magic',
		"If caster is now bleeding, they can't be healed before midnight",
		"If caster is now bleeding, they can't use magic for 1d4 days",
		"If caster is now bleeding, they can't use magic for 2d12 hours",
		'If caster is now bleeding, they changes sex for 1d6 days',
		'If caster is now bleeding, they declares war on an imagined enemy',
		'If caster is now bleeding, they flees at top speed in a panic',
		'If caster is now bleeding, they gains 10,000 Experience Points',
		'If caster is now bleeding, they gains one level',
		'If caster is now bleeding, they loses another 4d10 hit points',
		'If caster is now bleeding, they races to the nearest coastline',
		'If caster is now bleeding, they teleports to their home',
		"If caster is now bleeding, they thinks that they're somebody else",
		"If caster is now bleeding, they're attacked by a shark",
		"If caster is now bleeding, they're forever immune to healing magic",
		"If caster is now bleeding, they're immune to fire magic until sunset",
		"If caster is now bleeding, they're permanently invisible to goblins",
		"If caster is now bleeding, they're reduced to just one hit point",
		"If caster is now bleeding, they're restored to full Health",
		"If caster is now bleeding, they're stricken mute until they're healed",
		'If caster is now bleeding, their blood glows in the dark',
		'If caster is now bleeding, their blood is flammable for 2d12 hours',
		'If caster is now bleeding, their hair grows 8d12 inches',
		'If caster is now bleeding, their weapon is +4 ToHit for 2d12 hours',
		'If caster is now bleeding, their weapons vanish until dawn',
		...
		"If caster is slain by a metal weapon, they can't be resurrected",
		"If caster is slain by a metal weapon, he'll rises as a zombie",
		'If caster is slain, they awakens the next day fully healed (once)',
		'If caster is slain, their killer is 20% likely to take their own life',
		'If caster is slain, their killer is universally hailed as a hero',
		'If caster is slain, their killer receives 100,000 gold pieces',
		'If caster is standing near open flame, they tries to extinguish it',
		'If caster is standing near open flame, they tries to ignite himself',
		'If caster is struck by an axe, they disgorges a pound of sawdust',
		'If caster is struck by an axe, they yells "timber" and falls over',
		'If caster is usually shy, they becomes very assertive, & vice versa',
		...
		'If caster is wearing a magic ring, they acquires a new language',
		'If caster is wearing a magic ring, they acquires an unusual phobia',
		'If caster is wearing a magic ring, they ages 1d100 years until dawn',
		'If caster is wearing a magic ring, they ages one year per round',
		'If caster is wearing a magic ring, they becomes loudly belligerent',
		'If caster is wearing a magic ring, they becomes nocturnal',
		'If caster is wearing a magic ring, they can breathe underwater',
		"If caster is wearing a magic ring, they can't be harmed by ice",
		"If caster is wearing a magic ring, they can't Detect Magic",
		"If caster is wearing a magic ring, they can't discern True North",
		"If caster is wearing a magic ring, they can't eat while wearing it",
		"If caster is wearing a magic ring, they can't leave this spot",
		"If caster is wearing a magic ring, they can't remove it by himself",
		"If caster is wearing a magic ring, they can't sit until sunrise",
		"If caster is wearing a magic ring, they can't sleep for 2d10 days",
		"If caster is wearing a magic ring, they can't speak above a whisper",
		"If caster is wearing a magic ring, they can't use it for 1d4 days",
		"If caster is wearing a magic ring, they can't wear any other rings",
		'If caster is wearing a magic ring, they claims to be an impostor',
		'If caster is wearing a magic ring, they claims to be enslaved to it',
		'If caster is wearing a magic ring, they claims to be indestructible',
		'If caster is wearing a magic ring, they claims to despise it',
		'If caster is wearing a magic ring, they claims to have created it',
		'If caster is wearing a magic ring, they claims to have stolen it',
		"If caster is wearing a magic ring, they decides that they're a god",
		'If caster is wearing a magic ring, they disgorges a large bell',
		'If caster is wearing a magic ring, they disgorges one just like it',
		'If caster is wearing a magic ring, they feels 1d100° colder',
		'If caster is wearing a magic ring, they finds an enormous diamond',
		'If caster is wearing a magic ring, they finds another just like it',
		'If caster is wearing a magic ring, they forgets how to use it',
		'If caster is wearing a magic ring, they founds a bizarre cult',
		'If caster is wearing a magic ring, they goes insane for 1d4 days',
		'If caster is wearing a magic ring, they grows suspicious of Elves',
		"If caster is wearing a magic ring, they hasn't eaten in weeks",
		'If caster is wearing a magic ring, they hates to use it indoors',
		'If caster is wearing a magic ring, they hates to use it outdoors',
		'If caster is wearing a magic ring, they joins a bizarre cult',
		'If caster is wearing a magic ring, they misplaces it',
		'If caster is wearing a magic ring, they refuses to speak to Dwarves',
		'If caster is wearing a magic ring, they regains 2d6 hit points',
		'If caster is wearing a magic ring, they rings like a bell',
		'If caster is wearing a magic ring, they shrinks by 50% until dawn',
		'If caster is wearing a magic ring, they suffers cannibalistic urges',
		"If caster is wearing a magic ring, they suspects that it's a fake",
		'If caster is wearing a magic ring, they thinks their allies covet it',
		"If caster is wearing a magic ring, they thinks it's consuming him",
		"If caster is wearing a magic ring, they thinks it's controlling him",
		"If caster is wearing a magic ring, they thinks that it's on fire",
		'If caster is wearing a magic ring, they throws it 4d6 feet from him',
		'If caster is wearing a magic ring, they tries to destroy it',
		'If caster is wearing a magic ring, they tries to sever that finger',
		'If caster is wearing a magic ring, they uses it whenever possible',
		'If caster is wearing a magic ring, they wants to swallow it',
		'If caster is wearing a magic ring, they weeps tears of honey',
		"If caster is wearing a magic ring, he'll die if they removes it",
		"If caster is wearing a magic ring, they're accused of sedition",
		"If caster is wearing a magic ring, they're allergic to it",
		"If caster is wearing a magic ring, they're attacked by crows",
		"If caster is wearing a magic ring, they're attacked by scarabs",
		"If caster is wearing a magic ring, they're blind until they removes it",
		"If caster is wearing a magic ring, they're declared guilty of heresy",
		"If caster is wearing a magic ring, they're eager to behead himself",
		"If caster is wearing a magic ring, they're imprisoned far away",
		"If caster is wearing a magic ring, they're known to have stolen it",
		"If caster is wearing a magic ring, they're placed under arrest",
		"If caster is wearing a magic ring, they're related to the king",
		"If caster is wearing a magic ring, they're reluctant to use it",
		"If caster is wearing a magic ring, they're struck by lightning",
		"If caster is wearing a magic ring, they're swarmed by vermin",
		"If caster is wearing a magic ring, they're terrified of its power",
		"If caster is wearing a magic ring, they're wearing a copy in their nose",
		'If caster is wearing a magic ring, their Charisma is 3 until dawn',
		'If caster is wearing a magic ring, their Charisma is 18 until dawn',
		'If caster is wearing a magic ring, their clothes turn invisible',
		'If caster is wearing a magic ring, their clothes turn to lead',
		'If caster is wearing a magic ring, their ears and nose fall off',
		'If caster is wearing a magic ring, their eyes turn invisible',
		'If caster is wearing a magic ring, their fingernails grow 1d4 feet',
		"If caster is wearing a magic ring, their hands look like a corpse's",
		'If caster is wearing a magic ring, their hands switch wrists',
		'If caster is wearing a magic ring, their head turns invisible',
		'If caster is wearing a magic ring, their teeth turn to gold',
		'If caster is wearing a magic ring, holy water burns their skin',
		...
		'If caster is wearing a magic ring, it becomes part of their body',
		...
		'If caster is wearing a magic ring, it derides their magical prowess',
		...
		'If caster is wearing a magic ring, it weighs more than they does',
		...
		"If caster is wearing a magic ring, it's suddenly in their stomach",
		'If caster is wearing a magic ring, its effect is reversed',
		'If caster is wearing a magic ring, its main function is altered',
		'If caster is wearing a magic ring, no one takes them seriously',
		'If caster is wearing a magic ring, smoke pours from their nostrils',
		...
		'If caster is wearing any armor, they attacks someone nearby',
		'If caster is wearing any armor, they removes it as fast as possible',
		'If caster is wearing any armor, they teleports to their home',
		'If caster is wearing any armor, it teleports to their home',
		'If caster is wearing any leather, they moos like a cow until sunset',
		'If caster is wearing any leather, they reeks of manure until sunset',
		"If caster is wearing gloves, they can't remove them",
		'If caster is wearing gloves, they requires no sleep for 1d4 weeks',
		'If caster is wearing gloves, they turn into fluffy wool mittens',
		'If caster is wearing gloves, they turn into rigid steel',
		'If caster kills anyone in the next turn, they also perishes',
		"If caster kills anyone in the next turn, they're declared a hero",
		'If caster rides a horse in the next 24 hours, it tries to eat him',
		'If caster sleeps in their boots, they can never again remove them',
		'If caster sleeps in their boots, they begin devouring them tonight',
		"If caster stands on a riverbank, they're attacked by crustaceans",
		'If caster stands on a riverbank, the bank crumbles beneath him',
		"If caster swallows a hot coal, they're 5% likely to turn to diamond",
		"If caster swallows a hot coal, it's 10% likely to turn to diamond",
		'If caster tells a lie, they giggles',
		"If caster tells a lie, they're 40% likely to declare it outright",
		'If caster uses Detect Magic, they loses 1d6 hit points',
		"If caster uses Detect Magic, they're blinded for 1d10 rounds",
		"If caster's carrying a dagger, they throws it at someone nearby",
		"If caster's carrying a dagger, they tries to stab himself with it",
		...
		'If hit by a bludgeon on a natural 20, caster loses their spellbook',
		...
		'Illusions cast by caster make them 2X as heavy for their duration',
		'In matters of barter, caster offers their spellbook first',
		...
		"Magical animals seem to mock the caster while they're not looking",
		...
		'Nearest tree falls on caster, pinning them but not harming him',
		'Nearest wizard decides that the caster owes them a favor',
		...
		'Next attack on caster causes them to hallucinate for 1d4 hours',
		'Next attack on caster has a +10 ToHit bonus',
		'Next attack on caster kills him, but they resurrects at dawn',
		'Next attack on caster literally knocks the smile off of their face',
		...
		'Next creature slain by caster infects them with a strange disease',
		...
		'Next creature slain by caster places a Geas on them as it dies',
		'Next creature slain by caster pursues them as a vengeful undead',
		'Next door opened by caster becomes sentient and animated',
		'Next door opened by caster can never be closed again',
		'Next door opened by caster can never be opened by them again',
		'Next door opened by caster causes a pit to open beneath their feet',
		'Next door opened by caster causes all of their spells to discharge',
		...
		'Next door opened by caster falls on them heavily',
		'Next door opened by caster floods the room on the opposite side',
		'Next door opened by caster gives them a useful bit of information',
		'Next door opened by caster hurls them out of the nearest window',
		...
		'Next door opened by caster knocks them unconscious',
		...
		'Next door opened by caster leads to their home',
		...
		'Next door opened by caster leads to the last door they opened',
		...
		'Next door opened by caster leads to the room that they just left',
		...
		'Next door opened by caster restores them to full hit points',
		...
		"Next enemy to wound caster can't harm them for 1d4 days thereafter",
		'Next enemy to wound caster disarms himself and runs away',
		'Next enemy to wound caster gains one level or hit die',
		'Next enemy to wound caster heroically defends them for 1d4 turns',
		...
		'Next enemy to wound caster is teleported to their own home',
		'Next enemy to wound caster is thrown 4d6 hours into the future',
		'Next enemy to wound caster sinks into the ground to their knees',
		'Next enemy to wound caster suffers an equivalent injury',
		'Next enemy to wound caster then attacks their own allies',
		...
		'Next horse ridden by caster gains Intelligence equal to their own',
		...
		"Next person to see caster's reflection attacks them immediately",
		'Next person to touch the caster acquires illusory leprosy',
		"Next person to touch the caster can't speak to them until sunset",
		'Next person to touch the caster is dressed just like him',
		'Next person to touch the caster is invisible to them for 1d4 days',
		'Next person to touch the caster is stricken permanently bald',
		'Next person to touch the caster then attacks them for one round',
		'Next person to whom caster speaks acquires a phony language',
		"Next person to whom caster speaks adopts the caster's voice",
		'Next person to whom caster speaks attacks them for 1d6 rounds',
		'Next person to whom caster speaks can Command them 1d4 times',
		...
		'Next person to whom caster speaks hates them for 1d4 hours',
		'Next person to whom caster speaks ignores them for 2d4 hours',
		'Next person to whom caster speaks is destined to kill them someday',
		'Next person to whom caster speaks is dressed just like him',
		'Next person to whom caster speaks is invisible to them until dawn',
		...
		'Next person to whom caster speaks looks just like them until dawn',
		'Next person to whom caster speaks mocks them outrageously',
		'Next person to whom caster speaks must give them 8d8 gold pieces',
		...
		'Next potion imbibed by caster alerts everyone to their whereabouts',
		'Next potion imbibed by caster burns their home to the ground',
		"Next potion imbibed by caster cancels any resurrections they're had",
		'Next potion imbibed by caster causes them to be Slowed',
		'Next potion imbibed by caster causes them to spit out wood chips',
		'Next potion imbibed by caster causes them to sprout feathers',
		'Next potion imbibed by caster causes them to sprout tentacles',
		'Next potion imbibed by caster causes their clothing to disintegrate',
		'Next potion imbibed by caster causes their voice to echo ominously',
		'Next potion imbibed by caster changes their alignment for 2d8 hours',
		'Next potion imbibed by caster changes their sex for its duration',
		'Next potion imbibed by caster cures them of any current diseases',
		'Next potion imbibed by caster doubles in volume 1d20 times',
		'Next potion imbibed by caster enables them to breathe underwater',
		'Next potion imbibed by caster enlarges their hands by 50%',
		'Next potion imbibed by caster freezes them solid until sunset',
		'Next potion imbibed by caster gives them chimp-like proportions',
		'Next potion imbibed by caster glues their mouth shut',
		...
		'Next potion imbibed by caster hurls them 5d10 yards',
		...
		'Next potion imbibed by caster is 5% likely to kill them outright',
		...
		'Next potion imbibed by caster lasts only until they speaks',
		'Next potion imbibed by caster makes foliage sprout from their head',
		'Next potion imbibed by caster makes gold invisible to him',
		'Next potion imbibed by caster makes them -4 to Save vs Fortitude',
		'Next potion imbibed by caster makes them a terrific dancer',
		'Next potion imbibed by caster makes them age one year per round',
		'Next potion imbibed by caster makes them ambidextrous',
		'Next potion imbibed by caster makes them blink like a neon sign',
		'Next potion imbibed by caster makes them crave raw meat',
		'Next potion imbibed by caster makes them forget their name',
		'Next potion imbibed by caster makes them forget the past 24 hours',
		'Next potion imbibed by caster makes them hate magic for 1d4 days',
		'Next potion imbibed by caster makes them hate to answer questions',
		'Next potion imbibed by caster makes them horrifyingly ugly',
		'Next potion imbibed by caster makes them illiterate for 1d10 days',
		'Next potion imbibed by caster makes them invisible for 1d6 turns',
		'Next potion imbibed by caster makes them invisible to undead',
		'Next potion imbibed by caster makes them levitate 1d10 yards',
		'Next potion imbibed by caster makes them look 5d10 years older',
		'Next potion imbibed by caster makes them look like an infant',
		'Next potion imbibed by caster makes them lose 1d100 pounds',
		'Next potion imbibed by caster makes them overwhelmingly beautiful',
		'Next potion imbibed by caster makes them profoundly drunk',
		'Next potion imbibed by caster makes them see fire all around him',
		'Next potion imbibed by caster makes them seem far more charming',
		'Next potion imbibed by caster makes them spin rapidly 1d100 times',
		'Next potion imbibed by caster makes them sweat blood',
		"Next potion imbibed by caster makes them think they doesn't exist",
		"Next potion imbibed by caster makes them think that they're dead",
		"Next potion imbibed by caster makes them think that they're drowning",
		"Next potion imbibed by caster makes them think that they're invisible",
		"Next potion imbibed by caster makes them think that it's poison",
		'Next potion imbibed by caster makes their arms and legs invisible',
		'Next potion imbibed by caster makes their face invisible',
		'Next potion imbibed by caster makes their flesh invisible',
		'Next potion imbibed by caster makes their hands and feet invisible',
		...
		'Next potion imbibed by caster paralyzes their hands until sunset',
		'Next potion imbibed by caster reduces them to one hit point',
		'Next potion imbibed by caster restores them to full hit points',
		'Next potion imbibed by caster reveals any secret doors nearby',
		'Next potion imbibed by caster rotates their feet 180°',
		'Next potion imbibed by caster sets their hair ablaze',
		'Next potion imbibed by caster shrinks their hands by 50%',
		'Next potion imbibed by caster snuffs all fires within one mile',
		'Next potion imbibed by caster solidifies in their stomach',
		'Next potion imbibed by caster strikes them bald for one year',
		'Next potion imbibed by caster tastes like lamp oil',
		'Next potion imbibed by caster teleports them to their home',
		'Next potion imbibed by caster throws them 1d4 days into the future',
		'Next potion imbibed by caster triggers a Chaos Burst',
		'Next potion imbibed by caster turns them into 1d100 frogs',
		'Next potion imbibed by caster turns them into a zombie until dawn',
		'Next potion imbibed by caster turns them to vapor for 1d10 rounds',
		'Next potion imbibed by caster turns their hands into feet',
		'Next potion imbibed by caster turns their head to a cube',
		'Next potion imbibed by caster turns their lips and tongue to steel',
		'Next potion imbibed by caster turns their skeleton to steel',
		'Next potion imbibed by caster turns their skin permanently orange',
		'Next potion imbibed by caster turns their speech to gibberish',
		'Next potion imbibed by caster works only during every other round',
		'Next puddle stepped in by caster drains 1d10 hit points',
		'Next puddle stepped in by caster freezes solid around their feet',
		...
		"Next puddle stepped in by caster makes them think they're drowning",
		'Next puddle stepped in by caster renders them briefly invulnerable',
		'Next puddle stepped in by caster restores 1d10 hit points',
		'Next puddle stepped in by caster soaks them from head to toe',
		'Next puddle stepped in by caster teleports them to a puddle nearby',
		'Next puddle stepped in by caster throws them 1d20 yards',
		...
		'Next spell to hit the caster also renders their head invisible',
		'Next spell to hit the caster causes them to glow brightly',
		'Next spell to hit the caster leaves them hideously scarred',
		'Next spell to hit the caster likewise affects whoever cast it',
		'Next spell to hit the caster renders them blind for its duration',
		'Next spell to hit the caster takes effect 4d6 hours later',
		'Next successful attack upon caster hits a bystander instead',
		'Next successful attack upon caster knocks them unconscious',
		'Next sword that wounds caster acquires a permanent +2 bonus',
		'Next sword that wounds caster heals them for 1d10 hit points',
		...
		'Next sword that wounds caster mimics their personality thereafter',
		...
		"Next time caster's restored to full hit points, they shrinks by 50%",
		...
		'No matter how far the caster travels today, they winds up here',
		"No more than 60% of caster's body can become invisible at a time",
		'No one now within 10 yards of caster can harm them until dawn',
		'No one within 100 miles trusts caster enough to lend them money',
		...
		'On a successful attack roll, caster must Save or drop their weapon',
		...
		'Once per day, caster can cause their shoes or boots to vanish',
		'Once per day, caster can cause their spellbook to ignite',
		...
		'Once per day, caster can make their clothes vanish for 1d10 rounds',
		'Once per day, caster can make someone briefly forget their name',
		...
		'Once per day, caster can turn their hands ethereal for 1d6 rounds',
		'Once per day, caster can turn their hands invisible for 1d10 rounds',
		'Once per day, caster can turn their head 360° at the neck, unharmed',
		'Once per day, caster can turn their teeth invisible for 10 minutes',
		...
		'Once per week, caster can appear to be half their age for two hours',
		'Once per week, caster can cause all nearby to forget their name',
		'Once per week, caster can cause their hair to grow 1d4 inches',
		...
		'Once per week, caster can hold their breath for a full hour',
		...
		'Once per week, caster can teleport their spellbook up to 1d4 miles',
		...
		"One of caster's arms now juts from the center of their chest",
		...
		"One of caster's pockets accesses a small box in their home",
		...
		'Predators react to the caster as if they were a small rabbit',
		...
		'Scavengers and carrion birds react to caster as if they were dead',
		...
		"Something about the caster makes people suspect that they're dying",
		...
		'The clothes caster is wearing makes them dangerous overconfident',
		'The clothes caster is wearing makes them feel intensely cold',
		...
		"The ground beneath caster's feet sinks a depth 2X their height",
		...
		'Tomorrow, caster finds a book detailing their complete dissection',
		'Tomorrow, caster finds a jar containing 1d20 tiny elephants',
		"Tomorrow, caster finds a key to a lock that doesn't yet exist",
		'Tomorrow, caster finds a key to that mysterious door in their home',
		...
		'Tomorrow, caster finds a ruby as large as their head',
		...
		'Tomorrow, caster finds a tunnel that leads to their home',
		'Tomorrow, caster finds a vial containing a viscous salve',
		'Tomorrow, caster finds their own badly-decomposed corpse',
		'Tomorrow, caster finds what looks like their own severed head',
		...
		'Tomorrow, caster meets their long-lost and malevolent twin',
		'Tomorrow, caster meets their mentor, who expresses disapproval',
		...
		"Tomorrow, caster meets someone convinced that they doesn't exist",
		'Tomorrow, caster meets someone desperate to be their bodyguard',
		...
		'Tomorrow, caster meets someone who can remove their own heart',
		'Tomorrow, caster meets someone who can remove their skin at will',
		...
		'Tomorrow, caster meets someone who claims to be their father',
		'Tomorrow, caster meets someone who claims to be their grandchild',
		...
		'Tomorrow, caster meets someone who names the caster their heir',
		'Tomorrow, caster meets someone who offers them their firstborn son',
		'Tomorrow, caster meets someone who offers to sell them an artifact',
		'Tomorrow, caster meets someone who owes them a lot of money',
		'Tomorrow, caster meets someone who tries to eat their eyes',
		'Tomorrow, caster meets someone who wants to buy their pancreas',
		...
		'Tomorrow, caster meets someone whom they owes a lot of money',
		...
		"Tomorrow, caster thinks they're awakened from a centuries-long sleep",
		'Tomorrow, caster thinks that magic no longer functions',
		'Tomorrow, caster uncovers a well-funded plot against their life',
		'Tomorrow, caster unknowingly snubs a powerful spellcaster',
		'Tomorrow, caster vanishes at dawn and reappears at sunset',
		'Tomorrow, caster wakes 2d10 miles from where they fell asleep',
		'Tomorrow, caster wakes and gives apparently divine prophecy',
		"Tomorrow, caster wakes as if they're spent a month in the desert",
		'Tomorrow, caster wakes at this location',
		'Tomorrow, caster wakes convinced that all of their allies are dead',
		'Tomorrow, caster wakes convinced that they must return to their home',
		"Tomorrow, caster wakes convinced that they're just been created",
		"Tomorrow, caster wakes convinced that they're just been resurrected",
		"Tomorrow, caster wakes convinced that they're murdered their allies",
		"Tomorrow, caster wakes convinced that they're slept for 2d10 years",
		'Tomorrow, caster wakes convinced that their limbs are mechanical',
		...
		'Tomorrow, caster wakes unable to stand until they casts a spell',
		'Tomorrow, caster wakes where they awoke this morning',
		'Tomorrow, caster wakes with a mouthful of mud from a cemetery',
		'Tomorrow, caster wakes with mysterious tattoos all over their body',
		...
		"Undead have commandeered caster's home while they're been away",
		'Undead skeletons react to caster as if they were one of them',
		'Undead tend to ignore the caster until they acts against them',
		...
		'When caster dies, 10d10 voles burst from their corpse',
		...
		"When caster dies, they can't be resurrected for 1d12 months",
		"When caster dies, they're discovered to have died centuries ago",
		"When caster dies, they're found to have been remotely controlled",
		"When caster dies, they're quickly impersonated by a doppelganger",
		'When caster dies, their allies deny that they ever knew him',
		'When caster dies, their corpse appears riddled by gunfire',
		'When caster dies, their corpse attacks the nearest Elf',
		'When caster dies, their corpse disgorges 10d1000 gallons of water',
		'When caster dies, their corpse giggles maniacally for 1d4 hours',
		'When caster dies, their corpse is dismembered and scattered',
		'When caster dies, their corpse is dragged away by goblins',
		'When caster dies, their corpse is elected to public office',
		'When caster dies, their corpse melts like a snowman',
		'When caster dies, their corpse runs shrieking through a nearby town',
		'When caster dies, their corpse shatters into countless fragments',
		'When caster dies, their corpse swells to 1d6 times normal size',
		'When caster dies, their corpse turns to densely packed salt',
		'When caster dies, their corpse turns to solid bronze',
		'When caster dies, their corpse weighs as much as lead',
		'When caster dies, their heart assumes a life of its own',
		'When caster dies, their killer is thrown 1d20 days into the future',
		'When caster dies, their last word is "Rosebud"',
		'When caster dies, their name becomes synonymous with treachery',
		'When caster dies, their skeleton turns to glass',
		'When caster dies, their skull turns to wood',
		'When caster dies, their spellbook burns to cinders in 1d4 rounds',
		'When caster dies, their veins are discovered to be filled with gold',
		'When caster dies, some random person nearby dies as well',
		'When caster dies, the first person to touch their corpse also dies',
		'When caster dies, the nearest town is evacuated',
		'When caster dies, the nearest tree falls on their corpse',
		'When caster dies, the sky turns blood red for 2d4-1 days',
		'When caster dies, violent riots break out in the nearest town',
		'When caster is angry, a small snake slithers out of their ear',
		'When caster is angry, they foams at the mouth like a rabid dog',
		'When caster is angry, they turns bright green',
		'When caster is angry, their face appears scarred and deformed',
		'When caster is angry, their face appears to glisten with slime',
		'When caster is angry, their head appears to be a bare skull',
		'When caster is angry, insects appear to swarm over their face',
		'When caster is angry, steam billows from their nostrils',
		'When caster is surprised, they randomly teleports 1d4 yards',
		'When caster is surprised, their head briefly doubles in size',
		'When caster is surprised, their head spins 360°',
		'When caster next casts this spell, they becomes hopelessly lost',
		'When caster next casts this spell, they feels overwhelming deja vu',
		'When caster next casts this spell, they teleports to this spot',
		"When caster next casts this spell, they're attacked by squirrels",
		"When caster next casts this spell, they're paralyzed until sunset",
		"When caster next casts this spell, they're stricken with Confusion",
		'When caster next casts this spell, their age temporarily doubles',
		'When caster next casts this spell, their clothing attacks him',
		'When caster next casts this spell, their clothing freezes solid',
		'When caster next casts this spell, their clothing turns to cheese',
		'When caster next casts this spell, the winter solstice occurs',
		'When caster next draws blood, a large pit opens beneath him',
		'When caster next draws blood, they disgorges 1d10 gallons of blood',
		'When caster next draws blood, they laughs like a demon',
		'When caster next draws blood, they leaps 4d6 hours into the future',
		'When caster next draws blood, they loses 2d10 hit points',
		'When caster next draws blood, they must Save or fall unconscious',
		'When caster next draws blood, they regains 1d10 hit points',
		'When caster next draws blood, they suffers an equivalent wound',
		'When caster next draws blood, they teleports 1d100 yards',
		"When caster next draws blood, they're addicted to the taste of blood",
		"When caster next draws blood, they're attacked by rabid bats",
		"When caster next draws blood, they're restored to full hit points",
		"When caster next draws blood, they're stricken mute until sunrise",
		'When caster next draws blood, their eyes blaze with flame',
		'When caster next draws blood, their weapon turns to steam',
		'When caster next draws blood, rain immediately begins to fall',
		'When caster next draws blood, thunder rumbles in the distance',
		'When caster next enters a building, they teleports onto its roof',
		'When caster next enters a building, their clothes catch fire',
		'When caster next enters a lake, any boats nearby turn invisible',
		'When caster next enters a lake, they blasphemes some ocean god',
		'When caster next enters a lake, they decides to become amphibious',
		'When caster next enters a lake, they discovers a small island',
		'When caster next enters a lake, they emerges draped with seaweed',
		'When caster next enters a lake, they encounters a lady with a sword',
		'When caster next enters a lake, they encounters a tentacled monster',
		'When caster next enters a lake, they finds 1d4 valuable pearls',
		'When caster next enters a lake, they has visions of a sunken city',
		'When caster next enters a lake, they spouts water like a whale',
		'When caster next enters a lake, they suffers severe hypothermia',
		'When caster next enters a lake, they teleports to a different lake',
		"When caster next enters a lake, they're 30% likely to become a fish",
		"When caster next enters a lake, they're attacked by sharks",
		"When caster next enters a lake, they're attacked by turtles",
		"When caster next enters a lake, they're befriended by otters",
		"When caster next enters a lake, they're caught in a fisherman's net",
		"When caster next enters a lake, they're covered with barnacles",
		"When caster next enters a lake, they're hit by 2d8 harpoons",
		"When caster next enters a lake, they're mistaken for a sea monster",
		"When caster next enters a lake, they're sucked up into a waterspout",
		"When caster next enters a lake, they're swept toward the sea",
		"When caster next enters a lake, they're thrown to the opposite shore",
		'When caster next enters a lake, their clothing inflates',
		'When caster next enters a lake, their clothing vanishes',
		"When caster next enters a lake, their feet turn into duck's feet",
		'When caster next enters a lake, their hands and feet grow webbing',
		'When caster next enters a lake, their home is completely flooded',
		'When caster next enters a lake, their pockets fill with sodium',
		...
		'When caster next enters a town, they finds a magical scroll',
		'When caster next enters a town, they violates community standards',
		"When caster next enters a town, they're imprisoned for murder",
		"When caster next enters a town, they're named as its patron saint",
		"When caster next enters a town, they're quickly arrested for heresy",
		"When caster next enters a town, they're quickly elected mayor",
		"When caster next enters a town, they're recognized as a vampire",
		"When caster next enters a town, they're sold into slavery",
		'When caster next enters a town, their spellbook is confiscated',
		...
		'When caster next enters their home, 1d4 exterior walls vanish',
		'When caster next enters their home, 1d4 weeks pass in 1d4 rounds',
		'When caster next enters their home, a small hill rises beneath it',
		'When caster next enters their home, any curses upon them are lifted',
		'When caster next enters their home, they ages 1d10 years',
		'When caster next enters their home, they ages 1d10 years',
		"When caster next enters their home, they doubts they're ever lived there",
		'When caster next enters their home, they falls unconscious',
		'When caster next enters their home, they finds 1d100+100 gold pieces',
		'When caster next enters their home, they finds a secret trapdoor',
		'When caster next enters their home, they finds a troll in residence',
		'When caster next enters their home, they finds another spellbook',
		'When caster next enters their home, they finds their clone in residence',
		'When caster next enters their home, they finds it completely empty',
		'When caster next enters their home, they forgets how to exit again',
		'When caster next enters their home, they gains one level',
		'When caster next enters their home, they is healed of all damage',
		'When caster next enters their home, they loses a point of Wisdom',
		'When caster next enters their home, they loses any memorized spells',
		'When caster next enters their home, they must evict 2d10 squatters',
		"When caster next enters their home, they realizes it's made of coral",
		'When caster next enters their home, they recognizes nothing within it',
		'When caster next enters their home, they teleports to this location',
		"When caster next enters their home, they're attacked by kobolds",
		"When caster next enters their home, they're blinded for 4d12 hours",
		"When caster next enters their home, they're convinced it isn't his",
		"When caster next enters their home, they're drafted into the military",
		"When caster next enters their home, they're visited by solicitors",
		"When caster next enters their home, they're visited by three ghosts",
		'When caster next enters their home, their age is reduced by 3d4 years',
		'When caster next enters their home, their bed combusts violently',
		'When caster next enters their home, their clothes burst into flame',
		'When caster next enters their home, their clothes turn to stone',
		'When caster next enters their home, it becomes indestructible',
		'When caster next enters their home, it becomes steamy like a sauna',
		'When caster next enters their home, it doubles its current size',
		'When caster next enters their home, it drifts slowly out to sea',
		'When caster next enters their home, it falls into a heap of sawdust',
		'When caster next enters their home, it gains an additional level',
		'When caster next enters their home, it migrates 1d20 miles',
		'When caster next enters their home, it sinks into the ground',
		'When caster next enters their home, it turns invisible from within',
		'When caster next enters their home, it turns to glass',
		"When caster next enters their home, it's been thoroughly cleaned",
		"When caster next enters their home, it's buried by an avalanche",
		"When caster next enters their home, it's buried by volcanic ash",
		"When caster next enters their home, it's encircled by a deep moat",
		"When caster next enters their home, it's flattened by a meteor",
		"When caster next enters their home, it's infested with vermin",
		"When caster next enters their home, it's swept away by a tidal wave",
		"When caster next enters their home, it's totally refurbished",
		'When caster next enters their home, its doors and windows vanish',
		'When caster next enters their home, monsters reside under the bed',
		"When caster next enters their home, someone's eaten their porridge",
		'When caster next enters their home, the doors & windows fuse shut',
		'When caster next enters their home, the floor vanishes',
		'When caster next enters their home, the magistrate condemns it',
		'When caster next enters their home, the roof ignites',
		"When caster next kills someone, they appears in that person's home",
		'When caster next kills someone, they must Save vs Fortitude or die',
		'When caster next kills someone, that person quickly resurrects',
		"When caster next opens their spellbook, they're attacked by a shark",
		'When caster next says their name, 2d6 fish leap from their mouth',
		'When caster next says their name, a bird flies into their mouth',
		"When caster next says their name, they learns it's not their real name",
		'When caster next says their name, they promptly forgets their name',
		'When caster next says their name, their mouth is sealed shut',
		'When caster next teleports, they arrives bound and gagged',
		'When caster next teleports, they arrives fully Healed',
		'When caster next touches money, they triggers a Chaos Burst',
		'When caster next triggers a Burst, they teleports to this location',
		...
		'When caster next uses magic, an ice statue of them appears nearby',
		"When caster next uses magic, any gold they're carrying vanishes",
		'When caster next uses magic, cold water sprays from their ears',
		'When caster next uses magic, they and their allies are drenched',
		'When caster next uses magic, they becomes drunk for 1d4 hours',
		'When caster next uses magic, they becomes invisible to their allies',
		'When caster next uses magic, they disgorges 2d6 large clay bricks',
		'When caster next uses magic, they loses 3d4 hit points',
		'When caster next uses magic, they must Save or fall unconscious',
		'When caster next uses magic, they reeks of sulfur for 1d10 hours',
		'When caster next uses magic, they teleports 10d10 yards randomly',
		'When caster next uses magic, they teleports into a nearby building',
		"When caster next uses magic, they thinks that they're at death's door",
		"When caster next uses magic, they're 5% likely to lose one level",
		"When caster next uses magic, they're 10% likely to die outright",
		"When caster next uses magic, they're shunned by other magic users",
		"When caster next uses magic, they're thrown back to this moment",
		'When caster next uses magic, their clone appears nearby',
		'When caster next uses magic, their clone teleports to their home',
		'When caster next uses magic, their clothes turn to paper',
		'When caster next uses magic, their hands double in size',
		'When caster next uses magic, their hands freeze solid',
		'When caster next uses magic, their nearest ally falls unconscious',
		"When caster next wears a hat, they're targeted for assassination",
		"When caster opens their spellbook, they're shrouded by darkness",
		'When caster opens their spellbook, thunder rumbles overhead',
		'When caster teleports, they arrives 1d4 miles from the destination',
		'When caster teleports, they arrives 2d4 hours later than expected',
		'When caster teleports, they arrives blinded for 1d6 rounds',
		'When caster teleports, they arrives in an embarrassing posture',
		'When caster teleports, they arrives invisible',
		'When caster teleports, they arrives ravenously hungry',
		'When caster teleports, they arrives upside down',
		'When caster teleports, they arrives with half of their gear missing',
		'When caster teleports, only 95% + 1d10% of their body is teleported',
		'When caster tells a falsehood, they confesses it to everyone nearby',
		'When caster uses Mirror Image, 10X the number of Images appear',
		"When caster uses Mirror Image, they can't tell which image is real",
		...
		"When caster's blood is next spilled, they ages 5d10 years",
		"When caster's blood is next spilled, they can't speak for 1d4 turns",
		"When caster's blood is next spilled, they're blinded for 1d4 rounds",
		...
		'When next struck by magic, caster sprouts wool from their arms',
		...
		'When reduced to one hit point, caster teleports to their home',
		...
		'Whenever caster casts a spell, electricity crackles in their hair',
		'Whenever caster casts a spell, ghostly laughter echoes in the air',
		'Whenever caster casts a spell, they appears to explode',
		'Whenever caster casts a spell, they becomes light as a feather',
		'Whenever caster casts a spell, they experiences profound remorse',
		'Whenever caster casts a spell, they feels overwhelming euphoria',
		'Whenever caster casts a spell, they hears glass breaking everywhere',
		'Whenever caster casts a spell, they hears loud, discordant music',
		'Whenever caster casts a spell, they hears the laments of the damned',
		'Whenever caster casts a spell, they must Save or be knocked down',
		'Whenever caster casts a spell, they must Save or shrink by 20%',
		'Whenever caster casts a spell, they suffers crippling stage fright',
		'Whenever caster casts a spell, they thinks that they ages 1d10 years',
		'Whenever caster casts a spell, they whistles like a teapot',
		"Whenever caster casts a spell, they're 10% likely to pass out",
		"Whenever caster casts a spell, they're haunted by cryptic warnings",
		'Whenever caster casts a spell, their bones glow visibly in their body',
		'Whenever caster casts a spell, their clothes are glazed with frost',
		'Whenever caster casts a spell, their ears shine like the sun',
		'Whenever caster casts a spell, their feet swell by 10%',
		'Whenever caster casts a spell, their spellbook must Save or combust',
		'Whenever caster casts a spell, one of their hands grows by 25%',
		'Whenever caster casts a spell, someone far away vows to kill him',
		"Wherever caster walks, they sounds like they're on a squeaky floor",
		'While caster is invisible, a faint outline can still be seen',
		'While caster sleeps, they appears to be a perfect cube',
		'While caster sleeps, they appears to melt like a wax dummy',
		'While caster sleeps, they freezes solid but thaws before waking',
		'While caster sleeps, their allies must Save or forget who they is',
		'While caster sleeps, their arms and legs retract into their torso',
		'While caster sleeps, their body is translucent',
		'While caster sleeps, their body retracts into their head',
		'While caster sleeps, their clothing and gear are invisible',
		'While caster sleeps, their head appears detached from their body',
		'While caster sleeps, their head retracts into their body',
		'While caster sleeps, their whole body contracts into a small ball',
		'While caster sleeps, luminous moths flutter over their body',
		'While caster sleeps, mysterious runes hover over their head',
		'While caster sleeps, rodents bring them sacrificial offerings',
		'While caster sleeps, thousands of insects swarm over their body',
		'While indoors, caster appears to be 5% larger',
		"While indoors, caster feels as if they're dragging heavy chains",
		"While indoors, caster feels as if they're in a blazing desert",
		"While indoors, caster feels as if they're on a ship's deck",
		"While indoors, caster feels as if they're on windswept tundra",
		'While standing on a riverbank, caster is invisible to amphibians',
		"While walking, caster sounds as if they're wearing full plate armor",
		'Woodland creatures openly mock the caster and call them a coward',
		"Woodland creatures react to the caster as if they're one of them",
		"Woodland creatures react violently to the caster's presence",
		"Zombies can't come within 10 feet of the caster for 1d4 days",
		"1d8 of target's fingers reappear elsewhere on their body",
		...
		'An earthen duplicate of the target wants to take their place',
		"An evergreen sprouts from target's chest while they sleeps tonight",
		...
		'Any missile weapons now carried by target have their name on them',
		...
		'Any missiles fired near target orbit them like satellites',
		...
		'Any undead now within 10 yards of target attack them until slain',
		...
		"Any wooden weapons that wound the target vanish until they're dead",
		...
		"Anyone cutting target with a blade can't speak to them until dawn",
		...
		'Anyone cutting target with a blade is soaked with their own blood',
		...
		"Anyone cutting target with a blade thinks they're an ally",
		...
		"Anyone looking into the target's ear has visions of their own death",
		...
		'Anyone touching the target in the next turn adopts their name',
		...
		'Anyone who wounds the target is 5% likely to kill them outright',
		...
		"As target is wounded more severely, they're less likely to sense it",
		...
		"Bits of gristle tumble from the target's mouth while they speaks",
		...
		"Both of target's arms are now on the same side of their body",
		...
		"Creatures Summoned in target's presence beg them for mercy",
		"Creatures Summoned in target's presence have only 1 hit point",
		"Creatures Summoned in target's presence obey them unswervingly",
		...
		"Creatures Summoned in target's presence worship them as a god",
		...
		'Each day, target can turn their skin invisible for up to one hour',
		...
		"Each of target's feet is chained to their neck",
		"Each of target's feet tries to race away in a different direction",
		"Each of target's feet weighs as much as the rest of their body",
		"Each of target's hands fuses to the opposite elbow",
		'Each time target is injured, a gold coin appears in their mouth',
		'Each time target is injured, they must Save or fall unconscious',
		'Each time target is injured, they must Save or go blind',
		'Each time target is injured, howls like a wolf',
		'Each time target opens their mouth, a small toad leaps out of it',
		'Each time target opens their mouth, another tooth turns invisible',
		'Each time target opens their mouth, they hears eerie music nearby',
		'Each time target opens their mouth, nearby birds fall silent',
		"Electricity crackles in target's clothing when they're angry",
		"Electricity crackles in target's skin as they makes an attack",
		...
		"Electricity crackles in the target's hair when they uses magic",
		...
		'Every other day, the target is 5d10 years older than their true age',
		...
		'Everyone now within 10 yards of target attacks them for 1d4 rounds',
		'Everyone now within 10 yards of target ignores them for 1d4 hours',
		...
		'Everyone now within 10 yards of target shouts their name',
		"Everyone who knows the target's name fears them for 3d10 rounds",
		"Everyone who knows the target's name forgets what they looks like",
		"Everyone who knows the target's name owes them 1d4 gold pieces",
		"Everyone who knows the target's name thinks their name is Twinkles",
		...
		"For 1d4 days, target can't speak to anyone who knows their name",
		"For one week, target can't be healed by any magical means",
		"For one week, target can't be injured by members of their species",
		...
		"Half of target's head explodes, killing them messily",
		"Half of target's head is covered in fine gold scales",
		"Half of target's head is covered in fragrant blue moss",
		"Half of target's head vanishes, but they're basically unharmed",
		...
		'Hundreds of wasps swarm the target whenever they draws a weapon',
		...
		'If an arrow hits the target in the next 1d3 rounds, they explodes',
		'If an arrow hits the target in the next round, they doubles in size',
		'If an arrow hits the target in the next round, they turns to glass',
		"If an arrow hits the target in the next round, they're fully healed",
		'If next attack on target causes maximum damage, they dies',
		'If next attack on target causes maximum damage, their attacker dies',
		...
		'If target attempts to teleport, their nervous system stays behind',
		"If target disembowels himself, they're 10% likely to become a god",
		"If target draws a weapon, they can't sheathe it again for 4d6 hours",
		"If target draws a weapon, they can't sheathe it until they're wounded",
		"If target draws a weapon, they can't use it for 1d4 rounds",
		"If target draws a weapon, it's 5% likely to shatter outright",
		'If target eats raw meat, they bleeds from the ears for 4d4 rounds',
		'If target eats raw meat, they has visions of a possible future',
		'If target eats raw meat, they has visions of their own death',
		'If target eats raw meat, they succumbs to voracious bloodlust',
		"If target eats raw meat, they're thrown into the nearest river",
		'If target eats raw meat, it increases in volume by a factor of 10',
		'If target eats raw meat, it turns to hot ashes in their stomach',
		'If target has a shield, it becomes fused to their arm',
		'If target has a shield, it claps shut on their arm like a clamshell',
		'If target has a shield, it now weighs 500 pounds',
		'If target has a shield, it vanishes, taking their arm with it',
		...
		'If target has any leather, they sprouts horns like a bull',
		"If target has any leather, they're soaked with lamp oil",
		'If target has any leather, it rots over 1d10 rounds',
		'If target has any leather, the cows that yielded it seek revenge',
		'If target has slain anyone recently, they goes insane until dawn',
		"If target has slain anyone recently, they're attacked by vultures",
		'If target is aware of any poison nearby, they begins shrieking',
		"If target is aware of any poison nearby, they thinks it's delicious",
		'If target is aware of any poison nearby, they tries to ingest it',
		"If target is aware of any poison nearby, they're immune to it",
		'If target is beheaded, a spectacular lightshow ensues',
		'If target is beheaded, a winged horse springs from their neck-stump',
		'If target is beheaded, anyone nearby is stricken blind for 1 turn',
		'If target is beheaded, they grows a new head facing backwards',
		"If target is beheaded, they grows a new head just like the caster's",
		"If target is beheaded, they're 10% likely to possess their slayer",
		"If target is beheaded, they're 40% likely to grow a new head",
		'If target is beheaded, their blood turns to very strong acid',
		'If target is beheaded, their body combusts and races to the horizon',
		'If target is beheaded, their body defends their slayer for 2d10 turns',
		'If target is beheaded, their body deflates like a balloon',
		'If target is beheaded, their body seeks political office',
		'If target is beheaded, their body still lives a long and happy life',
		'If target is beheaded, their body tries to behead their slayer',
		'If target is beheaded, their head becomes undead',
		'If target is beheaded, their head bounces away like a rubber ball',
		'If target is beheaded, their head explodes as a 10HD fireball',
		'If target is beheaded, their head floats away like a balloon',
		'If target is beheaded, their head rolls to the highest mountaintop',
		'If target is beheaded, their head speaks prophecy for 1d4 rounds',
		'If target is beheaded, their head turns to solid gold',
		'If target is beheaded, their slayer disgorges 1d6 gallons of blood',
		'If target is beheaded, their slayer is Stunned for 1d4 hours',
		'If target is beheaded, their slayer must Save vs Will or go insane',
		'If target is beheaded, their slayer receives 10d1000 gold pieces',
		'If target is beheaded, their slayer then tries to behead himself',
		'If target is beheaded, lightning bolts discharge from their neck',
		'If target is beheaded, no one now nearby can ever be resurrected',
		'If target is beheaded, two identical heads sprout from their neck',
		'If target is carrying a magical weapon, they loses 1d8 hit points',
		'If target is carrying a magical weapon, they regains 1d8 hit points',
		'If target is carrying a magical weapon, it is burned to slag',
		'If target is carrying a magical weapon, it mimics their personality',
		'If target is carrying a pouch, they tries to climb into it',
		...
		'If target is carrying any food, they turns into a werewolf',
		'If target is carrying any gold, they can hurl one 10HD fireball',
		'If target is carrying any gold, they changes alignment until sunset',
		"If target is carrying any gold, they're struck by lightning",
		'If target is carrying any water, it becomes toxic to him',
		'If target is carrying any wood, they attempts to devour it',
		...
		'If target is carrying rope, they ties himself to a nearby tree',
		'If target is carrying rope, they winds it tightly about their neck',
		"If target is carrying rope, it can't be cut by non-magical means",
		'If target is carrying rope, it threads itself through their flesh',
		'If target is currently injured they begins aging one year per round',
		'If target is cut by a metal weapon, they loses 2d10 gold pieces',
		"If target is cut by a metal weapon, they won't heal naturally",
		'If target is cut by a metal weapon, their limbs turn invisible',
		...
		"If target is now bleeding, fire can't harm them for 2d4 days",
		'If target is now bleeding, they begins to drown as though submerged',
		"If target is now bleeding, they're hereafter susceptible to rust",
		'If target is now bleeding, their weapon is +4 for 2d4 hours',
		'If target is now bleeding, the ground at their feet heats to 500°',
		'If target is now carrying any food, they contracts advanced leprosy',
		'If target is now carrying any food, they loses 1d100 hit points',
		'If target is now carrying any food, they teleports 2d10 miles',
		"If target is now standing, they can't sit or lie down for 8d6 hours",
		'If target is now standing, they levitates helplessly for 2d8 rounds',
		"If target is now standing, they're now standing on tall stilts",
		'If target is now standing, their legs double in length',
		'If target is now wet, they suffers sudden heat exhaustion',
		'If target is slain by a blade, they can never be resurrected',
		'If target is slain by fire, they explodes as a 20HD fireball',
		'If target is slain by fire, they resurrects in 1d4 days',
		'If target is slain by fire, their ashes are scattered over the sea',
		'If target is slain by fire, the nearest forest is also set ablaze',
		'If target is slain in the next 24 hours, they becomes a god',
		"If target is slain in the next 24 hours, they can't be resurrected",
		'If target is slain in the next 24 hours, they resurrects at sunrise',
		'If target is slain in the next 24 hours, winter begins at once',
		'If target is slain, a spring bubbles up from beneath their corpse',
		...
		'If target is slain, they becomes an undead servant for their slayer',
		'If target is slain, they forever haunts the dreams of their slayer',
		'If target is slain, their allies all attack their slayer',
		'If target is slain, their allies quickly forget them and move on',
		'If target is slain, their corpse completely decays in 1d4 rounds',
		'If target is slain, their corpse embraces their slayer and combusts',
		'If target is slain, their corpse turns to wax within 1d10 rounds',
		'If target is slain, their slayer must Save or die along with him',
		"If target is slain, their soul can't leave their body",
		'If target is slain, their soul is sent to the wrong plane',
		'If target is slain, the caster is under a Geas to resurrect him',
		'If target is slain, the caster must inform their next of kin',
		'If target is wearing animal hide, they becomes an animal until dawn',
		'If target is wearing animal hide, they hides like an animal',
		"If target is wearing animal hide, they thinks that they're that animal",
		'If target is wearing animal hide, they tries to eat it',
		'If target is wearing animal hide, it animates and attacks him',
		'If target is wearing any rings, they has a spiritual revelation',
		"If target is wearing any rings, they're immune to magic until sunset",
		'If target is wearing any rings, their hands retract into their wrists',
		'If target is wearing any rings, they ignite on their fingers',
		'If target is wearing armor, they is unable to remove it',
		'If target is wearing armor, they teleports into the nearest town',
		"If target is wearing armor, they thinks it's part of their body",
		"If target is wearing armor, they're attacked by 1d4 alligators",
		"If target is wearing armor, they're blinded until they removes it",
		"If target is wearing armor, they're hurled into the nearest river",
		"If target is wearing armor, they're soaked with lamp oil",
		"If target is wearing armor, they're struck by lightning",
		...
		'If target is wearing armor, the ground beneath them gives way',
		"If target is wearing shoes, their feet become chicken's feet",
		'If target is wielding a weapon, they suffers severe frostbite',
		"If target kills an ally within one turn, he'll be fully Healed",
		'If target kills anyone in the next hour, they vanishes for 2d4 days',
		'If target lights a fire, they feels an urge to put their hands in it',
		'If target lights a fire, they is overwhelmingly afraid of it',
		'If target lights a fire, they perceives omens in its burning embers',
		'If target lights a fire, their clothing ignites',
		'If target loses a finger, they deliberately cuts off another one',
		'If target loses a finger, that hand shrivels and dies',
		'If target moves more than 10 yards from this spot, they dies',
		"If target now has fewer than 1d100 hit points, they're fully Healed",
		'If target now has more than 20 hit points, they loses 1d100',
		'If target sees an open pit, they tries to bury himself in it',
		"If target sees an open pit, they're attacked by something in it",
		"If target sits or lies down, they can't stand again for 8d6 hours",
		'If target sits or lies down, they teleports 1d100 yards',
		"If target sits or lies down, they're attacked by glowing beetles",
		"If target sits or lies down, they're covered by a light frost",
		"If target sleeps more than eight hours, they're struck by lightning",
		'If target teleports, they arrives holding two buckets of paint',
		'If target teleports, their skeleton teleports to this spot',
		'If target uses a doorway in the next hour, they turns to stone',
		"If target wields an axe, they thinks they're the archetypal Dwarf",
		'If target wields an axe, they tries to decapitate himself with it',
		"If target wields an axe, they're attacked by the nearest tree",
		'If target worships a deity, they claims to speak for the deity',
		'If target worships a deity, they forsakes that deity for another',
		"If target worships a deity, they thinks they're that deity's avatar",
		'If target worships a deity, they thinks the deity is talking to him',
		"If target's hands touch, they adhere to each other until dawn",
		"If target's weapon is metal, their hand turns to similar metal",
		...
		'Metal weapons are invisible to target while they wields them',
		...
		'Metal weapons seem 10X heavier to target while they wields them',
		...
		'Next 1d10 attacks upon target leave them breathless and exhausted',
		'Next 1d10 attacks upon target leave them soaked with brine',
		...
		'Next magic item handled by target is etched with their fingerprints',
		'Next magic item handled by target is invisible while they uses it',
		'Next magic item handled by target leaves colorful trails of light',
		'Next magic item handled by target leaves weird scars on their hands',
		"Next magic item handled by target makes them think they're drowning",
		'Next magic item handled by target makes their hands go numb',
		'Next magic item handled by target restores 1d10 hit points',
		'Next magic item handled by target seems to them to be 1,000°',
		'Next magic item handled by target seems to them to be 10X heavier',
		...
		'Next magic item handled by target tries to control their mind',
		'Next magic item handled by target works at 2X normal power',
		'Next magic item handled by target works contrary to their wishes',
		...
		'Next person to wound the target resembles them for 1d20 hours',
		...
		"Next person to wound the target thinks they're drowning for one turn",
		"Next person to wound the target thinks that they're slain the target",
		...
		'Next puddle stepped in by target absolves them of sin',
		'Next puddle stepped in by target causes them to hallucinate',
		'Next puddle stepped in by target changes their alignment until dawn',
		'Next puddle stepped in by target contains a small sea monster',
		'Next puddle stepped in by target drenches them from head to toe',
		'Next puddle stepped in by target explodes as a 6HD fireball',
		'Next puddle stepped in by target hardens like cement',
		'Next puddle stepped in by target inspires them to megalomania',
		'Next puddle stepped in by target is a 16HD water elemental',
		'Next puddle stepped in by target is highly concentrated acid',
		'Next puddle stepped in by target sends them to Elemental Water',
		'Next puddle stepped in by target teleports them to a nearby lake',
		'Next puddle stepped in by target throws them 3d10 yards in the air',
		'Next puddle stepped in by target turns to glass',
		'Next time target touches a tree, they must Save or turn to wood',
		"Next time target touches a tree, they're attacked by 1d100 squirrels",
		"Next time target touches a tree, they're buried in a heap of sawdust",
		"Next time target touches a tree, they're overgrown with stiff bark",
		...
		'Next weapon to wound target can never wound them again thereafter',
		"Next weapon to wound target can't harm them for 1d8 days",
		'Next weapon to wound target disintegrates if it wounds them again',
		'Next weapon to wound target embeds itself in a nearby tree',
		'Next weapon to wound target exudes acrid steam for 1d4 weeks',
		'Next weapon to wound target heals them if it wounds them again',
		'Next weapon to wound target heals its wielder by an equal amount',
		'Next weapon to wound target identifies them as its rightful owner',
		'Next weapon to wound target inflicts 10X the rolled damage',
		'Next weapon to wound target is 5% likely to change their sex',
		"Next weapon to wound target is +1 until they're wounded again",
		'Next weapon to wound target is 10% likely to change their alignment',
		'Next weapon to wound target is 10% likely to destroy their soul',
		...
		'Next weapon to wound target is engraved with their name',
		...
		'Next weapon to wound target is invisible to them forever after',
		...
		'Next weapon to wound target likewise wounds their attacker',
		'Next weapon to wound target makes them suffer apocalyptic visions',
		...
		'Next weapon to wound target was forged from their own bones',
		'Next weapon to wound target was forged on a distant world',
		'No one speaks to target for 2d4-1 days',
		'No one speaks to target until they spills their own blood',
		'Non-magical animals react to the target as if they were a salt lick',
		'Non-magical animals react to the target as if they were food',
		'Non-magical animals react to the target as if they were one of them',
		'Non-magical animals react to the target as if they were undead',
		...
		"On target's back is a button that, if pushed, lights up their head",
		"On target's back is a button that, if pushed, makes them giggle",
		"On target's back is a button that, if pushed, makes them glow blue",
		"On target's back is a button that, if pushed, makes them sweat",
		'Once per day, target can make a sound like a cannon',
		'Once per day, target can turn all wheels nearby invisible',
		"One of target's allies thinks that target is an avatar of their god",
		...
		"One of target's arms is replaced by a duplicate of their head",
		...
		"One of target's arms turns into a small replica of their leg",
		"One of target's arms turns to a lion's foreleg",
		"One of target's eyes migrates to the back of their head",
		...
		"One of target's hands is fireproof, but they never knows which one",
		...
		"One of target's hands migrates to the top of their head",
		...
		"One of target's legs and one of their arms become as clear as glass",
		"One of target's legs and one of their arms seem to be made of wood",
		"One of target's legs and one of their arms shrink by 50%",
		"One of target's legs and one of their arms turn invisible",
		...
		"One of target's limbs can appear identical to their other limbs",
		...
		"One of target's limbs now juts from the center of their back",
		"One of target's limbs regenerates in 1d4 rounds if severed",
		"One of target's limbs retracts into their torso when not in use",
		"One of target's limbs seems to belong to a different species",
		"One of target's limbs shrinks by 1d4% per day",
		"One of target's limbs suffers intense pain if they uses magic",
		...
		'People who meet target for the first time accuse them of drowning',
		'People who meet target for the first time accuse them of treason',
		...
		'People who meet target for the first time ignore them if they speaks',
		'People who meet target for the first time laugh at them derisively',
		'People who meet target for the first time lose 1d4 gold pieces',
		'People who meet target for the first time mistake them for royalty',
		'People who meet target for the first time mock their fashion sense',
		'People who meet target for the first time point at them and laugh',
		...
		"People who meet target for the first time think they're a corpse",
		"People who meet target for the first time think they're a murderer",
		"People who meet target for the first time think they're a thief",
		"People who meet target for the first time think they're mocking them",
		"People who meet target for the first time think they're on fire",
		"People who meet target for the first time think they're stupid",
		"People who meet target for the first time think that they're a demon",
		"People who meet target for the first time think that they're hideous",
		...
		"Smoke issues from the ground near the target when they're angry",
		"Smoke makes the target think that they're being suffocated",
		"Smoke pours from target's eyes when they uses or is struck by magic",
		"Smoke pours from target's skin as though their bones are ablaze",
		...
		"Sparks fly from target's eyes when they draws a weapon",
		"Sparks fly from target's fingertips when they're angry",
		"Sparks fly from target's nostrils as they speaks",
		...
		'Summoned creatures ignore the target unless they attacks them',
		'Summoned creatures ignore the target unless they has a weapon drawn',
		"Swords can't come within ten feet of the target for 1d4 rounds",
		"Swords in target's presence drip with their blood",
		...
		'Target acquires scars to match any wounds they inflicts on others',
		"Target acts as though they doesn't really exist",
		"Target acts as though they're the only person who really exists",
		'Target acts as though their fingers are readily replaceable',
		'Target acts as though their head and body are two separate beings',
		'Target acts generally like a jerk toward their friends and allies',
		...
		"Target affects an air of ostentatious wealth even if they're poor",
		'Target ages 1d10 years per day for the next 1d4 weeks',
		"Target ages 1d1000 years; if they lives, they're not subject to aging",
		'Target ages 1d4 years each time they says their name',
		"Target ages 1d4 years each time they're cut by a claw or fang",
		"Target ages 1d4 years each time they're cut by a metal blade",
		'Target ages 1d4 years each time their weapon injures someone',
		'Target ages at 2X normal rate unless they has a coin in their mouth',
		'Target ages at 2X normal rate while not in direct sunlight',
		'Target ages one year for each hit point of fire damage they suffers',
		"Target ages one year per round spent in the caster's presence",
		'Target ages plus or minus 1d10 years each hour',
		"Target always attacks the foe they're least likely to defeat",
		'Target always fails to consider the consequences',
		'Target always knows the location of the nearest giraffe',
		'Target and their possessions are stripped of any enchantments',
		...
		'Target and the next person they attacks are invisible to each other',
		'Target and the next person they attacks are soaked with icy brine',
		'Target and the next person they attacks both shrink by 5d10%',
		'Target and the next person they attacks each lose 2d8 hit points',
		'Target and the next person they attacks fall unconscious until dawn',
		'Target and the next person they attacks freeze solid',
		'Target and the next person they attacks teleport 1d4 miles away',
		'Target and the next person they attacks vanish for 10d10 rounds',
		'Target appears to be 1d100 years older than they really is',
		'Target appears to be 1d20 inches taller than they really is',
		'Target appears to be a hideous corpse until dawn tomorrow',
		'Target appears to be far more menacing than they really is',
		'Target appears to be in the middle of a terrible rainstorm',
		'Target appears to be made of chocolate until dawn tomorrow',
		'Target appears to be soaked in their own blood until dawn tomorrow',
		...
		'Target asserts that anyone who bleeds in their presence is a coward',
		'Target asserts that anyone who drinks their blood will live forever',
		'Target asserts that dangerous organisms live within their flesh',
		'Target asserts that death no longer has any power over him',
		'Target asserts that fire-based magic has no effect upon him',
		'Target asserts that they and the caster have been allies for years',
		'Target asserts that they can command undead',
		'Target asserts that they can cure disease and cast out demons',
		'Target asserts that they can divine the future, for the right price',
		'Target asserts that they can identify poisons by tasting them',
		'Target asserts that they can issue divine edicts',
		'Target asserts that they can place powerful curses on people',
		'Target asserts that they can produce pearls if they eats sand',
		'Target asserts that they can summon Earth Elementals by eating dirt',
		'Target asserts that they can summon ghosts and phantoms at will',
		'Target asserts that they can take the shape of a doppelganger',
		'Target asserts that they can talk to Air Elementals at will',
		'Target asserts that they can throw lightning bolts at will',
		'Target asserts that they can travel between planes at will',
		'Target asserts that they can travel freely through time',
		'Target asserts that they can turn diamonds into coal by eating them',
		'Target asserts that they died 1d4 rounds ago',
		'Target asserts that they died 1d4 years ago',
		'Target asserts that they has a key that unlocks their skull',
		'Target asserts that they has any number of non-verifiable maladies',
		'Target asserts that they has only 1d4 hours to live',
		'Target asserts that they has the power to bestow godhood',
		'Target asserts that they has the power to create and destroy souls',
		'Target asserts that they heals quickly and has a metal skeleton',
		'Target asserts that they intends to raze the nearest city',
		'Target asserts that they is descended from mighty kings',
		"Target asserts that they is the caster's father",
		'Target asserts that they knows exactly who is destined to kill him',
		'Target asserts that they knows the location of a secret holy book',
		'Target asserts that they knows the location of a vast treasure',
		"Target asserts that they knows when, where, and how he'll die",
		'Target asserts that they must choose which of their allies must die',
		'Target asserts that they was bitten by a werewolf one month ago',
		'Target asserts that they will become omnipotent upon death',
		'Target asserts that they will go insane unless they eats 1d4 apples',
		'Target asserts that they worked as a torturer for the king',
		"Target asserts that he'll combust if anyone says their name",
		"Target asserts that he'll combust if they draws their weapon too fast",
		"Target asserts that he'll combust if they gets wet",
		"Target asserts that he'll combust if they reads a map",
		"Target asserts that he'll combust if they're outdoors at sunset",
		"Target asserts that he'll combust if their blood is spilled",
		"Target asserts that he'll die before they sees another winter",
		...
		"Target asserts that he'll die if anyone nearby speaks their name",
		"Target asserts that he'll die if anyone nearby uses magic",
		"Target asserts that he'll die if they changes or cleans their clothes",
		"Target asserts that he'll die if they closes their eyes or blinks",
		"Target asserts that he'll die if they crosses moving water",
		"Target asserts that he'll die if they doesn't receive a pony",
		"Target asserts that he'll die if they draws a weapon in anger",
		"Target asserts that he'll die if they draws/sheathes their weapon",
		"Target asserts that he'll die if they eats during the next 4d6 days",
		"Target asserts that he'll die if they fires any missile weapon",
		"Target asserts that he'll die if they opens their eyes",
		"Target asserts that he'll die if they sees a rainbow",
		"Target asserts that he'll die if they sees their own blood",
		"Target asserts that he'll die if they speaks their native language",
		"Target asserts that he'll die if they spends any money",
		"Target asserts that he'll die if they stops dancing",
		"Target asserts that he'll die if they stops talking",
		"Target asserts that he'll die if they touches anyone else's blood",
		"Target asserts that he'll die if they touches gold",
		"Target asserts that he'll die if they touches ice",
		"Target asserts that he'll die if they touches metal",
		"Target asserts that he'll die if they uses any magic items",
		'Target asserts that he\'ll die if they uses the word "the"',
		"Target asserts that he'll die if they're cut by a magical blade",
		"Target asserts that he'll die if someone tells them to die",
		"Target asserts that he'll die in 1d4 rounds",
		"Target asserts that he'll die of biliousness",
		"Target asserts that he'll die the next time they eats",
		"Target asserts that he'll die the next time they receives first aid",
		"Target asserts that he'll die the next time they sleeps",
		"Target asserts that he'll die unless they burns all of their clothing",
		"Target asserts that he'll die unless they cuts their own throat",
		"Target asserts that he'll die unless they cuts off their own hand",
		"Target asserts that he'll die unless they destroys their magic items",
		"Target asserts that he'll die unless they destroys their weapon",
		"Target asserts that he'll die unless they drains all of their blood",
		"Target asserts that he'll die unless they drinks strong poison",
		"Target asserts that he'll die unless they eats a special mushroom",
		"Target asserts that he'll die unless they kills the caster",
		"Target asserts that he'll die unless they receives 500 gold pieces",
		"Target asserts that he'll die unless they receives 500 gold pieces",
		"Target asserts that he'll die unless they stays awake for 2d6 weeks",
		"Target asserts that he'll die unless they swallows a magic ring",
		"Target asserts that he'll die unless they takes a vow of pacifism",
		"Target asserts that he'll die unless their demands are met",
		...
		"Target asserts that he'll turn into a werewolf if they eats meat",
		"Target asserts that he'll turn to diamond when slain",
		"Target asserts that he'll vanish forever if they falls asleep",
		"Target asserts that he'll vanish forever if they leaves this area",
		"Target asserts that he'll vanish into the ground at dawn tomorrow",
		"Target asserts that he'll vanish into the sky if they're wounded",
		"Target asserts that they're a ghost and must haunt this area",
		"Target asserts that they're a highly qualified thoracic surgeon",
		"Target asserts that they're a mighty warrior despite the evidence",
		"Target asserts that they're a Summoned creature about to be banished",
		"Target asserts that they're a traveler from an antique land",
		"Target asserts that they're an assassin from the distant future",
		"Target asserts that they're an avatar of the caster's deity",
		"Target asserts that they're been fatally wounded",
		"Target asserts that they're been repeatedly destroyed and rebuilt",
		"Target asserts that they're been replaced by a doppelganger",
		"Target asserts that they're brother to dragons and companion to owls",
		"Target asserts that they're come to deliver their people from bondage",
		"Target asserts that they're eager to exterminate their species",
		"Target asserts that they're found a plot to wipe out their species",
		"Target asserts that they're hunting a monster from the distant past",
		"Target asserts that they're immune to magic",
		"Target asserts that they're on a quest to destroy a mighty artifact",
		"Target asserts that they're on a rock outcrop surrounded by lava",
		"Target asserts that they're on the verge of exterminating their race",
		"Target asserts that they're one of many clones of the real target",
		"Target asserts that they're protected by an unholy host of demons",
		"Target asserts that they're rapidly bleeding to death",
		"Target asserts that they're responsible for many thousands of deaths",
		"Target asserts that they're standing at the bottom of a deep well",
		"Target asserts that they're standing on a ledge over an infinite pit",
		"Target asserts that they're supernaturally beautiful",
		"Target asserts that they're the embodiment of a mighty artifact",
		"Target asserts that they're the mightiest warrior in the world",
		"Target asserts that they're the world's most powerful magic user",
		"Target asserts that they're transforming into some kind of beast",
		"Target asserts that they're unspeakably ugly",
		"Target asserts that they're water soluble",
		'Target asserts that their actions are in accordance with prophecy',
		'Target asserts that their actions shape the destiny of the world',
		'Target asserts that their allies have forsaken him',
		'Target asserts that their birth occurred under odd circumstances',
		'Target asserts that their blood is worth more than gold',
		'Target asserts that their body and head are two symbiotic organisms',
		'Target asserts that their clothes are writhing with snakes',
		'Target asserts that their clothing is trying to kill him',
		"Target asserts that their current form isn't their true form",
		'Target asserts that their death will be avenged one thousand times',
		'Target asserts that their flesh is harder than iron',
		'Target asserts that their god owes them a big favor',
		'Target asserts that their internal organs are made of pure gold',
		'Target asserts that their plans will all culminate at dawn tomorrow',
		"Target asserts that their soul will be destroyed if they're injured",
		'Target asserts that their touch can induce madness',
		'Target asserts that their worst injuries are just a flesh wound',
		'Target asserts that no one nearby really exists',
		'Target asserts that one of their allies will betray them in a garden',
		'Target asserts that poultices of manure can heal any wound',
		'Target asserts that puns and rhymes are painful to him',
		'Target asserts that secret entities are plotting their downfall',
		'Target asserts that someone nearby is the avatar of their god',
		...
		'Target asserts that the caster is an avatar of their deity',
		"Target asserts that the caster's spell functioned as intended",
		'Target asserts that the king owes them a huge favor',
		"Target asserts that the wages of sin aren't really death",
		'Target asserts that the world will end the moment that they dies',
		'Target asserts that time is an illusion, lunchtime doubly so',
		'Target asserts that whoever kills them will become a god',
		'Target asserts that whoever slays them will win incredible riches',
		'Target attacks anyone they sees using a magic item',
		'Target attacks anyone who attacks the caster',
		'Target attacks anyone who sees them using a magic item',
		'Target attacks anyone who speaks ill of the caster',
		'Target attacks anyone who uses magic upon the caster',
		'Target attacks the nearest herd animal until they or it is dead',
		'Target attacks the next person nearby who says their own name',
		'Target attacks the next person nearby who spends money',
		'Target attacks the next person who address them by name',
		'Target attacks the next person who draws a weapon nearby',
		'Target attacks the toughest, most dangerous creature they can see',
		"Target attempts to acquire the caster's spellbook",
		'Target attempts to disembowel himself with their bare hands',
		'Target attempts to ingest any ink they sees',
		"Target attempts to mimic the caster's every more",
		'Target attempts to strangle all trees within 100 yards',
		'Target attempts to strangle himself with their bare hands',
		...
		'Target barks like a dog when they thinks they sees magic',
		...
		"Target becomes giddy and mirthful when they're next hit by a weapon",
		'Target becomes intensely covetous of any magic item they sees',
		'Target becomes intensely hungry following each battle',
		'Target becomes nearly insane with rage whenever they says their name',
		"Target becomes the caster's most trusted and faithful friend",
		'Target becomes violently ill if they eats while in daylight',
		'Target becomes violently ill if they eats while sitting',
		"Target becomes wildly drunk when they're next hit by a weapon",
		'Target befouls any food or water that they and their allies now carry',
		'Target befriends a statue and carries it with them everywhere',
		'Target befriends a statue and thinks it gives them good advice',
		"Target befriends one of the caster's allies",
		'Target befriends the toughest, most dangerous creature they can see',
		'Target begs someone to bite off 1d10 of their fingers',
		'Target begs someone to set them ablaze',
		'Target believes anything the caster says to him',
		'Target believes everything that they says',
		'Target believes no factual statement they hears uttered in sunlight',
		'Target believes that 1d10 of their fingers are intensely magical',
		"Target believes that they can't be harmed by a fall from any height",
		"Target believes that they can't be slain by metal weapons",
		'Target believes that their allies are conspiring to rob him',
		'Target believes that nearly everyone is lying to him',
		'Target believes that whatever they last ate gave them eternal life',
		'Target believes that whatever they last ate is still alive',
		'Target believes that whatever they last ate was a powerful toxin',
		'Target believes that whatever they last ate was hallucinogenic',
		'Target believes that whatever they last ate was their last meal',
		'Target believes that whatever they last ate was worth a fortune',
		'Target belongs to a cult that requires them to perform horrid acts',
		'Target belongs to a cult that will remove their heart within a week',
		'Target bleeds from every orifice for 1d6 rounds but is unharmed',
		'Target bleeds profusely during combat, even if not wounded',
		"Target blows bright blue until they're wounded by a magical weapon",
		...
		"Target briefly resembles the target each time they're wounded",
		"Target bursts into flame the next time they're totally submerged",
		'Target can appear to be covered in moss and lichens at will',
		'Target can appear to be twice their true age at will',
		...
		'Target can become invisible at will if they plucks out their eyes',
		"Target can become invisible by drinking a quart of Elf's blood",
		'Target can bend their spine 120° midway along its length',
		...
		'Target can change the color of their face 2d4 times per day',
		'Target can climb like a monkey',
		'Target can climb like a monkey but is 40% likely to become one',
		'Target can comfortably lift and carry twice their weight in manure',
		'Target can Command one nearby humanoid for 1d6 hours',
		'Target can Command one person nearby to defend them to the death',
		...
		'Target can delay their voice by 1d4 rounds, 1d4 times per day',
		...
		'Target can exhale fire but suffers as much damage as they inflicts',
		...
		'Target can Heal himself but their closest ally will die as a result',
		...
		'Target can Heal himself but it costs them 1,000,000 gold pieces',
		'Target can Heal himself but only at night if they has one hit point',
		'Target can Heal himself four times but loses a limb each time',
		'Target can Heal himself if they sacrifices a point of CON each time',
		'Target can Heal himself ten times but loses a finger each time',
		'Target can hide their weapon inside their body for 2d4 hours per day',
		...
		'Target can magically Summon their own clone once for 1d10 rounds',
		'Target can magically Summon the caster 1d4 times for 1d10 rounds',
		'Target can magically Summon the corpse some person they killed',
		'Target can make their voice issue from any object within 10 feet',
		'Target can make their voice issue from any person within 5 feet',
		'Target can make their voice seem to be 1d4 octaves higher or lower',
		'Target can make their voice seem to be that of someone much older',
		'Target can make their whisper heard by anyone in their line of sight',
		'Target can make their whisper heard through one foot of stone',
		'Target can make one of their arms as supple as rope at will',
		'Target can make one of their hands double in size at will',
		'Target can mask their scent at will',
		'Target can never again address anyone by name',
		'Target can never again speak or write their own name',
		"Target can never again wear the clothes or armor they're wearing now",
		'Target can never again wield the specific weapon they now wields',
		'Target can never be harmed by any weapon now within 10 yards',
		'Target can never be harmed by the specific weapon they now wields',
		'Target can never be slain if they cuts off both of legs right now',
		...
		'Target can never become invisible to anyone who knows their name',
		'Target can never become invisible without dying',
		'Target can no longer conceal their astonishing halitosis',
		'Target can no longer conceal their disdain for magic users',
		'Target can no longer conceal their fear of combat',
		'Target can no longer conceal their hatred of Dwarves',
		'Target can no longer conceal their insatiable cannibalism',
		'Target can no longer conceal their plans for world domination',
		"Target can no longer conceal the fact that they're artificial",
		'Target can no longer conceal the secret of their birth',
		'Target can only be killed by a magical weapon that they has wielded',
		'Target can only be killed by a weapon forged from their own bones',
		'Target can only eat food that they himself has prepared',
		...
		'Target can polymorph at will but is blind in any form but their own',
		...
		"Target can readily be convinced that they doesn't really exist",
		'Target can recognize faces only 10% of the time',
		'Target can regenerate 1 hit point per round for the next week',
		'Target can remove their head for up to 1d4 rounds without harm',
		'Target can remove their heart for up to 1d6 rounds without harm',
		'Target can retract their ears into their skull at will',
		'Target can retract one of their limbs into their body at will',
		"Target can see no farther than 20 yards unless they're barefoot",
		'Target can see no farther than 20 yards while in sunlight',
		"Target can see secret doors but can't see normal ones",
		'Target can see secret doors if they drinks concentrated poison',
		'Target can see secret doors if they sacrifices 1d6 hit points',
		'Target can see secret doors while yelling and hopping on one foot',
		'Target can shine heatless torchlight from their palm at will',
		'Target can shine heatless torchlight from the soles of their feet',
		'Target can speak only in a full shout while their weapon is drawn',
		'Target can speak only in grunts while their weapon is drawn',
		'Target can speak only in rhyme while their weapon is drawn',
		...
		"Target can subsist on water alone while they're at full hit points",
		...
		'Target can teleport half of their body at will',
		...
		'Target can turn their head completely around without harm',
		'Target can understand every language spoken within 10 miles',
		'Target can wield their weapon only in their non-dominant hand',
		...
		"Target can't attack anyone until they wounds himself",
		"Target can't attack anyone who doesn't know target's name",
		"Target can't attack or be attacked for 2d8 rounds",
		"Target can't attack or be attacked until they moves from this spot",
		...
		"Target can't attack until they drops their weapons, gear, and clothes",
		...
		"Target can't be burned by acid if they cuts off both of their thumbs",
		...
		"Target can't be burned by steam while they're wearing boots or shoes",
		...
		"Target can't be magically detected by anyone not of their race",
		"Target can't be magically detected by anyone of the same sex",
		"Target can't be slain except while sleeping",
		"Target can't be slain if they remains within 10 yards of this spot",
		"Target can't be slain while sleeping",
		"Target can't be stunned by any blow to the head",
		"Target can't be surprised if they has a snowball in each hand",
		"Target can't be surprised if they has an eyeball in their mouth",
		"Target can't be surprised if they're wearing a carnation",
		...
		"Target can't breathe until they removes their boots or shoes",
		...
		"Target can't come within one mile of their home",
		"Target can't come within one mile of the caster",
		"Target can't come within ten feet of any tree thicker than they is",
		"Target can't create or use magical fire except while indoors",
		"Target can't create or use magical fire for 1d4 years",
		"Target can't die for at least 1d4 days, but they can be injured",
		"Target can't digest any food that they eats in direct sunlight",
		"Target can't digest any food unless they prepares it himself",
		...
		"Target can't draw their weapon if anyone else is within 10 yards",
		"Target can't draw their weapon or sheathe it if it's now drawn",
		"Target can't draw their weapon unless they asks permission to do so",
		"Target can't draw their weapon within 100 yards of this spot",
		"Target can't hear echoes",
		"Target can't hear their own voice",
		"Target can't hear their own voice except while their eyes are closed",
		"Target can't hear the voice of any female member of their race",
		"Target can't hear the voice of any male member of their race",
		...
		"Target can't ignite any fire unless their hair is soaking wet",
		...
		"Target can't leave this spot until they wounds himself",
		...
		"Target can't see or hear any of their allies for 4d6 hours",
		"Target can't see or hear their 1d4 of their allies for 1d4 days",
		...
		"Target can't sleep unless they first eats a handful of soil",
		"Target can't sleep unless they has their weapon in hand",
		"Target can't sleep unless they're standing up",
		"Target can't sleep until they fells the tallest tree in the kingdom",
		"Target can't sleep until they gives away all of their armor",
		...
		"Target can't speak to anyone who addresses them by name",
		"Target can't speak unless they wears a cloth over their face",
		"Target can't speak unless they're brandishing a weapon",
		"Target can't speak unless their hair is wet",
		"Target can't speak until after they has eaten their next full meal",
		"Target can't speak until their blood is next drawn",
		"Target can't speak until the caster says their own name",
		"Target can't speak while at full hit points",
		"Target can't speak while at full hit points",
		"Target can't speak while wielding a weapon",
		"Target can't use any form of rope or chain longer than they is tall",
		...
		"Target can't use any magic items older than they is",
		"Target can't use their hands or any utensils while eating",
		"Target can't voluntarily pass through doorways unless naked",
		"Target can't walk until the caster says their own name",
		"Target can't walk while carrying gold",
		"Target can't wield any weapon containing metal for 1d4 days",
		"Target can't wield any weapon in their dominant hand",
		"Target can't wield any weapon that hasn't drawn their blood",
		"Target can't wield any weapon within 1d4 miles of this spot",
		"Target can't wound anyone who hasn't wounded him",
		'Target carves a tiny notch in every tree they passes',
		'Target challenges their closest ally to single combat to the death',
		'Target chants nonsensically for 2d10 rounds',
		'Target clatters when they walks like a barrel full of pots and pans',
		'Target collapses into a fetal position for 1 turn',
		'Target combusts if they uses magic within the next 1d4 turns',
		'Target combusts if their weapon is thrown into a river',
		'Target comes into possession of a world-shaking artifact',
		'Target concludes every battle thoroughly soaked by their own blood',
		'Target confesses to a list of crimes, none of which has happened',
		"Target confesses to crimes they couldn't possibly have committed",
		'Target confesses to genocide but can produce no evidence of it',
		'Target confesses to rampant kleptomania',
		'Target constantly boasts about their prowess in all things',
		'Target constantly exudes fragrant soap suds',
		'Target continuously speaks to an imaginary ally',
		'Target coughs incessantly, but their actions are unimpaired',
		...
		'Target crows like a rooster whenever they sees a magic item used',
		'Target dares 1d4 of their allies to try to behead him',
		'Target declares this area to be a sacred shrine to their deity',
		'Target degenerates into an abomination hated by sentient beings',
		'Target demands that their friends and allies pay them tribute',
		'Target develops a pronounced stutter',
		'Target disappears and is completely forgotten for 2d4-1 days',
		'Target discovers that one of their limbs is a separate entity',
		'Target discovers that one of their limbs is made of living wood',
		'Target discovers that one of their limbs is trying to kill him',
		"Target discovers that one of their limbs isn't attached to their body",
		...
		'Target disgorges a box that they believes to contain their soul',
		...
		'Target disgorges a stone that will kill them if they touches it',
		...
		"Target disgorges an exact copy of the clothes they're now wearing",
		'Target disgorges an intricate but badly rusted clockwork device',
		'Target disgorges their own full-grown clone, which then attacks him',
		...
		'Target disgorges the front door of their home',
		"Target doesn't age until they next speaks",
		"Target doesn't age while bald",
		"Target doesn't age while holding a gold coin in their mouth",
		...
		'Target earns 50 gold pieces when their attacks cause maximum damage',
		...
		"Target endlessly frets that they're doomed to be eaten by a dragon",
		'Target experiences bone-chilling cold when their head is touched',
		'Target experiences clairvoyance when they is burned',
		'Target experiences heart-rending grief whenever they uses magic',
		'Target experiences intense vertigo when they draws a weapon',
		'Target experiences searing pain when their skin is touched',
		'Target experiences soul-wrenching pain if they stands upright',
		'Target experiences transcendent euphoria when their blood is drawn',
		"Target experiences vague nostalgia whenever they're wounded",
		...
		'Target fails at their next attempt at fine manual dexterity',
		'Target falls asleep for one hour per hit point they currently lacks',
		'Target fanatically defends the caster for 1d10 rounds',
		'Target fears any subsequent magic used by the caster',
		'Target fears that all of their efforts are for naught',
		"Target feels as if they're walking on a high tightrope",
		"Target feels as if they're wearing an enormous hat made of lead",
		'Target feels as if their clothes are trying to digest him',
		'Target feels as if their clothes have turned to steel',
		'Target feels as if someone else is wearing their clothes right now',
		'Target feels as if thorns have sprouted in their clothes',
		'Target feels as though a huge rodent is gnawing on their spine',
		'Target feels as though they just ate three pounds of butter',
		'Target feels as though they just ate three pounds of cement',
		'Target feels as though they just ate three pounds of flour',
		'Target feels as though they just ate three pounds of parchment',
		'Target feels as though they just swallowed a python',
		"Target feels as though they're been splashed with boiling water",
		"Target feels as though they're being swallowed by a python",
		"Target feels as though they're having a baby",
		"Target feels as though they're having a heart attack",
		"Target feels as though they're having teeth extracted",
		'Target feels as though their allies have abandoned him',
		'Target feels as though their internal organs are melting',
		'Target feels as though their teeth are spinning in their mouth',
		'Target feels as though their wounds have been completely healed',
		'Target feels as though one of their arms is being amputated',
		'Target feels compelled to abandon whatever faith they now follows',
		'Target feels compelled to attain godhood by the end of the week',
		'Target feels compelled to burn all of their clothing',
		'Target feels compelled to desecrate a shrine to their deity',
		'Target feels compelled to find a faith that contradicts their own',
		...
		"Target feels compelled to warn anyone they're about to attack",
		'Target feels their bones shake like a bundle of sticks',
		'Target feels their bones slowly disintegrating',
		'Target feels icy water dripping on them during every battle',
		"Target feels like they're having the time of their life",
		...
		'Target finds a canopic jar containing their own vital organs',
		...
		'Target finds a huge leech attached somewhere on their body',
		...
		'Target finds a magical ring enabling them to command amphibians',
		'Target finds a mysterious and compelling piece of sculpture',
		"Target finds a new, functioning limb that they didn't know they had",
		...
		'Target finds a pouch containing exact copies of their hands',
		'Target finds a recipe for creating human life in a jar',
		'Target finds a shield +4 that only they can lift',
		'Target finds a text personally written by their deity',
		"Target finds a text that they wrote but doesn't remember writing",
		...
		'Target finds the sound of their own voice to be horrifying',
		'Target finds the thought of their own death strangely comforting',
		'Target finds two doses of a Potion of Resurrection',
		'Target flees from anyone who addresses them by name',
		'Target flees into the forest if struck by magic in the next turn',
		'Target flies into a panic if anyone sees them eating',
		'Target flies into a panic if they sees other people eating',
		'Target flies into a rage and attacks the person nearest to him',
		'Target flies into a rage whenever they draws blood',
		'Target forgets 1d4 of their allies',
		'Target forgets everything said to them in the past 1d6 hours',
		'Target forgets their family and where they lives',
		"Target forgets their name and doesn't believe that they ever had one",
		'Target forgets how to ascend stairs and ladders',
		'Target forgets how to feed himself',
		'Target forgets how to sleep',
		"Target forgets how to use any magic item they're now carrying",
		...
		'Target forgets that their allies know who they is',
		'Target forgets the last 1d12 hours',
		'Target forgets the last 1d4 years',
		'Target forgets whatever mission or quest they is now undertaking',
		'Target formally changes their name to "Target"',
		"Target freezes solid if they're injured while standing in snow",
		'Target freezes solid the next time they enters an underground lake',
		...
		'Target gains a level but loses all but 1d4 of their hit points',
		'Target gains a level but one of their arms turns to steam forever',
		'Target gains a level if they permanently severs their dominant hand',
		"Target gains a level the next time they're cut by a magical blade",
		'Target gains a permanent 1d4-1 bonus to their Armor Class',
		...
		'Target gains a profound insight the next time they touches gold',
		'Target gains a title based on their actions in the next 1d6 rounds',
		'Target gains access to an elite secret society',
		"Target gains benefit from food only if eaten while they're naked",
		'Target gains no hit points from their next advancement in level',
		...
		'Target gains two levels if they kills and eats a human before dawn',
		'Target gains valuable insight into the nature of ventriloquism',
		'Target gets 1,000 gold pieces if they cuts off their foot right now',
		'Target gets 100 gold pieces for each finger they cuts from their hand',
		'Target gives their most prized possession to the caster',
		'Target gives their weapon to the person standing nearest to him',
		"Target glows bright blue until they're burned by magical fire",
		"Target glows bright blue until they're struck by magic",
		"Target glows bright blue until they're wounded by their own weapon",
		'Target glows bright blue while under any magical effect',
		'Target glows with a bright, rainbow aura while moving stealthily',
		'Target glows with angelic light whenever they uses a magic item',
		'Target goes berserk if any of their allies injure him',
		'Target goes berserk if they eats meat in the next 24 hours',
		'Target goes berserk if they sees anyone burned by fire',
		'Target goes berserk if they sees anyone eating meat',
		'Target goes berserk if they touches gold in the next 1d6 rounds',
		"Target goes berserk if they're currently carrying any magic items",
		...
		'Target goes into a homicidal rage whenever they removes their shoes',
		'Target goes into a homicidal rage whenever they sheathes their weapon',
		'Target goes totally and dangerously insane until sunset',
		'Target grows an additional 1d8 fingers',
		'Target grows an additional pair of ears atop their head',
		'Target grows an additional pair of eyes somewhere on their face',
		'Target has 1d100 tiny steel spheres embedded in their skin',
		...
		'Target has a blowhole in the back of their neck',
		'Target has a colony of bees living in their skull',
		'Target has a compartment in their torso able to carry small items',
		...
		'Target has a hole in their forehead as large as their fist',
		'Target has a hole in their torso big enough to accommodate their head',
		...
		'Target has a large and heavy padlock around their neck',
		'Target has a large apple stuck in their mouth for 1d4 days',
		...
		'Target has a permanent -4 ToHit penalty versus others of their race',
		'Target has a raised, square protuberance jutting from their chest',
		"Target has a relief of the caster's face embossed on their back",
		'Target has a scar on their forehead as though clumsily lobotomized',
		'Target has a secret name that, if spoken, causes them to race home',
		'Target has a secret name that, if spoken, teleports them 2d8 miles',
		'Target has a secret name that, if spoken, will change their sex',
		'Target has a secret name that, if spoken, will kill them outright',
		'Target has a seizure lasting 1d6 hours when they uses a magic item',
		'Target has a seizure lasting 8d8 rounds, after which they is Healed',
		"Target has a seizure lasting until they're struck by magic",
		"Target has a small lamp in their forehead like a miner's helmet",
		'Target has a small lump on their forehead like a horseshoe',
		'Target has a small steel ring jutting from each shoulder blade',
		'Target has a star-shaped hole running completely through their head',
		'Target has a steel band around their ankle like tagged wildlife',
		'Target has a steel bolt running completely through their head',
		'Target has a strange tattoo that, if touched, causes them to weep',
		'Target has a sword that they thinks can command an undead army',
		'Target has a sword that they thinks can make them invisible to Elves',
		'Target has a sword that they thinks can slay dragons easily',
		'Target has a sword that they thinks makes them a charismatic leader',
		'Target has a tiny compartment beneath one of their fingernails',
		'Target has a violent coughing fit that persists until sunrise',
		'Target has a violent coughing fit whenever they uses a magic item',
		'Target has a virus that will kill them in 4d6 hours unless cured',
		'Target has a wooden bucket firmly affixed to their head',
		...
		'Target has an immobilizing steel brace on one of their legs',
		'Target has an overpowering fear of other members of their race',
		...
		"Target has committed unspeakable acts in their deity's name",
		"Target has committed unspeakable acts in their deity's temple",
		...
		'Target has their name tattooed all over their body',
		'Target has in their possession an item that is literally impossible',
		'Target has in their possession something precious to the caster',
		'Target has innumerable feathers stuck to their skin',
		'Target has inspiring hallucinations about their future career',
		'Target has inspiring hallucinations about their life after death',
		'Target has ironclad proof that all of this is an illusion',
		"Target has ironclad proof that everyone they knows doesn't exist",
		"Target has ironclad proof that they're a prophesied savior",
		"Target has ironclad proof that they're dead",
		"Target has ironclad proof that they're really the caster",
		"Target has ironclad proof that they're the caster's father and son",
		'Target has ironclad proof that the apocalypse will be tomorrow',
		"Target has ironclad proof that the caster doesn't exist",
		"Target has no idea of where they is or what they're doing",
		'Target has no natural visible form; their appearance is an illusion',
		...
		'Target has six eyes spaced evenly around their skull',
		'Target has stolen large sums of money from each of their allies',
		'Target has terrifying hallucinations about their own birth',
		'Target has terrifying hallucinations about their own death',
		"Target has the caster's name tattooed all over their body",
		'Target has the head and right arm of a common housefly',
		'Target has three identical faces spaced evenly around their skull',
		'Target has ugly, thorny projections along both of their arms',
		'Target has visions depicting the true nature of magic',
		'Target has visions of a future full of incomprehensible wonders',
		"Target has visions of a future in which they're worshipped as a god",
		'Target has visions of a past that seems more real than their own',
		'Target has visions of a transcendently beautiful city in the sky',
		'Target has visions of their slow and torturous dismemberment',
		'Target has visions of the future involving no one they recognizes',
		...
		"Target hasn't slept since they last spoke with royalty",
		'Target hates their nearest ally as much as their most bitter enemy',
		'Target hears cheers and applause whenever their blood is drawn',
		'Target hears their own voice betraying their secrets to everyone',
		'Target hears their own voice castigating them for their many failures',
		'Target hears their own voice endlessly chanting their own name',
		'Target hears their own voice screaming in their ears until sunrise',
		'Target hears their own voice whispering words of comfort to him',
		'Target hears malevolent voices all around him',
		'Target hears the clattering of swords at all times',
		'Target hears the clattering of swords while their weapon is drawn',
		'Target hears the crash of cymbals whenever they uses a magic item',
		...
		'Target insists on wearing a bucket on their head for 1d4 weeks',
		'Target insists that their body is real and spectacular',
		'Target inspires homicidal rage in some common non-magical species',
		'Target is 5% likely to vanish forever each time they says their name',
		'Target is 10% likely to attack anyone who says their name',
		...
		'Target is 10% likely to strangle himself whenever they uses rope',
		'Target is 10% likely to turn to a wooden statue when they sleeps',
		'Target is 15% likely to be attacked by any horse they passes',
		'Target is 15% likely to die when they next sees an illusion',
		'Target is 20% likely to be healed by any poison they drinks',
		'Target is 20% likely to be healed instead of injured by fire',
		'Target is 20% likely to disbelieve any illusion they sees',
		...
		"Target is 20% likely to think that they're undead if undead are near",
		'Target is 20% likely to turn invisible when injured by fire',
		'Target is 30% likely to be able to summarize any book they kisses',
		...
		'Target is acutely hungry for 5d6 days, no matter how much they eats',
		'Target is affected by Reverse Gravity for 1d4 weeks',
		"Target is afflicted with leprosy for one month, then they're healed",
		...
		'Target is attacked by 6d12 house cats',
		...
		'Target is attacked by moths as if they were made of wool',
		'Target is attacked by teeming vermin visible only to him',
		'Target is attacked by the nearest boulder',
		'Target is blind until they wets their hair',
		'Target is blind while their hair is wet',
		...
		'Target is buried up to their knees in burning coals',
		'Target is buried up to their knees in shiny new gold coins',
		...
		'Target is certain that all of their allies have betrayed him',
		'Target is certain that they has the patronage of a powerful entity',
		'Target is certain that they was constructed in a laboratory',
		"Target is certain that he'll become a god if they dies in combat",
		"Target is certain that he'll die by sunset",
		"Target is certain that they're a plant-based creature",
		"Target is certain that they're about to become king",
		"Target is certain that they're as fragile as glass",
		"Target is certain that they're bleeding profusely",
		"Target is certain that they're immortal",
		"Target is certain that they're invulnerable until sunset",
		"Target is certain that they're standing at the center of a huge fire",
		...
		"Target is dreadfully homesick for some place they're never been",
		...
		'Target is driven like a thumbtack into the ground up to their neck',
		...
		'Target is encircled by tall icicles, each as thick as their leg',
		...
		"Target is fearless as long as they wears the shoes they're wearing now",
		...
		"Target is fully healed if they're slain while standing in snow",
		'Target is harassed by skeletal crows',
		'Target is haunted by the endless screams of damned souls',
		'Target is healed of all damage, but their clothes and gear vanish',
		...
		'Target is immortal and unaging until they next speaks',
		"Target is immortal, but they're sentenced to lifelong imprisonment",
		'Target is immortal, but their arms and legs vanish forever',
		'Target is immune to air-based magic for 1d4 days',
		'Target is immune to all attacks by non-magical birds',
		'Target is immune to all injury until they next speaks',
		...
		"Target is immune to their allies' magic",
		"Target is immune to their allies' magic for 10d10 rounds",
		'Target is immune to their own magic and attacks for 1d4 hours',
		...
		'Target is immune to necromantic magic until they uses a magic item',
		...
		'Target is immune to smoke inhalation for the rest of their life',
		...
		'Target is immune to the next magical disease they encounters',
		...
		'Target is instantly consumed by vermin if they dies within 24 hours',
		'Target is intensely drunk for 1d4 rounds after every combat',
		"Target is invisible to lycanthropes while they're bleeding",
		...
		'Target is invisible while they has an apple in each hand',
		'Target is invisible while shouting',
		'Target is invulnerable and invisible until they speaks or moves',
		...
		'Target is invulnerable to normal weapons until they inflicts damage',
		'Target is invulnerable to normal weapons until they wields one',
		'Target is invulnerable to weapon that they himself forged',
		...
		'Target is killed outright if they ever triggers a Chaos Burst',
		'Target is killed outright if they kills any member of their species',
		'Target is killed outright if they wounds himself with a sword',
		...
		'Target is obsessed with ridding himself of their allies',
		'Target is obsessed with ridding himself of their shadow',
		'Target is obsessively covetous of some item that they can now see',
		...
		"Target is obsessively protective someone they're never met",
		'Target is overwhelmingly drunk for 1d4 rounds, then totally sober',
		'Target is paralyzed by dread when they witnesses magical effects',
		...
		'Target is poisoned if they touches a book in the next 1d4 days',
		'Target is pursued by predatory moneylenders',
		'Target is pursued by ravenous wolves',
		'Target is pursued by rogue shadows that resemble their own',
		'Target is pushed through the planet and out to the opposite side',
		'Target is quarantined by the local Minister of Health',
		'Target is real but can be disbelieved as if they were an illusion',
		'Target is real but can be Dispelled as if they were an illusion',
		'Target is recognized as an escaped slave wherever they goes',
		...
		'Target is scarred as though they were pressed against a hot screen',
		'Target is scarred as though their digestive tract has been removed',
		...
		'Target is shunned by all other members of their species',
		...
		'Target is smeared in a fluid that suppresses their natural scent',
		'Target is smeared in lard',
		'Target is smeared in some kind of fireproof jelly',
		'Target is so badly disfigured that people flee from them in horror',
		'Target is sought for arrest because they stole a loaf of bread',
		...
		'Target is stricken from any documents that mention them by name',
		...
		'Target is struck by lightning the next time they draws a weapon',
		'Target is struck by lightning the next time they enters water',
		'Target is struck by lightning the next time they speaks',
		'Target is struck by lightning the next time they uses a magic item',
		"Target is struck by lightning unless they're currently atop a horse",
		'Target is stung by a bee as large as an ox',
		'Target is stung by a bee every time they makes a successful attack',
		'Target is suddenly acutely aware of any injuries they now has',
		'Target is suddenly attacked by ruffians',
		'Target is suddenly holding 1d4 anvils',
		'Target is suddenly holding a box full of their own bones',
		...
		'Target is suddenly holding the nearest corpse in their arms',
		'Target is suddenly lying in a four-poster canopy bed',
		'Target is suddenly lying in their own bed',
		...
		'Target is suddenly standing next to their most powerful enemy',
		...
		'Target is suddenly standing outside their own front door',
		'Target is suddenly standing under the nearest bridge',
		'Target is suddenly standing upon what appears to be their own grave',
		'Target is suddenly standing wherever they awoke this morning',
		...
		'Target is suspected of plotting to exterminate their entire species',
		...
		'Target is swarmed by undead whenever they uses a magic item',
		...
		'Target is tied to the ground with rope made of their own hair',
		...
		'Target is tormented by invisible barbs that catch in their flesh',
		'Target is tormented by shrill and discordant music',
		'Target is tormented by the awareness of their mortality',
		'Target is tormented by visions of their own damnation',
		'Target is tormented by visions of their own descent into madness',
		'Target is tormented by visions of the damned',
		'Target is tormented by visions of the torture of their allies',
		'Target is tormented by voices telling them to kill their allies',
		'Target is tormented by voices telling them to kill the king',
		...
		'Target is unusually clumsy for 1d4 hours after they says their name',
		...
		'Target is wearing the leathered skin from their own corpse',
		'Target is wholly invulnerable for 1d4 rounds',
		'Target is widely famed for their prowess with the scissors',
		'Target is widely recognized as a traitor to their race and species',
		'Target is, by their very nature, impossible',
		...
		'Target labors to conceal a humiliating secret from their allies',
		'Target lacks any concept of personal property',
		'Target laughs like a braying donkey when they injures someone',
		"Target laughs outrageously at the sight of their allies' blood",
		'Target learns that a deranged cult worships them as a god',
		...
		'Target looks as though half of their body has been severely burned',
		'Target looks as though half of their body is made of pumice',
		'Target looks as though half of their body is made of wood',
		"Target looks as though they're made entirely of clay",
		...
		'Target looks vaguely demonic whenever they uses a magic item',
		'Target loses 1d100 hit points if they speaks their name before sunset',
		'Target loses 1d100 hit points unless they eats 3lbs of gold by dawn',
		'Target loses 1d100% of their mass',
		'Target loses 1d4 hit points every time they draws a weapon',
		'Target loses 1d4 levels/hit dice',
		'Target loses a point of Intelligence for each hit point they loses',
		...
		'Target loses half of their remaining hit points',
		...
		'Target loses one hit point per round until they eats some raw meat',
		'Target loses one hit point per round until they strips naked',
		'Target loses one hit point per round until they swallows a coin',
		"Target loses one hit point per round until they're struck by magic",
		'Target loses the sense of object permanence',
		'Target makes a spirited effort to detach one of their legs',
		'Target makes a spirited effort to disarm their allies',
		'Target makes a spirited effort to eat their own foot',
		'Target makes a spirited effort to extract their own heart',
		'Target makes a spirited effort to pull out their own tongue',
		'Target makes a spirited effort to remove their lower jaw',
		'Target makes a spirited effort to scour the flesh from their hands',
		'Target makes a spirited effort to swallow their weapon',
		'Target makes a spirited effort to tear off their ears',
		'Target makes outrageous claims about their martial skill',
		'Target makes outrageous claims about their wealth and property',
		'Target mimics the actions of one of their allies for 2d6 rounds',
		"Target mimics the caster's actions for 1d10 rounds",
		'Target mistakes himself for someone else',
		'Target moos like a cow each time they draws a weapon',
		...
		'Target must carry a wooden staff taller than they is at all times',
		...
		'Target must draw their weapon every time they says their name',
		...
		"Target must give their name whenever they're asked for it",
		"Target must lie whenever they're asked their name",
		...
		"Target must Save each morning, or they can't use their arms that day",
		'Target must Save each morning, or their left leg bursts into flame',
		'Target must Save each night or else sleep for 6d8+24 hours',
		'Target must Save or 1d100 of their bones explode',
		'Target must Save or 1d100 of their bones turn to glass',
		'Target must Save or 1d100 of their bones turn to steel',
		'Target must Save or be dragged to the bottom of the nearest lake',
		'Target must Save or be struck dead by a meteor',
		'Target must Save or each of their bones teleports 1d4 miles',
		'Target must Save or forfeit ownership of all of their possessions',
		'Target must Save or they beheads himself with their next attack',
		'Target must Save or they will never have existed',
		'Target must Save or their hands and weapons vanish until sunset',
		'Target must Save or their temperature rises 1° per round',
		'Target must Save or lose 1d4 from each attribute score',
		"Target must Save when they're hit by a bludgeon or shatter",
		"Target must Save when they're hit by a bludgeon or shriek in panic",
		"Target must Save when they're hit by a bludgeon or turn inside out",
		"Target must Save when they're hit by a bludgeon or turn to butter",
		'Target must say their name every time they draws a weapon',
		'Target must scale the tallest mountain within 100 miles',
		'Target must take 1d10 steps backward each time they draws a weapon',
		'Target now has 1d12 x 10% of their full hit points',
		'Target now has an odd number of limbs',
		'Target now has three legs spaced evenly around their pelvis',
		'Target obsessively cleans and polishes any magical items they owns',
		...
		'Target obsessively pursues the one-armed man who killed their wife',
		'Target offered their legs as collateral on a high-interest loan',
		...
		"Target owes a big favor to someone to whom they're morally opposed",
		'Target perceives a vast army to be just beyond the nearest ridge',
		'Target perceives aggressive creditors to be hunting them endlessly',
		...
		'Target perceives hints of prophecy in any music they hears',
		...
		'Target perceives worms to be wriggling from their every orifice',
		'Target permanently abandons their principal weapon',
		'Target permanently ages one year for each hit point they loses',
		'Target permanently gains 1d4 hit points',
		'Target permanently loses 1d10 toes',
		'Target permanently loses 1d4 hit points',
		'Target permanently loses half their current hit points',
		'Target poses and spits water like a fountain for one turn',
		'Target presents a long list of grievances to the caster',
		'Target pretends that they has a personal relationship with their god',
		"Target pretends that they're been Charmed by the caster",
		'Target punches their jaw repeatedly until they knocks himself out',
		'Target quickly regenerates any lost fingers or toes',
		"Target races away in a random direction and can't stop until dawn",
		'Target races headlong toward any magic user they encounters',
		...
		'Target races toward their home at top speed',
		...
		'Target reacts violently to anyone bearing a scar on their face',
		'Target reacts violently to anyone bearing a tattoo',
		'Target reacts violently to anyone displaying a holy symbol',
		'Target reacts violently to anyone they sees who is now injured',
		'Target reacts violently to anyone they thinks is able to kill him',
		'Target reacts violently to anyone nearby when they awakens',
		'Target reacts violently to anyone not of their race',
		'Target reacts violently to anyone not wearing a hat',
		'Target reacts violently to anyone refusing to address them as sire',
		'Target reacts violently to anyone representing a deity',
		'Target reacts violently to anyone taller than they is',
		...
		'Target reacts violently to anyone who addresses them by name',
		'Target reacts violently to anyone who addresses the caster',
		'Target reacts violently to anyone who asks their name',
		...
		"Target reacts violently to anyone who doesn't offer them money",
		...
		'Target reacts violently to anyone who eats meat in their presence',
		'Target reacts violently to anyone who gives them an order',
		...
		'Target reacts violently to anyone who mentions their martial skill',
		'Target reacts violently to anyone who offers them aid in battle',
		'Target reacts violently to anyone who offers them food or water',
		'Target reacts violently to anyone who offers them hospitality',
		'Target reacts violently to anyone who offers them money',
		'Target reacts violently to anyone who questions their bravery',
		'Target reacts violently to anyone who receives magical healing',
		'Target reacts violently to anyone who refuses to give them money',
		...
		'Target reacts violently to anyone who sees them get injured',
		'Target reacts violently to anyone who shows them common courtesy',
		...
		"Target reacts violently to anyone who suggests that they're mortal",
		...
		'Target reacts violently to anyone whom they perceives to be ill',
		...
		'Target reacts violently to Elves who learn their name',
		'Target reacts violently to the next person to draw blood near him',
		'Target realizes that has an extra eye in the back of their head',
		'Target realizes that they murdered 1d10 people closest to him',
		"Target realizes that they're a mechanical simulacrum",
		"Target realizes that they're always been a ravenous cannibal",
		"Target realizes that they're been chewing on gravel for several days",
		"Target realizes that they're being controlled by invisible entities",
		"Target realizes that they're had an arrow in their thigh for days",
		"Target realizes that they're lost and doesn't know anyone nearby",
		'Target realizes that the back of their head is removable',
		'Target receives a massive shock the next time they touches metal',
		'Target receives a sign that they should abandon all worldly goods',
		'Target receives a sign that they should devote himself to magic',
		'Target receives a sign that they should reject all magic',
		'Target receives a sign that their murder is imminent',
		"Target reeks of carrion when they're angry",
		'Target reeks of cheap perfume between sunset and dawn',
		'Target reeks of chlorine while they speaks',
		'Target reeks of gasoline for the rest of their life',
		...
		'Target refuses to eat until their magical sword is returned',
		'Target refuses to eat within 6d10 miles of this spot',
		'Target refuses to give medical aid to their allies',
		'Target refuses to share food or water with their allies',
		'Target refuses to speak their native tongue while outdoors',
		'Target refuses to speak to anyone at all for 1d8 days',
		'Target refuses to speak to anyone not of their race',
		'Target refuses to speak to anyone of their race',
		'Target refuses to speak to anyone who addresses them by name',
		'Target refuses to speak to anyone who is looking at him',
		'Target refuses to speak to anyone who shares their native tongue',
		'Target refuses to speak to anyone whom they knows to employ magic',
		'Target regains their full hit points in each of the next 1d8 rounds',
		'Target regenerates one hit point for each pint of blood they drinks',
		'Target regresses to infancy but quickly grows to their correct age',
		'Target re-rolls 1d4 of their attribute scores, using 2d10',
		'Target re-rolls their hit points',
		'Target retains a perfect memory of the next 4d12 hours',
		'Target rightly believes that everyone is trying to kill him',
		'Target roars like a lion whenever they sees food',
		...
		'Target secretes a sticky pus from their eyes, nose, and ears',
		...
		'Target shimmers like a desert mirage, making them -1 ToHit',
		'Target shrinks by 25% during each of the next 1d10 days',
		'Target shrinks by 8d10% when they next attacks the caster',
		'Target single-mindedly attacks the tallest person they can see',
		'Target single-mindedly tries to kill the caster until one is dead',
		'Target sinks halfway to the center of the world',
		'Target smells like 1,000 roses whenever they uses a magic item',
		'Target smells like 10 corpses whenever they uses a magic item',
		...
		'Target smells strongly of blood whenever they uses a magic item',
		'Target smells strongly of cabbage until their next birthday',
		'Target smells strongly of sauerkraut for the rest of their life',
		'Target smells strongly of sour milk until next wounded in battle',
		'Target smells strongly of vanilla for 2d4 days',
		'Target sneezes and 10d10 angry wasps spew from their nose',
		'Target sneezes and blows 1d4 pounds of iron filings from their nose',
		'Target sneezes and blows all of their teeth from their mouth',
		'Target snorts like a pig before and after they says their name',
		"Target sounds as though they're shouting through a distant megaphone",
		'Target speaks only in an archaic dialect of their native language',
		'Target spends 1d4 rounds obsessing over the impact of their actions',
		'Target spends 1d4 turns trying to fell a tree with their bare hands',
		'Target spends 2d4 rounds trying to remove one of their vital organs',
		'Target spends 2d8 rounds praising the caster for their magic skills',
		"Target spends a few rounds trying to convince himself they're dead",
		'Target spends a few rounds trying to unscrew their own head',
		'Target spends all of their money to buy something totally worthless',
		...
		'Target sprays a gallon of milk from their nose',
		'Target sprays a huge gout of jet-black ink from their nose',
		'Target sprouts 1d10 additional noses all over their body',
		'Target sprouts 1d10 fingers from their cheeks',
		'Target sprouts 1d10 pairs of delicate antennae',
		'Target sprouts 1d100 additional ears on their body',
		'Target sprouts 1d6 additional noses somewhere on their body',
		'Target sprouts 3d10 tufts of coarse, ugly hair on their body',
		'Target sprouts a bunch of flexible metal tines on their face',
		"Target sprouts a clumsy elephant's trunk at the back of their head",
		'Target sprouts a collar of holly from the skin of their neck',
		"Target sprouts a horse's tail from the center of their chest",
		'Target sprouts a long, prehensile tail from their chest',
		'Target sprouts a non-functional face between their shoulder blades',
		'Target sprouts a non-functioning hand from the top of their head',
		'Target sprouts a pair of compound eyes from their cheekbones',
		'Target sprouts a pair of loathsome tentacles from their forehead',
		'Target sprouts a pair of retractable fangs in each palm',
		"Target sprouts a pig's tail from between their eyes",
		'Target sprouts a small foot from the top of their head',
		'Target sprouts a torch sconce between their shoulder blades',
		"Target sprouts a vulture's wing between their shoulder blades",
		...
		'Target sprouts an additional hand from one of their arms',
		...
		'Target sprouts an additional mouth next to their original one',
		'Target sprouts an additional pair of eyes on their forehead',
		'Target sprouts an additional pair of nostrils on their forehead',
		'Target sprouts an additional pair of thumbs on their forehead',
		'Target sprouts an additional thumb from the back of each hand',
		"Target sprouts an iguana's tail from their chin",
		'Target sprouts an intelligent fungus atop their head',
		'Target sprouts an ox horn from their chin',
		'Target sprouts an ox horn from one side of their head',
		'Target sprouts countless leaves, each bearing a mysterious rune',
		'Target sprouts deer antlers from their shoulder blades',
		'Target sprouts enormous fangs from their lower jaw',
		'Target sprouts harmless but acrid blue mold all over their body',
		'Target sprouts retractable iron claws from their fingers',
		'Target sprouts small, flashing lights along their spine',
		...
		"Target suddenly has 2d10 carpenter's nails in their mouth",
		'Target suddenly has a horseshoe in their mouth',
		'Target suddenly owns a book describing how to build a spacecraft',
		'Target suddenly owns a large pouch made of their own leathered skin',
		'Target suddenly owns an exact replica of their own skeleton',
		...
		"Target suddenly realizes that they doesn't know how to use weapons",
		'Target suddenly realizes that they has a conjoined twin',
		"Target suddenly realizes that they're terrified of spiders",
		"Target suddenly realizes that they're undead",
		...
		'Target suddenly senses that their identity is a fictional construct',
		'Target suffers a fit of crippling paranoia for 1d4 turns',
		'Target suffers a seizure lasting 1d10 rounds',
		'Target suffers burns if they touches water hotter than 80°',
		"Target suffers double damage from injuries while they're wet",
		'Target suffers extreme hypothermia',
		'Target suffers from a disfiguring pox, but their teeth are radiant',
		...
		'Target suffers intense dread when they tries to use a magic item',
		...
		'Target suffers severe burns the next time they removes their clothes',
		'Target suffers severe convulsions in the presence of kobolds',
		'Target suffers severe frostbite the next time they touches metal',
		...
		'Target swears undying loyalty to the next person to say their name',
		...
		'Target teleports 8d10 miles when they next attacks the caster',
		...
		'Target teleports one mile upon their next successful attack',
		...
		'Target teleports to the exact place where they awoke this morning',
		'Target teleports to the exact place where they last ate a full meal',
		'Target teleports to the exact place where they met the caster',
		'Target teleports to the exact place where they was born',
		...
		'Target teleports to the place where they last paid for a meal',
		'Target teleports to the place where their blood was last spilled',
		...
		'Target teleports to this spot upon losing 50% of their hit points',
		'Target teleports to this spot when their blood is next spilled',
		"Target teleports well beyond the caster's line of sight",
		'Target tells embarrassing lies about himself at every opportunity',
		"Target thinks he'll die if they climbs a tree taller than they is",
		"Target thinks he'll die if they sees a shooting star",
		"Target thinks he'll die if they wields a magical weapon",
		"Target thinks he'll die if struck again by the caster's magic",
		"Target thinks he'll die unless the caster saves him",
		"Target thinks they're an elephant until they're next injured",
		'Target thinks that 1d100 years have passed',
		'Target thinks that a mighty artifact is hidden in a nearby lake',
		'Target thinks that they can control the caster for 1d6 rounds',
		"Target thinks that they're thoroughly soaked with lamp oil",
		"Target thinks that they're under the caster's control until sunset",
		'Target thinks that their attacks heal rather than inflict damage',
		'Target thinks that their clothing is on fire for 1d10 rounds',
		'Target thinks that their enemies are only illusions',
		'Target thinks that their left arm has turned to stone',
		'Target thinks that their skin is trying to suffocate him',
		'Target thinks that their sweat is flammable',
		'Target thinks that their weapon is intelligent and powerful',
		'Target thinks that their weapon will explode on contact with metal',
		'Target thinks that non-magical fire is a manifestation of their god',
		'Target thinks that non-magical fire is an offense against their god',
		'Target thinks that one of their limbs is as fragile as glass',
		'Target thinks that the nearest fire is an avatar of their god',
		'Target thinks that the nearest statue is their close relative',
		'Target thinks that the nearest statue was once their close friend',
		'Target throws all of their belongings into the next fire they sees',
		'Target throws their weapon into the next chasm they passes',
		'Target tries to bite off 1d10 of their fingers, one try per finger',
		'Target trips and falls over in each of the next 1d6 rounds',
		'Target trips over what they realizes is their own grave marker',
		'Target trumpets like an elephant when they draws a weapon',
		...
		'Target turns in a circle every time they passes through a doorway',
		...
		'Target vanishes until 1d4 different people say their name',
		'Target vanishes until the caster dies or gains a level',
		'Target vanishes until two different people say their name',
		...
		'Target vows to slay every necromancer they meets',
		'Target vows to smite those who take their name in vain',
		'Target vows to tithe 90% of their income',
		'Target wails inconsolably for 1d10 rounds',
		'Target wakes each day bald, but their hair regrows by noon',
		"Target wakes each day certain that they're been buried for weeks",
		"Target wakes each day certain that they're been tortured for weeks",
		"Target wakes each day certain that they're gone blind",
		"Target wakes each day certain that they're immortal",
		"Target wakes each day certain that they're spent a month in the snow",
		"Target wakes each day certain that they're still dreaming",
		"Target wakes each day certain that they're the king",
		'Target wakes each day certain that their heart has been removed',
		'Target wakes each day covered in dirt as though recently buried',
		'Target wakes each day covered in finely-powdered rust',
		'Target wakes each day with their pockets full of twigs and gravel',
		...
		'Target will betray their closest ally in their time of greatest need',
		'Target will combust in 1d10 rounds unless they eats 2d10 gold coins',
		'Target will combust violently in 2d10 rounds',
		'Target will die unless they spends 100 gold pieces each day',
		'Target will either die or become a god at the next solstice',
		"Target will gouge out their eyes unless they're retrained or attacked",
		'Target will rescue their closest ally but it will cost their own life',
		...
		"Target's age varies by 1d10 years each time they're wounded",
		"Target's allies all attack them for 1d4 rounds",
		"Target's allies all sound just like him",
		"Target's allies are all healed, but they're reduced to one hit point",
		...
		"Target's allies are stricken blind until the target says their name",
		"Target's allies are teleported at least 1d4 miles away from him",
		"Target's allies arrange to sell them for a substantial profit",
		"Target's allies assembled them from artificial parts",
		"Target's allies attempt to steal and sell all of their belongings",
		"Target's allies betrayed them terribly within the last 1d4 days",
		"Target's allies can come within 10 yards of them during melee",
		"Target's allies can't communicate with them until they spills blood",
		"Target's allies can't defend them in a fight",
		"Target's allies can't digest any food that they prepares",
		"Target's allies can't distinguish the target from the caster",
		"Target's allies can't draw weapons within 10 yards of him",
		"Target's allies can't look directly at them for 1d4 days",
		"Target's allies can't see them while they're at full hit point",
		"Target's allies can't speak to them while they has a weapon drawn",
		"Target's allies conspire to sell them into slavery",
		"Target's allies conspire to sell their soul to a demon",
		"Target's allies each carry a small vial filled with their blood",
		"Target's allies each find 1d10 gold pieces",
		"Target's allies each give them 1d100 gold pieces",
		"Target's allies fear that they're about to go on a homicidal rampage",
		"Target's allies go berserk if they is slain",
		"Target's allies have never liked or respected him",
		"Target's allies look just like them for 4d6 hours",
		"Target's allies look just like them until sunset",
		"Target's allies mock and ridicule them mercilessly until sunset",
		"Target's allies speak no language they can understand for 2d8 days",
		"Target's allies spread vicious and humiliating rumors about",
		"Target's allies suspect that they belongs to a divine lineage",
		"Target's allies suspect that they're a mechanical impostor",
		"Target's allies suspect that they're hiding vast wealth from them",
		"Target's allies suspect that they're joined a violent cult",
		"Target's allies suspect that they're plotting to betray them",
		"Target's allies suspect that they're really the caster",
		"Target's allies swear a blood oath against whoever slays him",
		"Target's allies think that they can resurrect the dead",
		"Target's allies think that they fulfills an ancient prophecy",
		"Target's allies think that they has some terribly virulent disease",
		"Target's allies think that they plans to sacrifice them to their god",
		"Target's allies think that they're ablaze",
		"Target's allies think that they're at death's door",
		"Target's allies think that they're being controlled by unseen forces",
		"Target's allies think that they're damned beyond hope of redemption",
		"Target's allies think that they're dead, and they try to bury him",
		"Target's allies think that they're drowning",
		"Target's allies think that they're far more powerful than they lets on",
		"Target's allies think that they're guilty of many unspeakable crimes",
		"Target's allies think that they're ingested a powerful toxin",
		"Target's allies think that they're possessed by a powerful demon",
		"Target's allies think that they're under the caster's control",
		'Target\'s allies think that their name is "Fungus"',
		"Target's allies think that their touch is poisonous to them",
		"Target's allies trust them implicitly",
		"Target's allies utterly terrify them for 1d8 hours",
		"Target's allies worship them as a god for 1d8 days",
		"Target's ankle is tightly chained to their neck",
		...
		"Target's arms are replaced by inert duplicates of their head",
		...
		"Target's arms spin like propellers until they're hit by magic",
		"Target's arms vanish, but they sprouts a trunk like an elephant",
		"Target's arms wheeze like hydraulics when they moves them",
		...
		"Target's attacks cause maximum damage, but they takes equal damage",
		"Target's attempts at tracking invariably lead to their own trail",
		...
		"Target's body climbs into a tree each night as they sleeps",
		...
		"Target's body slowly absorbs any clothing they wears",
		...
		"Target's bones are visible through their skin while they sleeps",
		"Target's bones are visible through their skin while they're wet",
		...
		"Target's bones chime like bells when they're struck",
		"Target's bones clatter inside their body like a bare skeleton",
		...
		"Target's boots can never sink underwater while they wears them",
		"Target's boots fuse to the ground where they're now standing",
		"Target's boots turn to glass",
		"Target's Charisma is raised to 25 for 1d6 rounds",
		"Target's closest ally attacks them for 1d10 rounds",
		"Target's closest ally is permanently invisible to him",
		"Target's closest ally turns out to be their clone",
		"Target's closest ally will betray them in their hour of need",
		"Target's clothes always appear to be filthy",
		"Target's clothes always resemble the clothes they're now wearing",
		...
		"Target's clothes are consumed by fire, but they is unharmed",
		...
		"Target's clothes billow with foul smoke when they uses a magic item",
		"Target's clothes billow with foul smoke when they wields a weapon",
		"Target's clothes billow with foul smoke when they're underground",
		...
		"Target's clothes clatter like a suit of armor while they walks",
		...
		"Target's clothes ignite each time they uses a magic item",
		"Target's clothes inflate to the size of a house",
		"Target's clothes make them appear to suffer from leprosy",
		"Target's clothes mock them with whispers that only they can hear",
		"Target's clothes protect them against extremes of natural weather",
		"Target's clothes shrink by one percent per round",
		"Target's clothes smolder from now until dawn, but they is unharmed",
		"Target's clothes teleport 1d10 yards",
		"Target's clothes totally unravel over the next 3d10 rounds",
		"Target's clothes turn invisible each time they uses a magic item",
		"Target's clothes writhe like a living creature for 24 hours",
		"Target's corpse will never decay by natural processes",
		"Target's current hit point total is their maximum hit point total",
		"Target's deadliest foe appears in the area, armed to the teeth",
		"Target's deadliest foe will rescue them in their hour of need",
		"Target's death is expected to yield vast riches for their slayer",
		...
		"Target's death will reveal them to be a horrific, demonic entity",
		...
		"Target's ears migrate about their head as the days wear on",
		"Target's ears migrate to their shoulders",
		...
		"Target's eyes bulge from the top of their head like a frog's eyes",
		...
		"Target's eyes glow with malevolent fire when they faces true north",
		"Target's eyes merge into a single eye somewhere on their face",
		"Target's eyes migrate to just above their ears",
		...
		"Target's face appears to have been welded to their skull",
		"Target's face begins to look more and more bat-like",
		"Target's face can't be harmed by acid",
		"Target's face glows pale green when they tells a lie",
		"Target's face is badly sunburned in a checkerboard pattern",
		"Target's face is flattened to their skull",
		...
		"Target's face looks as though they're been pounded with hammers",
		"Target's face looks as though something exploded in their nose",
		"Target's face looks like badly melted wax",
		"Target's face migrates to the top of their head",
		"Target's family disowns them and places a bounty on their head",
		...
		"Target's feet are now prehensile, but their hands are not",
		"Target's feet can rotate 360° at the ankle without harming him",
		"Target's feet can't come within one yard of each other",
		"Target's feet explode if they ventures more than one mile from here",
		"Target's feet shriek incessantly while they wears shoes or boots",
		...
		"Target's fingers and thumbs connect directly to their wrists",
		...
		"Target's fists are each as large as their head",
		"Target's fists can't come within five feet of the ground",
		"Target's fists retract into their forearms when not in use",
		...
		"Target's footprints look like arrows pointing which way they went",
		"Target's footprints look like they're executing complex dance steps",
		...
		"Target's hair falls out and tiny spikes sprout all over their head",
		"Target's hair floats as though underwater",
		"Target's hair grows 1d12 inches each time they're struck by magic",
		"Target's hair is severely tangled in the nearest tree or bush",
		"Target's hair is styled into a tall bouffant",
		"Target's hair moves from their head to somewhere else on their body",
		...
		"Target's hands applaud despite their wishes for 3d10 rounds",
		"Target's hands are bound in adamantite shackles",
		"Target's hands are encased in thick blobs of candle wax",
		"Target's hands are invisible while they wields a weapon",
		...
		"Target's hands are utterly paralyzed until they're struck by magic",
		"Target's hands attempt to strangle them for 3d10 rounds",
		"Target's hands become ethereal while they wields a weapon",
		"Target's hands can never be severed from their arms",
		...
		"Target's hands can't come within 18 inches of their mouth",
		"Target's hands change color each hour",
		"Target's hands combust if they tries to wear gloves",
		"Target's hands combust if they come into contact with each other",
		"Target's hands flap like birds' wings for 1d10 rounds",
		"Target's hands freeze to the next wooden object they touches",
		"Target's hands fuse to the next metal object they handles",
		"Target's hands fuse together behind their back",
		"Target's hands itch slightly when they touches a magic item",
		...
		"Target's hands steam vigorously when they're struck by magic",
		"Target's hands try to grab their ankles while they're walking",
		"Target's hands turn to metal but otherwise function normally",
		"Target's hands vanish while they sleeps but return before they wakes",
		"Target's hat animates and attempts to eat their head",
		...
		"Target's head can survive away from their body for 3d8 hours",
		"Target's head can't be harmed by magical electricity",
		"Target's head considers itself separate from their body",
		"Target's head deflates like a balloon while they sleeps",
		"Target's head explodes but regrows over the next 1d10 rounds",
		"Target's head explodes if they're decapitated",
		"Target's head glows like a jack-o-lantern",
		"Target's head goes on a murderous rampage if they're decapitated",
		...
		"Target's head is protected as though they're wearing a steel helmet",
		...
		"Target's head shrinks to the size of their closed fist",
		"Target's head spins rapidly at the neck for 2d10 rounds",
		"Target's head splits in half, revealing their real head inside",
		"Target's head strongly resembles a foot",
		"Target's head throbs visibly when they're angry",
		"Target's head vanishes and their face appears on their chest",
		"Target's head was stolen from a necromancer's workshop",
		"Target's head will be claimed by warring factions after they dies",
		...
		"Target's intestines are more intelligent than they is",
		"Target's intestines are replaced by a length of noisy chain",
		"Target's jawbone becomes that of an ass",
		"Target's knees and elbows become ball-joints like their shoulders",
		...
		"Target's left arm moves to their right shoulder",
		...
		"Target's legs are shaped like springs and twang when they walks",
		"Target's legs can't be cut by non-magical weapons",
		"Target's legs exactly resemble their arms",
		"Target's legs exchange positions",
		"Target's legs fuse together, and their arms fuse to their sides",
		...
		"Target's lips move constantly as though they're singing to himself",
		...
		"Target's maximum natural lifespan is 1d10 years more than their age",
		...
		"Target's most valuable possession flies toward them at great speed",
		...
		"Target's mouth and one of their eyes exchange places",
		"Target's mouth appears to be full of angry hornets",
		"Target's mouth can speak with a mind of its own",
		"Target's mouth can't be opened while they're wearing a hat",
		"Target's mouth glows as though they're eating fireflies",
		"Target's mouth glows like a forge",
		"Target's mouth is full of moths",
		"Target's mouth is now located on the back of their head",
		...
		"Target's neck attempts to devour their head",
		"Target's neck can extend an additional 1d4 feet at will",
		"Target's neck can retract into their torso like a turtle's",
		"Target's neck can't be broken",
		"Target's neck doubles in length",
		"Target's neck flares like a lizard's frill when they're angry",
		...
		"Target's neck is scarred and twisted as if they survived a hanging",
		"Target's next 1d10 attacks affect them as well",
		...
		"Target's next missile attack automatically strikes them instead",
		...
		"Target's nostrils are each as large as their mouth",
		"Target's nostrils glow with an unholy radiance",
		"Target's nostrils migrate to the top of their head",
		...
		"Target's shadow races around them in a tight circle",
		"Target's shadow rises up and tries to strangle him",
		"Target's skin acquires 1d100 blasphemous tattoos",
		"Target's skin ages 10X as fast as the rest of their body",
		...
		"Target's skin can't be burned, but fire still causes them pain",
		"Target's skin can't be cut",
		"Target's skin can't be cut by magical weapons under moonlight",
		"Target's skin can't be cut, and their mouth and nose seal shut",
		...
		"Target's skin freezes to their weapon each time they wields it",
		"Target's skin gives them a natural AC of 3, but only while naked",
		...
		"Target's skin is charred and blackened, but they is unharmed",
		"Target's skin is covered in scales like a fish",
		"Target's skin is flayed from their limbs, but it regrows by dawn",
		"Target's skin is forever the color of the next stone they touches",
		"Target's skin is invisible by firelight",
		"Target's skin is invisible in the presence of undead",
		"Target's skin is invisible while they're standing in water",
		...
		"Target's skin is repeatedly tattooed with their own name",
		...
		"Target's skin will melt if they gets too close to a campfire",
		"Target's skin writhes and pulses while they're eating",
		...
		"Target's speech is reversed while their weapon is drawn",
		...
		"Target's spine juts from their flesh along their entire back",
		...
		"Target's teeth and tongue fall out when they next opens their mouth",
		...
		"Target's teeth glow brightly while their mouth is open",
		"Target's teeth glow like coals in a forge",
		"Target's teeth glow like torches when they're struck by magic",
		"Target's teeth resonate in their jaw when they uses a magic item",
		"Target's teeth shoot from their mouth like bullets",
		...
		"Target's toes are each as large as their big toe",
		...
		"Target's torso regenerates their limbs and head as needed",
		"Target's torso shines like a beacon for 1d4 days",
		"Target's torso shines like a beacon when they uses a magic item",
		...
		"Target's torso unzips and dumps out all of their organs",
		...
		"Target's voice inspires confidence in others of their species",
		"Target's voice inspires dread in anyone of the opposite sex",
		"Target's voice is inaudible to others of their species",
		"Target's voice is nearly unintelligible when they wields their weapon",
		"Target's voice issues from their navel",
		"Target's voice issues from their weapon for the next few weeks",
		"Target's voice issues from the nearest wooden object",
		"Target's voice issues from this spot for 2d10 days",
		"Target's voice seems to issue from whomever they're addressing",
		"Target's voice sounds as though they're shouting from a distance",
		...
		"Target's waterskin is filled with their own blood",
		...
		"Target's weapon attacks them the next time they're wounded in battle",
		...
		"Target's weapon burns target's hand the next time they wields it",
		...
		"Target's weapon can't injure anyone of their sex",
		...
		"Target's weapon enables them to breathe underwater for 3d8 rounds",
		...
		"Target's weapon glows blue in their presence",
		"Target's weapon glows blue in the presence of orcs or birds",
		"Target's weapon glows blue in the presence of swords",
		"Target's weapon glows blue whenever they tries to remain hidden",
		"Target's weapon glows brightly when their blood has been spilled",
		...
		"Target's weapon has a +4 bonus when used against their allies",
		"Target's weapon has a +4 bonus when used against the caster",
		"Target's weapon has a +4 bonus while they're standing in water",
		...
		"Target's weapon induces pessimism in their allies during melee",
		...
		"Target's weapon inspires them to embark on a murderous rampage",
		"Target's weapon instills Fear in any who've been wounded by it",
		"Target's weapon instills Fear in goblins and kobolds",
		"Target's weapon instills Fear in them after each battle",
		"Target's weapon instills Fear in their allies during battle",
		...
		"Target's weapon is 20% likely to poison them when it draws blood",
		"Target's weapon is 20% likely to turn ethereal during battle",
		"Target's weapon is 20% likely to vanish each time they draws it",
		...
		"Target's weapon is bent into a torc around their neck",
		"Target's weapon is bent into the shape of a paperclip",
		"Target's weapon is chained by its hilt to a collar about their neck",
		...
		"Target's weapon is etched with their likeness",
		...
		"Target's weapon is invisible to them in daylight",
		"Target's weapon is invisible to them until it draws their blood",
		...
		"Target's weapon is vulnerable to magical fire while they wields it",
		"Target's weapon is weightless when not in use",
		"Target's weapon kills them outright if used against him",
		"Target's weapon makes them 1d20 years older while it's drawn",
		"Target's weapon makes them appear somehow less imposing",
		"Target's weapon makes them highly susceptible illusion magic",
		...
		"Target's weapon renders them mute for 1d8 hours after each battle",
		"Target's weapon repels their allies while it's drawn",
		...
		"Target's weapon ridicules them in front of their allies",
		"Target's weapon rings like a bell to mark the hours",
		"Target's weapon shatters the next time they're burned by fire",
		...
		"Target's weapon thinks that they're its mother",
		...
		"Target's weapon urges them to leap from the nearest bridge",
		"Target's weapon vanishes until they dies",
		"Target's weapon vanishes when they dies",
		"Target's weapon was forged by their descendent years in the future",
		"Target's weapon was forged by someone who has never existed",
		"Target's weapon was forged from the bones of a slain god",
		"Target's weapon was forged in a volcano by demonic weapon smiths",
		"Target's weapon was forged on the western slope of Heaven",
		"Target's weapon was lost in a tragic shipwreck decades ago",
		"Target's weapon was shrinks them by 5% each time it draws blood",
		"Target's weapon was stolen from the gods, and they want it back",
		"Target's weapon weighs as much as they does",
		...
		"Target's weight quadruples while they're swimming or wading",
		...
		"The ground now at target's feet hurls them 1d4 miles away",
		...
		"The right half of target's head vanishes, but they is unharmed",
		...
		"The top few inches of target's head vanish, but they is unharmed",
		...
		'To the target, all liquids taste like their own blood',
		...
		'Undead are attracted to the target as though they can help them',
		...
		"Vines sprout from the target's weapon and bind their limbs",
		...
		'Weapons are invisible to the target while they wields them',
		"Whatever is now in target's hand heats to 500°",
		"Whatever is now in target's hand is embossed with their name",
		...
		"Whatever is now in target's hand weighs more than they does",
		'Whatever target does, they claims some bizarre, fantastical motive',
		"Whatever target does, they claims to be fulfilling their deity's will",
		'Whatever target is wearing is stuck to them like glue',
		'When caster dies, target begins aging 1d10 years per round',
		'When injured, target is 5% likely to fly into a berserker rage',
		'When injured, target is 10% likely to attack their nearest ally',
		...
		'When target dies, everyone who knew them forgets all about him',
		'When target dies, they is posthumously crowned king',
		'When target dies, they is rumored never to have existed',
		"When target dies, they're immediately resurrected 10d100 miles away",
		'When target dies, their corpse animates and races to this spot',
		'When target dies, their corpse attacks the nearest person',
		'When target dies, their corpse burns with green flame until sunset',
		'When target dies, their corpse grows by a factor of 2d10',
		'When target dies, their corpse immediately turns to granite',
		'When target dies, their corpse metamorphoses into something awful',
		'When target dies, their corpse runs wild through the nearest town',
		"When target dies, their corpse teleports into the caster's home",
		'When target dies, their killer is hailed as a national hero',
		'When target dies, their killer is named their executor',
		'When target dies, their skeleton animates as a free willed undead',
		'When target dies, their soul commandeers the nearest undead body',
		'When target dies, their soul is trapped in their weapon',
		'When target draws a weapon, a nearby tree drops its leaves',
		"When target draws a weapon, they can't put it down until sunset",
		"When target draws a weapon, they feels that he'll die in 1d6 rounds",
		'When target draws a weapon, they must declare their name and title',
		'When target draws a weapon, they must draw blood within 1d6 rounds',
		'When target draws a weapon, they must pass a DEX check or drop it',
		'When target draws a weapon, they must Save or lose 1d4-1 hit points',
		"When target draws a weapon, they're randomly teleported 1d20 yards",
		"When target draws a weapon, they're stricken with intense fear",
		"When target draws a weapon, they're stunned for 1d4 rounds",
		'When target draws a weapon, their allies all shout their name',
		'When target draws a weapon, their weapon arm glows like a firefly',
		'When target draws a weapon, it costs them 1d4 gold pieces',
		...
		'When target draws a weapon, someone nearby declares them a coward',
		'When target draws a weapon, someone nearby laughs at him',
		'When target draws a weapon, the scent of eggs fills the air',
		'When target is next struck by magic, they becomes chaotic evil',
		'When target is next struck by magic, they becomes powerfully drunk',
		"When target is next struck by magic, they hates that spell's caster",
		'When target is next struck by magic, they teleports 1d6 miles',
		'When target next sleeps, a small tree sprouts from their chest',
		'When target next sleeps, everyone nearby dreams of killing him',
		'When target next sleeps, they sleeps for 2d20 days and nights',
		"When target next spills blood, any coins they're holding are doubled",
		'When target next spills blood, they finds 1d1000 gold pieces',
		'When target next spills blood, they is excommunicated and condemned',
		'When target next spills blood, they loses 1d10 hit points',
		"When target next spills blood, they loses any wealth they're carrying",
		'When target next spills blood, they regains 1d10 hit points',
		'When target next spills blood, they suffers cannibalistic urges',
		'When target next spills blood, they suffers dreadful hallucinations',
		'When target next spills blood, they takes a vow of pacifism',
		"When target next spills blood, they thinks he'll die by nightfall",
		'When target next spills blood, they vanishes for 1d4 days',
		"When target next spills blood, they're thrown 4d8 yards into the air",
		'When target next spills blood, their allies attack him',
		'When target next spills blood, their clothes are soaked in it',
		'When target next spills blood, their clothes burst into flame',
		'When target next spills blood, their feet take root in the ground',
		"When target next spills blood, their allies think they're dying",
		'When target next spills blood, their skin and hair become blood-red',
		'When target next spills blood, their Strength is halved until dawn',
		'When target next spills blood, their victim grows obsessed with him',
		'When target next spills blood, their waterskin fills with blood',
		'When target next spills blood, their weapon attacks him',
		'When target next spills blood, their weapon steams and hisses',
		'When target next spills blood, their weapon vanishes for 1d4 days',
		'When target next uses rope, they ties an insoluble knot',
		"When target next uses rope, they're attacked by undead skeletons",
		'When target next uses rope, it attacks them as if it were a snake',
		'When target next uses rope, it hauls them high into the air',
		'When target next uses rope, it shocks them like electrical wire',
		'When target next uses rope, it winds around them and combusts',
		'When target rolls a natural 20 ToHit, they wounds himself instead',
		'When target rolls a natural 20 ToHit, their weapon explodes',
		'When target says their name, they adds a wildly effusive honorific',
		"When target says their name, they can't tell a lie for one hour",
		'When target says their name, their age doubles',
		'When target says their name, their clothes are soaked with brine',
		'When target says their name, their clothes become amazingly clean',
		'When target says their name, mocking laughter echoes in the sky',
		'When target says their name, someone nearby adopts their name',
		'When target says their name, someone nearby forgets their own name',
		'When target says their name, someone nearby weeps openly',
		'When target sees or is hit by magic, they giggles for 1d10 rounds',
		'When target sees or is hit by magic, their head becomes invisible',
		'When target sneezes, 1d4 nearby trees are rendered invisible',
		'When target sneezes, bits of hot gravel spray from their nostrils',
		"When target uses magic, they thinks they're spinning rapidly",
		...
		"While target sleeps, they dreams that they're in hell",
		"While target sleeps, they dreams that they're undergoing surgery",
		'While target sleeps, they is invisible and inaudible to their allies',
		'While target sleeps, they sees and hears through the caster',
		"While target sleeps, they're 40% likely to regain 1d10 hit points",
		"While target sleeps, they're absolutely invulnerable to harm",
		"While target sleeps, they're bound by countless spider webs",
		'While target sleeps, their body races away in a random direction',
		'While target sleeps, their clothes deteriorate to filthy rags',
		'While target sleeps, someone writes obscene limericks on their skin',
		'While target stands still, they rotates slowly counter-clockwise',
		'While target stands still, pigeons treat them just like a statue',
		...
		'Yesterday, target learned that they and caster are closely related',
		'Yesterday, target learned that they had 36 hours left to live',
		'Yesterday, target stole a magic ruby from a dragon',
		'Yesterday, target took a sacred vow that they just now violated',
		...
		'A deity has died, and someone nearby is blamed for their death',
		...
		'A local ruler has quite obviously sold their soul to a demon',
		...
		'A local ruler shames their title with interpersonal indiscretions',
		...
		"Any priest nearby is 10% likely to think they're their god",
		...
		"Anyone nearby who's carrying rope has a hanging scar on their neck",
		...
		'Everyone within 50 yards has 1d100 gold pieces in their pocket',
		"Everyone within 50 yards has 1d6 orc's teeth in their pocket",
		'Everyone within 50 yards has a 1% chance to become a god',
		'Everyone within 50 yards has a 2% chance to explode',
		'Everyone within 50 yards has a big snowball in their pocket',
		"Everyone within 50 yards has a hen's egg in their pocket",
		'Everyone within 50 yards has a lighted candle in their pocket',
		'Everyone within 50 yards has a live cobra in their pocket',
		'Everyone within 50 yards has a live salmon in their pocket',
		'Everyone within 50 yards has a lump of quartz in their mouth',
		'Everyone within 50 yards has a red hot coal in their pocket',
		'Everyone within 50 yards has a signet ring in their pocket',
		'Everyone within 50 yards has a small diamond in their pocket',
		'Everyone within 50 yards has an iron ring around their wrist',
		'Everyone within 50 yards has delicate glass globe in their pocket',
		"Everyone within 50 yards has someone's severed hand in their pocket",
		...
		'Everyone within 50 yards swaps their name with someone else nearby',
		...
		'For one round, any nearby priest has 10% chance to summon their god',
		...
		"Nearest priest believes they're been excommunicated",
		'Nearest priest believes that cannibalism is a sacrament',
		'Nearest priest believes that clothing is an abomination',
		"Nearest priest believes that they're recently slain their deity",
		'Nearest priest believes that their deity has abandoned him',
		'Nearest priest believes that their deity has made them immortal',
		'Nearest priest believes that their deity is at their beck and call',
		'Nearest priest believes that their deity is standing nearby',
		'Nearest priest believes that someone nearby is their deity',
		'Nearest priest falls badly out of favor with their deity',
		...
		'Nearest priest is summoned by their deity',
		'Nearest priest is wholly immune to arcane magic for 4d6 hours',
		"Nearest priest realizes that they're worshipping the wrong deity",
		"Nearest priest thinks they're being persecuted for their beliefs",
		...
		'Nearest wizard breaks their staff and throws their books into the sea',
		...
		'Nearest wizard is equally affected by magic they casts on others',
		'Nearest wizard is exposed as a fraud and a charlatan',
		'Nearest wizard is unable to cast magic upon himself',
		"Nearest wizard suspects that they're a fraud and a charlatan",
		...
		"Next person nearby to draw blood dies if they're wounded before dawn",
		...
		'Next person nearby to draw blood then tries to destroy their weapon',
		"Next person nearby to draw blood thereafter thinks they're a vampire",
		...
		"Next person nearby to say their name can't use magic for 1d10 days",
		'Next person nearby to say their name goes berserk',
		'Next person nearby to say their name is attacked by rabbits',
		'Next person nearby to say their name is attacked by rodents',
		'Next person nearby to say their name is healed for 2d6 hit points',
		'Next person nearby to say their name is targeted for assassination',
		'Next person nearby to say their name permanently forgets their name',
		'Next person nearby to say their name teleports into a nearby cave',
		'Next person nearby to say their name then runs away at top speed',
		'Next person nearby to say their name wakes 5d10 miles away tomorrow',
		'Next person nearby to speak finds that their mouth has vanished',
		...
		'Next person nearby to use magic turns invisible above their nose',
		...
		'Next person slain nearby has their skull and spine torn out',
		...
		"Next person slain nearby is welcomed into their deity's pantheon",
		...
		'Next person slain nearby turns into a large swine as they dies',
		'Next person slain nearby was the offspring of a god',
		"Next person struck by magic nearby thinks they're a toddler",
		...
		'Next weapon drawn nearby forces its wielder to attack their allies',
		...
		"Next weapon drawn nearby makes its wielder think they're immortal",
		"Next weapon drawn nearby makes its wielder think they're invisible",
		...
		"Someone nearby attracts 2d10 followers who think they're a prophet",
		'Someone nearby awakens tomorrow in a stone sepulcher',
		'Someone nearby babbles about cone-shaped beings who took their mind',
		...
		'Someone nearby can shrink to half their height at will',
		...
		'Someone nearby can turn invisible by holding a toad in their mouth',
		...
		"Someone nearby can't move their arms in daylight",
		...
		"Someone nearby discovers solid proof that they doesn't really exist",
		...
		'Someone nearby finds a complete map of their own nervous system',
		...
		'Someone nearby finds their own severed head from some future time',
		'Someone nearby flies into a terrible rage when they sees magic used',
		'Someone nearby forever refuses to believe that magic truly exists',
		"Someone nearby fosters rumors that they're a demigod",
		'Someone nearby gains 10d100 experience points',
		"Someone nearby glows from within as though they're swallowed a torch",
		...
		'Someone nearby has a potion that turns half of their body invisible',
		'Someone nearby has a transcendent religious experience',
		'Someone nearby has a treasure map carved into their back',
		'Someone nearby has deeply offended the ruling family',
		'Someone nearby has produced a child with a powerful demon',
		'Someone nearby has two extra thumbs jutting from their forehead',
		'Someone nearby hoots like an owl when they hears their name',
		"Someone nearby inflates like a puffer fish whenever they're angry",
		"Someone nearby inherits wealth equal to a small nation's treasury",
		'Someone nearby is 3% likely to explode whenever they draws a weapon',
		...
		"Someone nearby is certain that they're immune to poison",
		...
		'Someone nearby is encased up to their chin in a large glass cube',
		...
		'Someone nearby is unable to bend their legs until sunrise',
		...
		'Someone nearby must be killed before they destroys us all!',
		"Someone nearby must be restrained or he'll cut off their own hands",
		...
		'Someone nearby must Save vs Death or their age doubles 2d6 times',
		'Someone nearby must Save vs Death or their bones explode',
		'Someone nearby must Save vs Death or their bones turn to soap',
		'Someone nearby must Save vs Death or their clothing attacks him',
		'Someone nearby must Save vs Death or their clothing turns to gold',
		'Someone nearby must Save vs Death or their head doubles in size',
		'Someone nearby must Save vs Death or their skin burns from their body',
		'Someone nearby must Save vs Death or their teeth turn to glass',
		...
		'Someone nearby now has three legs spaced evenly around their pelvis',
		...
		"Someone nearby realizes that they're a dragon in humanoid form",
		"Someone nearby realizes that they're been dead for centuries",
		"Someone nearby realizes that they're carrying a dangerous artifact",
		"Someone nearby realizes that they're just a fictional character",
		"Someone nearby realizes that they're the avatar of a deity",
		"Someone nearby realizes that their hands are someone else's hands",
		'Someone nearby realizes that their skin is slowly dissolving',
		...
		'Someone nearby rings like a bell whenever they sees magic used',
		...
		'Someone nearby sprays blood-red foam from their nose for 1d6 rounds',
		"Someone nearby sprouts a troll's arm from the center of their chest",
		"Someone nearby sprouts a turtle's shell atop their head",
		'Someone nearby sprouts hideous, non-functional bat wings',
		'Someone nearby sprouts inflatable sacs from their shoulder blades',
		'Someone nearby sprouts ornate feathers from their tongue',
		'Someone nearby sprouts plates from their back like a stegosaurus',
		...
		'Someone nearby suffers cannibalistic mania while their allies sleep',
		"Someone nearby suspects that they're trying to kill himself",
		'Someone nearby swallowed a small explosive device this morning',
		'Someone nearby teleports 1d10 yards in each of 1d10 rounds',
		'Someone nearby thinks they can snuff fires by sitting in them',
		"Someone nearby thinks he'll die if they says their name in moonlight",
		"Someone nearby thinks they're invisible in the presence of royalty",
		"Someone nearby thinks they're the last survivor of an extinct race",
		'Someone nearby thinks that they smells like a corpse',
		'Someone nearby tries suicide with the next silver weapon they sees',
		'Someone nearby tries to cut himself in half lengthwise',
		'Someone nearby tries to eat their own hands',
		'Someone nearby tries to kill every cow they sees',
		'Someone nearby tries to scalp himself',
		'Someone nearby tries to swallow their own arm, elbow first',
		'Someone nearby triggers a Burst when they next crosses a bridge',
		'Someone nearby triggers a Burst when they next traverses a doorway',
		"Someone nearby truly believes that they're a prophesized redeemer",
		...
		'Someone nearby turns to wood when they drops to one hit point',
		...
		'Someone nearby weeps tears of honey when they feels pain',
		...
		'Someone nearby will combust if they lights a fire by dawn tomorrow',
		'Someone nearby will combust when they next crosses moving water',
		'Someone nearby will die if they says their name backwards',
		'Someone nearby will die if they travels more than a mile in one day',
		'Someone nearby will explode if they draws blood by sunset today',
